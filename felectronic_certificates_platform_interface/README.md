...
A common platform interface for the [`felectronic_certificates`](https://github.com/Crdzbird/spanishgov_toolkits/tree/master/felectronic_certificates) plugin.
