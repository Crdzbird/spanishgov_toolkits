...
/*!
 ...
 <p>
  ...
  The nanosecond part is returned by <code>getNano</code>.
...
/*!
 ...
 <ul>
  <li><code>NANOS</code> -
   Returns an <code>Instant</code> with the specified number of nanoseconds added.
   This is equivalent to <code>plusNanos(long)</code>.
  <li><code>MICROS</code> -
   Returns an <code>Instant</code> with the specified number of microseconds added.
   This is equivalent to <code>plusNanos(long)</code> with the amount
   multiplied by 1,000. 
 <li><code>MILLIS</code> -
   Returns an <code>Instant</code> with the specified number of milliseconds added.
   This is equivalent to <code>plusNanos(long)</code> with the amount
   multiplied by 1,000,000. 
 <li><code>SECONDS</code> -
   Returns an <code>Instant</code> with the specified number of seconds added.
   This is equivalent to <code>plusSeconds(long)</code>.
  <li><code>MINUTES</code> -
   Returns an <code>Instant</code> with the specified number of minutes added.
   This is equivalent to <code>plusSeconds(long)</code> with the amount
   multiplied by 60. 
 <li><code>HOURS</code> -
   Returns an <code>Instant</code> with the specified number of hours added.
   This is equivalent to <code>plusSeconds(long)</code> with the amount
   multiplied by 3,600. 
 <li><code>HALF_DAYS</code> -
   Returns an <code>Instant</code> with the specified number of half-days added.
   This is equivalent to <code>plusSeconds(long)</code> with the amount
   multiplied by 43,200 (12 hours). 
 <li><code>DAYS</code> -
   Returns an <code>Instant</code> with the specified number of days added.
   This is equivalent to <code>plusSeconds(long)</code> with the amount
