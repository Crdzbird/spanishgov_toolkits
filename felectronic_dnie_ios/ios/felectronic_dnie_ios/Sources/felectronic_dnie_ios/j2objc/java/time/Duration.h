...
/*!
 @brief Returns number of whole times a specified Duration occurs within this Duration.
 <p>
  This instance is immutable and unaffected by this method call.
 ...
 @since 9
 */
- (jlong)dividedByWithJavaTimeDuration:(JavaTimeDuration *)divisor;
...
/*!
 @brief Extracts the number of days in the duration.
 <p>
  This returns the total number of days in the duration by dividing the
  number of seconds by 86400.
  This is based on the standard definition of a day as 24 hours. 
...
/*!
 @brief Extracts the number of hours part in the duration.
 <p>
  This returns the number of remaining hours when dividing <code>toHours</code>
  by hours in a day.
  This is based on the standard definition of a day as 24 hours. 
 <p>
  This instance is immutable and unaffected by this method call.
...
/*!
 @brief Extracts the number of milliseconds part of the duration.
 <p>
  This returns the milliseconds part by dividing the number of nanoseconds by 1,000,000.
  The length of the duration is stored using two fields - seconds and nanoseconds.
  The nanoseconds part is a value from 0 to 999,999,999 that is an adjustment to
  the length in seconds.
  The total duration is defined by calling <code>getNano()</code> and <code>getSeconds()</code>.
  <p>
  This instance is immutable and unaffected by this method call.
...
/*!
 @brief Extracts the number of minutes part in the duration.
 <p>
  This returns the number of remaining minutes when dividing <code>toMinutes</code>
...
/*!
 @brief Get the nanoseconds part within seconds of the duration.
 <p>
  The length of the duration is stored using two fields - seconds and nanoseconds.
  The nanoseconds part is a value from 0 to 999,999,999 that is an adjustment to
  the length in seconds.
...
/*!
 @brief Extracts the number of seconds part in the duration.
 <p>
  This returns the remaining seconds when dividing <code>toSeconds</code>
...
/*!
 @brief Returns a copy of this <code>Duration</code> truncated to the specified unit.
 <p>
 ...
 time-based units on {@@code ChronoUnit}
  and <code>DAYS</code>. Other ChronoUnits throw an exception. 
 <p>
  This instance is immutable and unaffected by this method call.
 @param unit the unit to truncate to, not null
 @return a <code>Duration</code> based on this duration with the time truncated, not null
 @throw DateTimeExceptionif the unit is invalid for truncation
 @throw UnsupportedTemporalTypeExceptionif the unit is not supported
 @since 9
 */
- (JavaTimeDuration *)truncatedToWithJavaTimeTemporalTemporalUnit:(id<JavaTimeTemporalTemporalUnit>)unit;
