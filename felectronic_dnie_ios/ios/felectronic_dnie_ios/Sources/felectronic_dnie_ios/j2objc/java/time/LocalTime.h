...
/*!
 @brief Obtains an instance of <code>LocalTime</code> from an <code>Instant</code> and zone ID.
 <p>
 ...
 @since 9
 */
+ (JavaTimeLocalTime *)ofInstantWithJavaTimeInstant:(JavaTimeInstant *)instant
...
/*!
 @brief Converts this <code>LocalTime</code> to the number of seconds since the epoch
 ...
 @since 9
 */
- (jlong)toEpochSecondWithJavaTimeLocalDate:(JavaTimeLocalDate *)date
...
/*!
 @brief Nanos per millisecond.
 */
inline jlong JavaTimeLocalTime_get_NANOS_PER_MILLI(void);
#define JavaTimeLocalTime_NANOS_PER_MILLI 1000000LL
J2OBJC_STATIC_FIELD_CONSTANT(JavaTimeLocalTime, NANOS_PER_MILLI, jlong)
...
FOUNDATION_EXPORT JavaTimeLocalTime *JavaTimeLocalTime_ofInstantWithJavaTimeInstant_withJavaTimeZoneId_(JavaTimeInstant *instant, JavaTimeZoneId *zone);
