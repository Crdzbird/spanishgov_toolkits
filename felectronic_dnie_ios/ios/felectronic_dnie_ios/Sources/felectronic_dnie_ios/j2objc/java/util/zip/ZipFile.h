...
- (instancetype __nonnull)initWithJavaIoFile:(JavaIoFile *)file
                                     withInt:(jint)mode
                                 withBoolean:(jboolean)enableZipPathValidator;
...
/*!
 ...
 <p>If the app targets Android U or above, zip file entry names containing
  ".." or starting with "/" passed here will throw a <code>ZipException</code>.
  For more details, see <code>dalvik.system.ZipPathValidator</code>.
 @param name the name of the zip file
 @throw ZipExceptionif (1) a ZIP format error has occurred or
...
FOUNDATION_EXPORT void JavaUtilZipZipFile_initWithJavaIoFile_withInt_withBoolean_(JavaUtilZipZipFile *self, JavaIoFile *file, jint mode, jboolean enableZipPathValidator);

FOUNDATION_EXPORT JavaUtilZipZipFile *new_JavaUtilZipZipFile_initWithJavaIoFile_withInt_withBoolean_(JavaIoFile *file, jint mode, jboolean enableZipPathValidator) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilZipZipFile *create_JavaUtilZipZipFile_initWithJavaIoFile_withInt_withBoolean_(JavaIoFile *file, jint mode, jboolean enableZipPathValidator);

FOUNDATION_EXPORT void JavaUtilZipZipFile_initWithJavaIoFile_withInt_withJavaNioCharsetCharset_withBoolean_(JavaUtilZipZipFile *self, JavaIoFile *file, jint mode, JavaNioCharsetCharset *charset, jboolean enableZipPathValidator);

FOUNDATION_EXPORT JavaUtilZipZipFile *new_JavaUtilZipZipFile_initWithJavaIoFile_withInt_withJavaNioCharsetCharset_withBoolean_(JavaIoFile *file, jint mode, JavaNioCharsetCharset *charset, jboolean enableZipPathValidator) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilZipZipFile *create_JavaUtilZipZipFile_initWithJavaIoFile_withInt_withJavaNioCharsetCharset_withBoolean_(JavaIoFile *file, jint mode, JavaNioCharsetCharset *charset, jboolean enableZipPathValidator);
