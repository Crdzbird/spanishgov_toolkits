...
/*!
 ...
 @return a <code>Collector</code> that produces the arithmetic mean of a
  derived property
 */
...
/*!
 @brief Adapts a <code>Collector</code> to one accepting elements of the same type 
 <code>T</code> by applying the predicate to each input element and only
  accumulating if the predicate returns <code>true</code>.
 ...
 @since 9
 */
+ (id<JavaUtilStreamCollector>)filteringWithJavaUtilFunctionPredicate:(id<JavaUtilFunctionPredicate>)predicate
...
/*!
 @brief Adapts a <code>Collector</code> accepting elements of type <code>U</code> to one
  accepting elements of type <code>T</code> by applying a flat mapping function
  to each input element before accumulation.The flat mapping function
  maps an input element to a <code>stream</code> covering zero or more
  output elements that are then accumulated downstream.
 Each mapped stream
  is <code>closed</code> after its contents
  have been placed downstream.  (If a mapped stream is <code>null</code>
 ...
 @since 9
 */
+ (id<JavaUtilStreamCollector>)flatMappingWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction>)mapper
                                           withJavaUtilStreamCollector:(id<JavaUtilStreamCollector>)downstream;
...
@endcode
 @param classifier a classifier function mapping input elements to keys
 @param downstream a <code>Collector</code>  implementing the downstream reduction
 @param mapFactory a supplier providing a new empty <code>Map</code>                    into which the results will be inserted
 @return a <code>Collector</code> implementing the cascaded group-by operation
 - seealso: #groupingBy(Function, Collector)
 - seealso: #groupingBy(Function)
...
/*!
 ...
 <p>There are no guarantees on the type, mutability, or serializability
  of the <code>ConcurrentMap</code> or <code>List</code> objects returned, or of the
...
/*!
 ...
 <p>The classification function maps elements to some key type <code>K</code>.
  The downstream collector operates on elements of type <code>T</code> and
  produces a result of type <code>D</code>. The resulting collector produces a 
 <code>ConcurrentMap<K, D></code>.
  
 <p>There are no guarantees on the type, mutability, or serializability
  of the <code>ConcurrentMap</code> returned. 
 <p>For example, to compute the set of last names of people in each city,
  where the city names are sorted: 
 @code
...
@endcode
 @param classifier a classifier function mapping input elements to keys
 @param downstream a <code>Collector</code>  implementing the downstream reduction
 @param mapFactory a supplier providing a new empty <code>ConcurrentMap</code>                    into which the results will be inserted
 @return a concurrent, unordered <code>Collector</code> implementing the cascaded group-by operation
 - seealso: #groupingByConcurrent(Function)
 - seealso: #groupingByConcurrent(Function, Collector)
 - seealso: #groupingBy(Function, Supplier, Collector)
...
/*!
 ...
 The returned <code>Map</code> always contains mappings for both 
 <code>false</code> and <code>true</code> keys.
  There are no guarantees on the type, mutability,
  serializability, or thread-safety of the <code>Map</code> or <code>List</code>
  returned.
...
/*!
 ...
 @param collectionFactory a supplier providing a new empty <code>Collection</code>                           into which the results will be inserted
...
/*!
 ...
 <code>ConcurrentMap</code> whose keys and values are the result of applying
  the provided mapping functions to the input elements.
 <p>If the mapped keys contain duplicates (according to <code>Object.equals(Object)</code>),
...
/*!
 ...
 <code>Object.equals(Object)</code>), an <code>IllegalStateException</code> is
  thrown when the collection operation is performed.  If the mapped keys
  might have duplicates, use <code>toMap(Function, Function, BinaryOperator)</code>
  instead. 
 <p>There are no guarantees on the type, mutability, serializability,
  or thread-safety of the <code>Map</code> returned.
 @param keyMapper a mapping function to produce keys
 @param valueMapper a mapping function to produce values
...
/*!
 ...
 <code>Map</code> whose keys and values are the result of applying the provided
  mapping functions to the input elements.
 <p>If the mapped
  keys contain duplicates (according to <code>Object.equals(Object)</code>),
  the value mapping function is applied to each equal element, and the
  results are merged using the provided merging function. 
 <p>There are no guarantees on the type, mutability, serializability,
  or thread-safety of the <code>Map</code> returned.
...
/*!
 @brief Returns a <code>Collector</code> that accumulates the input elements into an 
 <a href="..
 /List.html#unmodifiable">unmodifiable List</a> in encounter
  order.The returned Collector disallows null values and will throw 
 <code>NullPointerException</code> if it is presented with a null value.
 @return a <code>Collector</code> that accumulates the input elements into an 
 <a href="../List.html#unmodifiable">unmodifiable List</a> in encounter order
 @since 10
 */
+ (id<JavaUtilStreamCollector>)toUnmodifiableList;

/*!
 @brief Returns a <code>Collector</code> that accumulates the input elements into an 
 <a href="..
 /Map.html#unmodifiable">unmodifiable Map</a>,
  whose keys and values are the result of applying the provided
  mapping functions to the input elements.
 <p>If the mapped keys contain duplicates (according to 
 <code>Object.equals(Object)</code>), an <code>IllegalStateException</code> is
  thrown when the collection operation is performed.  If the mapped keys
  might have duplicates, use <code>toUnmodifiableMap(Function, Function, BinaryOperator)</code>
  to handle merging of the values. 
 <p>The returned Collector disallows null keys and values. If either mapping function
  returns null, <code>NullPointerException</code> will be thrown.
 ...
 @throw NullPointerExceptionif either keyMapper or valueMapper is null
 - seealso: #toUnmodifiableMap(Function, Function, BinaryOperator)
 @since 10
 */
+ (id<JavaUtilStreamCollector>)toUnmodifiableMapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction>)keyMapper
                                                withJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction>)valueMapper;
...
/*!
 ...
 @param mergeFunction a merge function, used to resolve collisions between                       values associated with the same key, as supplied
                        to 
 <code>Map.merge(Object, Object, BiFunction)</code> ,                       must be non-null
 @return a <code>Collector</code> that accumulates the input elements into an 
 <a href="../Map.html#unmodifiable">unmodifiable Map</a>, whose keys and values
  are the result of applying the provided mapping functions to the input elements
 @throw NullPointerExceptionif the keyMapper, valueMapper, or mergeFunction is null
 - seealso: #toUnmodifiableMap(Function, Function)
 @since 10
 */
+ (id<JavaUtilStreamCollector>)toUnmodifiableMapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction>)keyMapper
                                                withJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction>)valueMapper
...
/*!
 @brief Returns a <code>Collector</code> that accumulates the input elements into an 
 <a href="..
 /Set.html#unmodifiable">unmodifiable Set</a>.The returned
  Collector disallows null values and will throw <code>NullPointerException</code>
 ...
 @since 10
 */
+ (id<JavaUtilStreamCollector>)toUnmodifiableSet;
...
inline id<JavaUtilSet> JavaUtilStreamCollectors_get_CH_UNORDERED_NOID(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilStreamCollectors_CH_UNORDERED_NOID;
J2OBJC_STATIC_FIELD_OBJ_FINAL(JavaUtilStreamCollectors, CH_UNORDERED_NOID, id<JavaUtilSet>)
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toUnmodifiableList(void);

FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toSet(void);

FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toUnmodifiableSet(void);
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_flatMappingWithJavaUtilFunctionFunction_withJavaUtilStreamCollector_(id<JavaUtilFunctionFunction> mapper, id<JavaUtilStreamCollector> downstream);

FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_filteringWithJavaUtilFunctionPredicate_withJavaUtilStreamCollector_(id<JavaUtilFunctionPredicate> predicate, id<JavaUtilStreamCollector> downstream);
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toUnmodifiableMapWithJavaUtilFunctionFunction_withJavaUtilFunctionFunction_(id<JavaUtilFunctionFunction> keyMapper, id<JavaUtilFunctionFunction> valueMapper);
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> JavaUtilStreamCollectors_toUnmodifiableMapWithJavaUtilFunctionFunction_withJavaUtilFunctionFunction_withJavaUtilFunctionBinaryOperator_(id<JavaUtilFunctionFunction> keyMapper, id<JavaUtilFunctionFunction> valueMapper, id<JavaUtilFunctionBinaryOperator> mergeFunction);
