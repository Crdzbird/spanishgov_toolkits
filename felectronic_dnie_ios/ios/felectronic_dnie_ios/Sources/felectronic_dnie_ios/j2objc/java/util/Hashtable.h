...
/*!
 ...
 <code>Hashtable</code> operations, including <code>get</code> and <code>put</code>).<p>
...
@endcode
 ...
 .  Thus, in the face of concurrent
  ...
  The Enumerations returned by Hashtable's <code>keys</code> and 
 <code>elements</code> methods are <em>not</em> fail-fast; if the
...
/*!
 ...
 <code>java.util.ConcurrentModificationException</code> if the remapping
...
/*!
 @brief  
 <p>This method will, on a best-effort basis, throw a 
 <code>java.util.ConcurrentModificationException</code> if the mapping
  function modified this map during computation.
 @throw ConcurrentModificationExceptionif it is detected that the
...
/*!
 @brief Returns a string representation of this <code>Hashtable</code> object
  in the form of a set of entries, enclosed in braces and separated
  by the ASCII characters "<code> ,&nbsp;</code>" (comma and space).Each
  entry is rendered as the key, an equals sign <code>=</code>, and the
...
/*!
 @brief A constructor chained from <code>Properties</code> keeps Hashtable fields
  uninitialized since they are not used.
 @param dummy a dummy parameter
 */
- (instancetype __nonnull)initWithJavaLangVoid:(JavaLangVoid *)dummy;

/*!
 @brief Calls super.clone()
 */
- (JavaUtilHashtable *)cloneHashtable;

/*!
 @brief Called by Properties to write out a simulated threshold and loadfactor.
 */
- (void)defaultWriteHashtableWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)s
                                                  withInt:(jint)length
                                                withFloat:(jfloat)loadFactor;

/*!
 @brief Perform deserialization of the Hashtable from an ObjectInputStream.
 The Properties class overrides this method.
 */
- (void)readHashtableWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)s;

/*!
 @brief Perform serialization of the Hashtable to an ObjectOutputStream.
 The Properties class overrides this method.
 */
- (void)writeHashtableWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)s;
...
FOUNDATION_EXPORT void JavaUtilHashtable_initWithJavaLangVoid_(JavaUtilHashtable *self, JavaLangVoid *dummy);

FOUNDATION_EXPORT JavaUtilHashtable *new_JavaUtilHashtable_initWithJavaLangVoid_(JavaLangVoid *dummy) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilHashtable *create_JavaUtilHashtable_initWithJavaLangVoid_(JavaLangVoid *dummy);
