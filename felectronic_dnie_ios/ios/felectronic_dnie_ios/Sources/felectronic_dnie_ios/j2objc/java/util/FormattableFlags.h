...
/*!
 @brief FormattableFlags are passed to the <code>Formattable.formatTo()</code>
...
/*!
 @brief Left-justifies the output.Spaces (<code>'&#92;u0020'</code>) will be added
  at the end of the converted value as required to fill the minimum width
  of the field.
 If this flag is not set then the output will be
  right-justified. 
 <p> This flag corresponds to <code>'-'</code> (<code>'&#92;u002d'</code>) in
...
/*!
 ...
 <code>formatter</code> argument of the <code>formatTo()</code>
...
@endcode
 ...
 <p> This flag corresponds to <code>'S'</code> (<code>'&#92;u0053'</code>) in
  the format specifier.
 */
...
/*!
 @brief Requires the output to use an alternate form.The definition of the
  form is specified by the <code>Formattable</code>.
 <p> This flag corresponds to <code>'#'</code> (<code>'&#92;u0023'</code>) in
  the format specifier.
 */
