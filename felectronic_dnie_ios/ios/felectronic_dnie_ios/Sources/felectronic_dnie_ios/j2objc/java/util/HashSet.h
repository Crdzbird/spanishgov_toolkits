...
/*!
 ...
 <code>HashSet</code> instance's size (the number of elements) plus the
...
/*!
 @brief Constructs a new, empty set; the backing <code>HashMap</code> instance has
...
/*!
 @brief Returns a shallow copy of this <code>HashSet</code> instance: the elements
