...
/*!
 ...
 <p>The methods of this class all throw a <code>NullPointerException</code>
 ...
 <p>The documentation for the polymorphic algorithms contained in this class
  ...
  to.  (For example, the algorithm used by <code>sort</code> does not have to be
  a mergesort, but it does have to be <i>stable</i>.)
  
 <p>The "destructive" algorithms contained in this class, that is, the
  algorithms that modify the collection on which they operate, are specified
  to throw <code>UnsupportedOperationException</code> if the collection does not
  support the appropriate mutation primitive(s), such as the <code>set</code>
  method.  These algorithms may, but are not required to, throw this
  exception if an invocation would have no effect on the collection.  For
  example, invoking the <code>sort</code> method on an unmodifiable list that is
  already sorted may or may not throw <code>UnsupportedOperationException</code>.
...
/*!
 ...
 <code>cc.addAll(Collections.unmodifiableList(Arrays.asList(elements)))</code>.
...
@endcode
 @param c the collection into which <code>elements</code>  are to be inserted
 @param elements the elements to insert into <code>c</code>
 @return <code>true</code> if the collection changed as a result of the call
 @throw UnsupportedOperationExceptionif <code>c</code> does not support
          the <code>add</code> operation
 @throw NullPointerExceptionif <code>elements</code> contains one or more
          null values and <code>c</code> does not permit null elements, or
          if <code>c</code> or <code>elements</code> are <code>null</code>
 @throw IllegalArgumentExceptionif some property of a value in
          <code>elements</code> prevents it from being added to <code>c</code>
...
/*!
 ...
 <code>Queue</code>.Method <code>add</code> is mapped to <code>push</code>,
  <code>remove</code> is mapped to <code>pop</code> and so on.
 This
  view can be useful when you would like to use a method
  requiring a <code>Queue</code> but you need Lifo ordering. 
...
/*!
 @brief Returns an enumeration over the specified collection.This provides
  ...
  as input.
 <p>The iterator returned from a call to <code>Enumeration.asIterator()</code>
...
/*!
 ...
 <code>e</code> in the collection such that 
 ...
 @throw NullPointerExceptionif <code>c</code> is null
 @since 1.5
 */
...
/*!
 @brief Returns the starting position of the first occurrence of the specified
  ...
  such occurrence.More formally, returns the lowest index <code>i</code>
 ...
 <code>target</code> .
 @param target the list to search for as a subList of <code>source</code> .
...
/*!
 @brief Returns the starting position of the last occurrence of the specified
  ...
  occurrence.More formally, returns the highest index <code>i</code>
  such that <code>source.subList(i, i+target.size()).equals(target)</code>,
  or -1 if there is no such index.
 (Returns -1 if 
 <code>target.size() > source.size()</code>)
...
/*!
 ...
 <i>natural ordering</i> of its elements.All elements in the
  collection must implement the <code>Comparable</code> interface.
 ...
 <code>e2</code> in the collection).<p>
...
/*!
 @brief Returns the maximum element of the given collection, according to the
  ...
  comparator (that is, <code>comp.compare(e1, e2)</code> must not throw a 
 <code>ClassCastException</code> for any elements <code>e1</code> and 
 <code>e2</code> in the collection).
 <p>
  This method iterates over the entire collection, hence it requires
  time proportional to the size of the collection.
 @param coll the collection whose maximum element is to be determined.
...
/*!
 @brief Returns an immutable list consisting of <code>n</code> copies of the
  specified object.The newly allocated data object is tiny (it contains
  a single reference to the data object).
 This method is useful in
  combination with the <code>List.addAll</code> method to grow lists.
  The returned list is serializable.
 @param n the number of elements in the returned list.
 @param o the element to appear repeatedly in the returned list.
 @return an immutable list consisting of <code>n</code> copies of the
          specified object.
...
/*!
 ...
 <p>Each method invocation on the set returned by this method results in
  exactly one method invocation on the backing map or its <code>keySet</code>
  view, with one exception.  The <code>addAll</code> method is implemented
  as a sequence of <code>put</code> invocations on the backing map. 
...
/*!
 ...
 More formally, replaces with <code>newVal</code> each element <code>e</code>
  in <code>list</code> such that 
 <code>(oldVal==null ? e==null : oldVal.equals(e))</code>.
  (This method has no effect on the size of the list.)
 @param list the list in which replacement is to occur.
 @param oldVal the old value to be replaced.
 @param newVal the new value with which <code>oldVal</code>  is to be
          replaced.
 @return <code>true</code> if <code>list</code> contained one or more elements
          <code>e</code> such that
          <code>(oldVal==null ?  e==null : oldVal.equals(e))</code>.
 @throw UnsupportedOperationExceptionif the specified list or
          its list-iterator does not support the <code>set</code> operation.
 @since 1.4
 */
...
/*!
 ...
 After calling this method, the element at index <code>i</code> will be
  the element previously at index <code>(i - distance)</code> mod 
 <code>list.size()</code>, for all values of <code>i</code> between <code>0</code>
  and <code>list.size()-1</code>, inclusive.  (This method has no effect on
  the size of the list.) 
 <p>For example, suppose <code>list</code> comprises<code>[t, a, n, k, s]</code>.
  After invoking <code>Collections.rotate(list, 1)</code> (or 
 <code>Collections.rotate(list, -4)</code>), <code>list</code> will comprise 
 <code>[s, t, a, n, k]</code>.
  
 <p>Note that this method can usefully be applied to sublists to
  move one or more elements within a list while preserving the
  order of the remaining elements.  For example, the following idiom
  moves the element at index <code>j</code> forward to position 
 <code>k</code> (which must be greater than or equal to <code>j</code>):
  @code

      Collections.rotate(list.subList(j, k+1), -1); 
  
@endcode
  To make this concrete, suppose <code>list</code> comprises 
 <code>[a, b, c, d, e]</code>.  To move the element at index <code>1</code>
  (<code>b</code>) forward two positions, perform the following invocation: 
 @code

      Collections.rotate(l.subList(1, 4), -1); 
  
@endcode
  The resulting list is <code>[a, c, d, b, e]</code>.
 ...
 <code>RandomAccess</code> interface, this implementation breaks the
  list into two sublist views around index <code>-distance mod size</code>.
...
/*!
 ...
 @param value the value to which the returned map maps <code>key</code> .
...
/*!
 ...
 @throw IndexOutOfBoundsExceptionif either <code>i</code> or <code>j</code>
...
/*!
 ...
 <p>
  It is imperative that the user manually synchronize on the returned
  list when traversing it via <code>Iterator</code>, <code>Spliterator</code>
  or <code>Stream</code>:
  @code
...
/*!
 ...
 <p>
  It is imperative that the user manually synchronize on the returned
  map when traversing any of its collection views via <code>Iterator</code>,
  <code>Spliterator</code> or <code>Stream</code>:
  @code
...
/*!
 ...
 <code>tailMap</code> views, via <code>Iterator</code>, <code>Spliterator</code> or 
 <code>Stream</code>:
  @code
...
/*!
 ...
 <p>
  It is imperative that the user manually synchronize on the returned
  navigable set when traversing it, or any of its <code>subSet</code>,
  <code>headSet</code>, or <code>tailSet</code> views, via <code>Iterator</code>,
  <code>Spliterator</code> or <code>Stream</code>:
  @code
...
/*!
 ...
 <p>
  It is imperative that the user manually synchronize on the returned
  sorted set when traversing it or any of its <code>subSet</code>,
  <code>headSet</code>, or <code>tailSet</code> views via <code>Iterator</code>,
  <code>Spliterator</code> or <code>Stream</code>:
  @code
...
/*!
 @brief Returns an <a href="Collection.html#unmodview">unmodifiable view</a> of the
...
/*!
 @brief Returns an <a href="Collection.html#unmodview">unmodifiable view</a> of the
  ...
  through" to the specified navigable map.
...
/*!
 @brief Returns an <a href="Collection.html#unmodview">unmodifiable view</a> of the
  ...
  iterator, result in an <code>UnsupportedOperationException</code>.
 <p>
