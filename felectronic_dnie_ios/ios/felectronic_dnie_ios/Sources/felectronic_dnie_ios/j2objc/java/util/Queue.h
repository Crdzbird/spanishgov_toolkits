...
/*!
 ...
 Besides basic <code>Collection</code> operations, queues provide
 ...
 <code>null</code> or <code>false</code>, depending on the operation).  The
  latter form of the insert operation is designed specifically for
  use with capacity-restricted <code>Queue</code> implementations; in most
...
/*!
 @brief Retrieves and removes the head of this queue.This method differs
  from <code>poll()</code> only in that it throws an exception if
  this queue is empty.
