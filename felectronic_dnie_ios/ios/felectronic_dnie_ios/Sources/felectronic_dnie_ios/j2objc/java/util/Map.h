...
/*!
 ...
 <h2><a id="unmodifiable">Unmodifiable Maps</a></h2>
  <p>The <code>Map.of</code>,
  <code>Map.ofEntries</code>, and 
 <code>Map.copyOf</code>
...
/*!
 @brief Returns an unmodifiable map containing zero mappings.
...
/*!
 @brief Returns an unmodifiable map containing a single mapping.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the mapping's key
 @param v1 the mapping's value
 @return a <code>Map</code> containing the specified mapping
 @throw NullPointerExceptionif the key or the value is <code>null</code>
 @since 9
 */
+ (id<JavaUtilMap>)ofWithId:(id)k1
                     withId:(id)v1;

/*!
 @brief Returns an unmodifiable map containing two mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
 @param v2 the second mapping's value
 @return a <code>Map</code> containing the specified mappings
 @throw IllegalArgumentExceptionif the keys are duplicates
 @throw NullPointerExceptionif any key or value is <code>null</code>
 @since 9
 */
+ (id<JavaUtilMap>)ofWithId:(id)k1
                     withId:(id)v1
...
/*!
 @brief Returns an unmodifiable map containing three mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
 ...
 @return a <code>Map</code> containing the specified mappings
 @throw IllegalArgumentExceptionif there are any duplicate keys
 @throw NullPointerExceptionif any key or value is <code>null</code>
 @since 9
 */
+ (id<JavaUtilMap>)ofWithId:(id)k1
...
/*!
 @brief Returns an unmodifiable map containing four mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing five mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing six mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing seven mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing eight mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing nine mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing ten mappings.
 See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param k1 the first mapping's key
 @param v1 the first mapping's value
 @param k2 the second mapping's key
...
/*!
 @brief Returns an unmodifiable map containing keys and values extracted from the given entries.
 The entries themselves are not stored in the map.
  See <a href="#unmodifiable">Unmodifiable Maps</a> for details.
 @param entries<code>Map.Entry</code> s containing the keys and values from which the map is populated
 @return a <code>Map</code> containing the specified mappings
 @throw IllegalArgumentExceptionif there are any duplicate keys
 @throw NullPointerExceptionif any entry, key, or value is <code>null</code>, or if
          the <code>entries</code> array is <code>null</code>
 - seealso: Map#entryMap.entry()
 @since 9
 */
+ (id<JavaUtilMap>)ofEntriesWithJavaUtilMap_EntryArray:(IOSObjectArray *)entries;

/*!
 @brief Returns an unmodifiable <code>Entry</code> containing the given key and value.
 These entries are suitable for populating <code>Map</code> instances using the 
 <code>Map.ofEntries()</code> method.
 ...
 <ul>
  ...
  <li>They are unmodifiable. Calls to <code>Entry.setValue()</code>
 ...
 @throw NullPointerExceptionif the key or value is <code>null</code>
 - seealso: Map#ofEntriesMap.ofEntries()
 @since 9
 */
+ (id<JavaUtilMap_Entry>)entry__WithId:(id)k
                                withId:(id)v;

/*!
 @brief Returns an <a href="#unmodifiable">unmodifiable Map</a> containing the entries
  of the given Map.The given Map must not be null, and it must not contain any
  null keys or values.
 If the given Map is subsequently modified, the returned
  Map will not reflect such modifications.
 @param map a <code>Map</code>  from which entries are drawn, must be non-null
 @return a <code>Map</code> containing the entries of the given <code>Map</code>
 @throw NullPointerExceptionif map is null, or if it contains any null keys or values
 @since 10
 */
+ (id<JavaUtilMap>)copyOfWithJavaUtilMap:(id<JavaUtilMap>)map OBJC_METHOD_FAMILY_NONE;
...
FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_of(void);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_(id k1, id v1);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_(id k1, id v1, id k2, id v2);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5, id k6, id v6);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5, id k6, id v6, id k7, id v7);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5, id k6, id v6, id k7, id v7, id k8, id v8);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5, id k6, id v6, id k7, id v7, id k8, id v8, id k9, id v9);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id k1, id v1, id k2, id v2, id k3, id v3, id k4, id v4, id k5, id v5, id k6, id v6, id k7, id v7, id k8, id v8, id k9, id v9, id k10, id v10);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_ofEntriesWithJavaUtilMap_EntryArray_(IOSObjectArray *entries);

FOUNDATION_EXPORT id<JavaUtilMap_Entry> JavaUtilMap_entry__WithId_withId_(id k, id v);

FOUNDATION_EXPORT id<JavaUtilMap> JavaUtilMap_copyOfWithJavaUtilMap_(id<JavaUtilMap> map);
