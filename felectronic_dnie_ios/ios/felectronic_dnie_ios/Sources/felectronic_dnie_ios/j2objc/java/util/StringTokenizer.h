...
@endcode</blockquote>
 ...
 <p>
  <code>StringTokenizer</code> is a legacy class that is retained for
  compatibility reasons although its use is discouraged in new code. It is
  recommended that anyone seeking this functionality use the <code>split</code>
  method of <code>String</code> or the java.util.regex package instead. 
 <p>
  The following example illustrates how the <code>String.split</code>
...
/*!
 ...
 <p>
  Note that if <code>delim</code> is <code>null</code>, this constructor does
  not throw an exception. However, trying to invoke other methods on the
  resulting <code>StringTokenizer</code> may result in a 
...
/*!
 ...
 <code>StringTokenizer</code> object is changed to be the characters in
  the string <code>delim</code>.
