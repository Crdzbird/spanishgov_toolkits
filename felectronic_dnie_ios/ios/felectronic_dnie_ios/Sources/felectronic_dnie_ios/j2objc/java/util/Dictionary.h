...
/*!
 ...
 Every key and every value is an object. In any one <code>Dictionary</code>
  object, every key is associated with at most one value. Given a 
 <code>Dictionary</code> and a key, the associated element can be looked up.
...
/*!
 @brief Returns an enumeration of the values in this dictionary.The general
  contract for the <code>elements</code> method is that an 
 <code>Enumeration</code> is returned that will generate all the elements
...
/*!
 ...
 The general contract for the <code>isEmpty</code> method is that if this
 ...
 @throw NullPointerExceptionif the <code>key</code> is <code>null</code>.
...
/*!
 @brief Returns an enumeration of the keys in this dictionary.The general
  contract for the keys method is that an <code>Enumeration</code> object
...
/*!
 ...
 <code>key</code>, the value already in this dictionary for that 
 <code>key</code> is returned, after modifying the entry to contain the
   new element. <p>If this dictionary does not already have an entry
   for the specified <code>key</code>, an entry is created for the
   specified <code>key</code> and <code>value</code>, and <code>null</code> is
   returned. 
 <p>
