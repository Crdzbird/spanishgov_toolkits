...
/*!
 @brief Returns a predicate that is the negation of the supplied predicate.
 This is accomplished by returning result of the calling 
 <code>target.negate()</code>.
 ...
 @since 11
 */
+ (id<JavaUtilFunctionPredicate>)not__WithJavaUtilFunctionPredicate:(id<JavaUtilFunctionPredicate>)target;
...
FOUNDATION_EXPORT id<JavaUtilFunctionPredicate> JavaUtilFunctionPredicate_not__WithJavaUtilFunctionPredicate_(id<JavaUtilFunctionPredicate> target);
