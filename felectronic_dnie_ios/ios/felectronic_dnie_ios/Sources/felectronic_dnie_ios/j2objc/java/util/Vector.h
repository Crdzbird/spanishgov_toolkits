...
/*!
 ...
 <code>ConcurrentModificationException</code>.  Thus, in the face of
  ...
  the <code>elements</code> method are <em>not</em> fail-fast; if the
...
/*!
 ...
 The first item generated is the item at index <code>0</code>,
  then the item at index <code>1</code>, and so on. If the vector is
...
/*!
 ...
 <code>e2</code> are <em>equal</em> if <code>Objects.equals(e1, e2)</code>.)
...
/*!
 ...
 More formally, returns the lowest index <code>i</code> such that 
 <code>(i >= index && Objects.equals(o, get(i)))</code>,
  or -1 if there is no such index.
 @param o element to search for
...
/*!
 ...
 <code>Objects.equals(o, get(i))</code> (if such
  an element exists).
...
/*!
 ...
 @throw ArrayStoreExceptionif the runtime type of a, <code><T></code>, is not
  a supertype of the runtime type, <code><E></code>, of every element in this
  Vector
 @throw NullPointerExceptionif the given array is null
 @since 1.2
 */
...
FOUNDATION_EXPORT id JavaUtilVector_elementAtWithNSObjectArray_withInt_(IOSObjectArray *es, jint index);
...
FOUNDATION_EXPORT void JavaUtilVector_VectorSpliterator_initWithJavaUtilVector_withNSObjectArray_withInt_withInt_withInt_(JavaUtilVector_VectorSpliterator *self, JavaUtilVector *outer$, IOSObjectArray *array, jint origin, jint fence, jint expectedModCount);

FOUNDATION_EXPORT JavaUtilVector_VectorSpliterator *new_JavaUtilVector_VectorSpliterator_initWithJavaUtilVector_withNSObjectArray_withInt_withInt_withInt_(JavaUtilVector *outer$, IOSObjectArray *array, jint origin, jint fence, jint expectedModCount) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilVector_VectorSpliterator *create_JavaUtilVector_VectorSpliterator_initWithJavaUtilVector_withNSObjectArray_withInt_withInt_withInt_(JavaUtilVector *outer$, IOSObjectArray *array, jint origin, jint fence, jint expectedModCount);
