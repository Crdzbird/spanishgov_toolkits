...
@endcode</blockquote>
 ...
 <p> For category <i>General</i>, <i>Character</i>, <i>Numberic</i>,
  ...
  if the argument <i>arg</i> is <code>null</code>, then the result is "<code>null</code>".
 ...
 . If there is no explicit locale specified, either at the
  ...
  invocation, then the <code>default locale</code>
  is used. 
 <table class="striped">
  ...
  <tbody>
  <tr><th scope="row" style="vertical-align:top"> <code>'b'</code>, <code>'B'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'t'</code>, <code>'T'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'%'</code>
      ...
      <td> The result is a literal <code>'%'</code> (<code>'&#92;u0025'</code>)
  
 <tr><th scope="row" style="vertical-align:top"><code>'n'</code>
 ...
 <table class="striped">
  ...
  <tbody>
  <tr><th scope="row" style="vertical-align:top"> <code>'H'</code>
      <td> Hour of the day for the 24-hour clock, formatted as two digits with
      a leading zero as necessary i.e. <code>00 - 23</code>.
  
 <tr><th scope="row" style="vertical-align:top"><code>'I'</code>
      <td> Hour for the 12-hour clock, formatted as two digits with a leading
      zero as necessary, i.e.  <code>01 - 12</code>.
  
 <tr><th scope="row" style="vertical-align:top"><code>'k'</code>
      <td> Hour of the day for the 24-hour clock, i.e. <code>0 - 23</code>.
  
 <tr><th scope="row" style="vertical-align:top"><code>'l'</code>
      <td> Hour for the 12-hour clock, i.e. <code>1 - 12</code>.
  
 <tr><th scope="row" style="vertical-align:top"><code>'M'</code>
      <td> Minute within the hour formatted as two digits with a leading zero
      as necessary, i.e.  <code>00 - 59</code>.
  
 <tr><th scope="row" style="vertical-align:top"><code>'S'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'p'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'z'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'Q'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'B'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'A'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'j'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'e'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'R'</code>
      <td> Time formatted for the 24-hour clock as <code>"%tH:%tM"</code>
  
 <tr><th scope="row" style="vertical-align:top"><code>'T'</code>
 ...
 <code>'<'</code> (<code>'&#92;u003c'</code>) flag, which causes the argument for
...
@endcode</blockquote>
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'s'</code>
      ...
      <p> If the argument implements <code>Formattable</code>, then
 ...
 <li> If a decimal separator is present, a locale-specific decimal separator
  is
  substituted. 
 <li> If the <code>','</code> (<code>'&#92;u002c'</code>)
  <a id="L10nGroup">flag</a> is given, then the locale-specific grouping separator
  is
 ...
 <code>'('</code> (<code>'&#92;u0028'</code>) is prepended and a <code>')'</code>
  (<code>'&#92;u0029'</code>) is appended. 
 <li> If the value is negative (or floating-point negative zero) and 
 <code>'('</code> flag is not given, then a <code>'-'</code> (<code>'&#92;u002d'</code>)
  is prepended. 
 <li> If the <code>'+'</code> flag is given and the value is positive or zero (or
  floating-point positive zero), then a <code>'+'</code> (<code>'&#92;u002b'</code>)
  will be prepended. 
 </ol>
 ...
 <p> If <code>'('</code>, <code>'+'</code>, '&nbsp;&nbsp;', or <code>','</code> flags
      ...
      thrown. 
 <tr><th scope="row" style="vertical-align:top"> <code>'x'</code>
 ...
 <p> If the <code>'#'</code> flag is given then the output will always begin
      ...
      present).     
 <p> If <code>'('</code>, <code>'&nbsp;&nbsp;'</code>, <code>'+'</code>, or
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'+'</code>
      ...
      include a sign.     
 <p> If both the <code>'+'</code> and <code>'&nbsp;&nbsp;'</code> flags are given
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'&nbsp;&nbsp;'</code>
      ...
      <p> If both the <code>'+'</code> and <code>'&nbsp;&nbsp;'</code> flags are given
      then an <code>IllegalFormatFlagsException</code> will be thrown. 
 <tr><th scope="row" style="vertical-align:top"> <code>'0'</code>
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'('</code>
      ...
      (<code>'&#92;u0028'</code>) and append a <code>')'</code>
 ...
 <li> Negative numbers begin with a <code>'-'</code> (<code>'&#92;u002d'</code>)
 ...
 <p> If <i>x</i> is negative then the result will be a signed value
      beginning with <code>'-'</code> (<code>'&#92;u002d'</code>).  Signed output is
      allowed for this type because unlike the primitive types it is not
      possible to create an unsigned equivalent without assuming an explicit
      data-type size.     
 <p> If <i>x</i> is positive or zero and the <code>'+'</code> flag is given
      then the result will begin with <code>'+'</code> (<code>'&#92;u002b'</code>).
      <p> If the <code>'#'</code> flag is given then the output will always begin
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'e'</code>
      ...
      <td> Requires the output to be formatted using <a id="scientific">
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'g'</code>
 ...
 <p> The result is a string that represents the sign and magnitude
      ...
      will begin with <code>'-'</code> (<code>'&#92;u002d'</code>).
 ...
 <code>'p'</code> (<code>'&#92;u0070'</code>) followed by a decimal string of the
 ...
 <code>'x'</code> (<code>'&#92;u0078'</code>) and <code>'p'</code>
      (<code>'&#92;u0070'</code> and all hexadecimal digits <code>'a'</code> -
      <code>'f'</code> (<code>'&#92;u0061'</code> - <code>'&#92;u0066'</code>).
 ...
 <p> If the <a id="floatDPrec">conversion</a> is <code>'e'</code>,
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'e'</code>
      <td style="vertical-align:top"> <code>'&#92;u0065'</code>
      <td> Requires the output to be formatted using <a id="bscientific">
 computerized scientific notation</a>.  The <a href="#L10nAlgorithm">
 localization algorithm</a> is applied.
      <p> The formatting of the magnitude <i>m</i> depends upon its value.
      <p> If <i>m</i> is positive-zero or negative-zero, then the exponent
 ...
 <tr><th scope="row" style="vertical-align:top"> <code>'E'</code>
      <td style="vertical-align:top"> <code>'&#92;u0045'</code>
      <td> The upper-case variant of <code>'e'</code>.  The exponent symbol
      will be <code>'E'</code> (<code>'&#92;u0045'</code>).
 ...
 <tr><th scope="row" style="vertical-align:top"><code>'n'</code>
      <td> the platform-specific line separator as returned by <code>System.lineSeparator()</code>
 .
