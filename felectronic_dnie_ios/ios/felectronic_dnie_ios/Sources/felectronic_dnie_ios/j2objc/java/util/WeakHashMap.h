...
/*!
 @brief Hash table based implementation of the <code>Map</code> interface, with 
 <em>weak keys</em>.
...
/*!
 @brief Constructs a new, empty <code>WeakHashMap</code> with the default initial
  capacity (16) and load factor (0.75).
 */
- (instancetype __nonnull)init;

/*!
 @brief Constructs a new, empty <code>WeakHashMap</code> with the given initial
...
/*!
 @brief Constructs a new <code>WeakHashMap</code> with the same mappings as the
