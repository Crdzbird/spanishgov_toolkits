...
/*!
 @brief Sets the date of this <code>Calendar</code> with the given date
...
/*!
 */
+ (jint)toStandaloneStyleWithInt:(jint)style;
...
- (jint)getBaseStyleWithInt:(jint)style;
...
FOUNDATION_EXPORT jint JavaUtilCalendar_toStandaloneStyleWithInt_(jint style);
...
/*!
 @brief Sets the time zone parameter to the given <code>zone</code>.If no time
  zone parameter is given to this <code>Calendar.Builder</code>, the 
 default
  <code>TimeZone</code>
