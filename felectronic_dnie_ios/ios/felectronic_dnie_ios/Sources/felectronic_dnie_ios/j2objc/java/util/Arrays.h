...
/*!
 @brief Returns a fixed-size list backed by the specified array.Changes made to
  the array will be visible in the returned list, and changes made to the
  list will be visible in the array.
 The returned list is 
 <code>Serializable</code> and implements <code>RandomAccess</code>.
  
 <p>The returned list implements the optional <code>Collection</code> methods, except
  those that would change the size of the returned list. Those methods leave
  the list unchanged and throw <code>UnsupportedOperationException</code>.
 @param a the array by which the list will be backed
 @return a list view of the specified array
 @throw NullPointerExceptionif the specified array is <code>null</code>
 */
...
/*!
 @brief Copies the specified array, truncating or padding with <code>false</code> (if necessary)
  so the copy has the specified length.For all indices that are
  valid in both the original array and the copy, the two arrays will
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>false</code>.
 ...
 @throw NegativeArraySizeExceptionif <code>newLength</code> is negative
 @throw NullPointerExceptionif <code>original</code> is null
 @since 1.6
 */
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>(byte)0</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 ...
 For any indices that are valid in the copy but not
  the original, the copy will contain <code>'\u0000'</code>.  Such indices
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>0d</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>0f</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>0</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>0L</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 @brief Copies the specified array, truncating or padding with zeros (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>(short)0</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
...
/*!
 @brief Copies the specified array, truncating or padding with nulls (if necessary)
  ...
  contain identical values.
 For any indices that are valid in the
  copy but not the original, the copy will contain <code>null</code>.
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
...
/*!
 ...
 For any indices that are valid in the
  ...
  Such indices will exist if and only if the specified length
  is greater than that of the original array.
  The resulting array is of the class <code>newType</code>.
 @param original the array to be copied
 @param newLength the length of the copy to be returned
 ...
 @throw ArrayStoreExceptionif an element copied from
      <code>original</code> is not of a runtime type that can be stored in
      an array of class <code>newType</code>
 @since 1.6
 */
+ (IOSObjectArray * __nonnull)copyOfWithNSObjectArray:(IOSObjectArray *)original
...
/*!
 ...
 The initial index of the range (<code>from</code>) must lie between zero
  and <code>original.length</code>, inclusive.  The value at 
 <code>original[from]</code> is placed into the initial element of the copy
  (unless <code>from == original.length</code> or <code>from == to</code>).
  Values from subsequent elements in the original array are placed into
  subsequent elements in the copy.  The final index of the range
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>false</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 ...
 @throw IllegalArgumentExceptionif <code>from > to</code>
 @throw NullPointerExceptionif <code>original</code> is null
 @since 1.6
 */
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>(byte)0</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>'\u0000'</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>0d</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>0f</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>0</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>0L</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>(short)0</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
 @param original the array from which a range is to be copied
 @param from the initial index of the range to be copied, inclusive
...
/*!
 ...
 <code>original[from]</code> is placed into the initial element of the copy
  ...
  (<code>to</code>), which must be greater than or equal to <code>from</code>,
  may be greater than <code>original.length</code>, in which case 
 <code>null</code> is placed in all elements of the copy whose index is
  greater than or equal to <code>original.length - from</code>.  The length
  of the returned array will be <code>to - from</code>.
  <p>
  The resulting array is of exactly the same class as the original array.
...
/*!
 @brief Returns <code>true</code> if the two specified arrays are <i>deeply
 ...
 <code>null</code>, or if they refer to arrays that contain the same
  number of elements and all corresponding pairs of elements in the two
  arrays are deeply equal. 
 <p>Two possibly <code>null</code> elements <code>e1</code> and <code>e2</code> are
  deeply equal if any of the following conditions hold: 
 <ul>
     <li> <code>e1</code> and <code>e2</code> are both arrays of object reference
          types, and <code>Arrays.deepEquals(e1, e2) would return true</code>
     <li> <code>e1</code> and <code>e2</code> are arrays of the same primitive
          type, and the appropriate overloading of         
 <code>Arrays.equals(e1, e2)</code> would return true.
     <li> <code>e1 == e2</code>
     <li> <code>e1.equals(e2)</code> would return true. 
 </ul>
...
/*!
 ...
 It is therefore unacceptable to invoke this method on an array that
  ...
  undefined. 
 <p>For any two arrays <code>a</code> and <code>b</code> such that 
 <code>Arrays.deepEquals(a, b)</code>, it is also the case that 
 <code>Arrays.deepHashCode(a) == Arrays.deepHashCode(b)</code>.
  
 <p>The computation of the value returned by this method is similar to
  that of the value returned by <code>List.hashCode()</code> on a list
  containing the same elements as <code>a</code> in the same order, with one
  difference: If an element <code>e</code> of <code>a</code> is itself an array,
  its hash code is computed not by calling <code>e.hashCode()</code>, but as
  by calling the appropriate overloading of <code>Arrays.hashCode(e)</code>
  if <code>e</code> is an array of a primitive type, or as by calling 
 <code>Arrays.deepHashCode(e)</code> recursively if <code>e</code> is an array
  of a reference type.  If <code>a</code> is <code>null</code>, this method
  returns 0.
 @param a the array whose deep-content-based hash code to compute
 @return a deep-content-based hash code for <code>a</code>
...
/*!
 ...
 <p>The string representation consists of a list of the array's
  elements, enclosed in square brackets (<code>"[]"</code>).  Adjacent
  elements are separated by the characters <code>", "</code> (a comma
  followed by a space).  Elements are converted to strings as by 
 <code>String.valueOf(Object)</code>, unless they are themselves
  arrays. 
 <p>If an element <code>e</code> is an array of a primitive type, it is
  converted to a string as by invoking the appropriate overloading of 
 <code>Arrays.toString(e)</code>.  If an element <code>e</code> is an array of a
  reference type, it is converted to a string as by invoking
  this method recursively. 
 <p>To avoid infinite recursion, if the specified array contains itself
  as an element, or contains an indirect reference to itself through one
  or more levels of arrays, the self-reference is converted to the string 
 <code>"[...]"</code>.  For example, an array containing only a reference
  to itself would be rendered as <code>"[[...]]"</code>.
  
 <p>This method returns <code>"null"</code> if the specified array
  is <code>null</code>.
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of booleans are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
  are equal if they contain the same elements in the same order.  Also,
  two array references are considered equal if both are <code>null</code>.
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of bytes are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of chars are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of doubles are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
  are equal if they contain the same elements in the same order.  Also,
  two array references are considered equal if both are <code>null</code>.
  Two doubles <code>d1</code> and <code>d2</code> are considered equal if: 
 @code
    new Double(d1).equals(new Double(d2))
@endcode
  (Unlike the <code>==</code> operator, this method considers 
 <code>NaN</code> equal to itself, and 0.0d unequal to -0.0d.)
 @param a one array to be tested for equality
 @param a2 the other array to be tested for equality
 @return <code>true</code> if the two arrays are equal
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of floats are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
  are equal if they contain the same elements in the same order.  Also,
  two array references are considered equal if both are <code>null</code>.
  Two floats <code>f1</code> and <code>f2</code> are considered equal if: 
 @code
    new Float(f1).equals(new Float(f2))
@endcode
  (Unlike the <code>==</code> operator, this method considers 
 <code>NaN</code> equal to itself, and 0.0f unequal to -0.0f.)
 @param a one array to be tested for equality
 @param a2 the other array to be tested for equality
 @return <code>true</code> if the two arrays are equal
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of ints are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of longs are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
...
/*!
 @brief Returns true if the two specified arrays of Objects, over the specified
 ...
 <p>Two arrays are considered equal if the number of elements covered by
  ...
  in the same order. 
 <p>Two objects <code>e1</code> and <code>e2</code> are considered <i>equal</i> if 
 ...
 @return <code>true</code> if the two arrays, over the specified ranges, are
          equal
 @throw IllegalArgumentException
 if <code>aFromIndex > aToIndex</code> or
          if <code>bFromIndex > bToIndex</code>
 @throw ArrayIndexOutOfBoundsException
 if <code>aFromIndex < 0 or aToIndex > a.length</code> or
          if <code>bFromIndex < 0 or bToIndex > b.length</code>
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of Objects are 
 <i>equal</i> to one another.The two arrays are considered equal if
  both arrays contain the same number of elements, and all corresponding
  pairs of elements in the two arrays are equal.
 Two objects <code>e1</code>
  and <code>e2</code> are considered <i>equal</i> if 
 <code>Objects.equals(e1, e2)</code>.
...
/*!
 @brief Returns <code>true</code> if the two specified arrays of shorts are 
 <i>equal</i> to one another.Two arrays are considered equal if both
  arrays contain the same number of elements, and all corresponding pairs
  of elements in the two arrays are equal.
 In other words, two arrays
...
/*!
 ...
 <p>Two arrays are considered equal if the number of elements covered by
  ...
  in the same order. 
 <p>Two objects <code>e1</code> and <code>e2</code> are considered <i>equal</i> if,
  given the specified comparator, <code>cmp.compare(e1, e2) == 0</code>.
 @param a the first array to be tested for equality
 @param aFromIndex the index (inclusive) of the first element in the                    first array to be tested
 @param aToIndex the index (exclusive) of the last element in the                  first array to be tested
 @param b the second array to be tested for equality
 ...
 if <code>aFromIndex < 0 or aToIndex > a.length</code> or
          if <code>bFromIndex < 0 or bToIndex > b.length</code>
 @throw NullPointerException
 if either array or the comparator is <code>null</code>
 @since 9
 */
+ (jboolean)equalsWithNSObjectArray:(IOSObjectArray *)a
                            withInt:(jint)aFromIndex
...
/*!
 ...
 <p>Two arrays are considered equal if both arrays contain the same number
  ...
  considered equal if both are <code>null</code>.
 ...
 @param cmp the comparator to compare array elements
 @return <code>true</code> if the two arrays are equal
 @throw NullPointerExceptionif the comparator is <code>null</code>
 @since 9
 */
+ (jboolean)equalsWithNSObjectArray:(IOSObjectArray *)a
                  withNSObjectArray:(IOSObjectArray *)a2
...
/*!
 @brief Assigns the specified boolean value to each element of the specified
  ...
  extends from index <code>fromIndex</code>, inclusive, to index 
...
/*!
 ...
 For any two <code>boolean</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
  
 <p>The value returned by this method is the same value that would be
  obtained by invoking the <code>hashCode</code>
  method on a <code>List</code> containing a sequence of <code>Boolean</code>
  instances representing the elements of <code>a</code> in the same order.
  If <code>a</code> is <code>null</code>, this method returns 0.
 @param a the array whose hash value to compute
 @return a content-based hash code for <code>a</code>
 @since 1.5
 */
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>byte</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>char</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>double</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>float</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two non-null <code>int</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>long</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 ...
 <p>The value returned by this method is equal to the value that would
  be returned by <code>Arrays.asList(a).hashCode()</code>, unless <code>a</code>
  is <code>null</code>, in which case <code>0</code> is returned.
...
/*!
 @brief Returns a hash code based on the contents of the specified array.
 For any two <code>short</code> arrays <code>a</code> and <code>b</code>
  such that <code>Arrays.equals(a, b)</code>, it is also the case that 
 <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  enclosed in square brackets (<code>"[]"</code>).  Adjacent elements are
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(boolean)</code>.  Returns <code>"null"</code> if 
...
/*!
 @brief Returns a string representation of the contents of the specified array.
 The string representation consists of a list of the array's elements,
  enclosed in square brackets (<code>"[]"</code>).  Adjacent elements
  are separated by the characters <code>", "</code> (a comma followed
  by a space).  Elements are converted to strings as by 
 <code>String.valueOf(byte)</code>.  Returns <code>"null"</code> if 
 <code>a</code> is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(char)</code>.  Returns <code>"null"</code> if <code>a</code>
  is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(double)</code>.  Returns <code>"null"</code> if <code>a</code>
  is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(float)</code>.  Returns <code>"null"</code> if <code>a</code>
  is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(int)</code>.  Returns <code>"null"</code> if <code>a</code> is 
 <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(long)</code>.  Returns <code>"null"</code> if <code>a</code>
  is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 ...
 <code>Object</code>, which describes their <i>identities</i> rather than
  their contents. 
 <p>The value returned by this method is equal to the value that would
  be returned by <code>Arrays.asList(a).toString()</code>, unless <code>a</code>
  is <code>null</code>, in which case <code>"null"</code> is returned.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
...
/*!
 ...
 The string representation consists of a list of the array's elements,
  ...
  separated by the characters <code>", "</code> (a comma followed by a
  space).  Elements are converted to strings as by 
 <code>String.valueOf(short)</code>.  Returns <code>"null"</code> if <code>a</code>
  is <code>null</code>.
 @param a the array whose string representation to return
 @return a string representation of <code>a</code>
 @since 1.5
...
/*!
 @brief Checks that <code>fromIndex</code> and <code>toIndex</code> are in
  the range and throws an exception if they aren't.
 */
+ (void)rangeCheckWithInt:(jint)arrayLength
                  withInt:(jint)fromIndex
                  withInt:(jint)toIndex;
...
FOUNDATION_EXPORT void JavaUtilArrays_rangeCheckWithInt_withInt_withInt_(jint arrayLength, jint fromIndex, jint toIndex);
...
FOUNDATION_EXPORT jboolean JavaUtilArrays_equalsWithNSObjectArray_withInt_withInt_withNSObjectArray_withInt_withInt_(IOSObjectArray *a, jint aFromIndex, jint aToIndex, IOSObjectArray *b, jint bFromIndex, jint bToIndex);

FOUNDATION_EXPORT jboolean JavaUtilArrays_equalsWithNSObjectArray_withNSObjectArray_withJavaUtilComparator_(IOSObjectArray *a, IOSObjectArray *a2, id<JavaUtilComparator> cmp);

FOUNDATION_EXPORT jboolean JavaUtilArrays_equalsWithNSObjectArray_withInt_withInt_withNSObjectArray_withInt_withInt_withJavaUtilComparator_(IOSObjectArray *a, jint aFromIndex, jint aToIndex, IOSObjectArray *b, jint bFromIndex, jint bToIndex, id<JavaUtilComparator> cmp);
