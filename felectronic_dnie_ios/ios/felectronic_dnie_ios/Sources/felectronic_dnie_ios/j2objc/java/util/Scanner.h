...
/*!
 ...
 <p>A <code>Scanner</code> breaks its input into tokens using a
  ...
  various <code>next</code> methods. 
...
@endcode</blockquote>
 ...
 <p>The <a id="default-delimiter">default whitespace delimiter</a> used
  by a scanner is as recognized by <code>Character.isWhitespace()</code>
 . The <code>reset()</code>
  method will reset the value of the scanner's delimiter to the default
  whitespace delimiter regardless of whether it was previously changed. 
 <p>A scanning operation may block waiting for input. 
 <p>The <code>next</code> and <code>hasNext</code> methods and their
  companion methods (such as <code>nextInt</code> and 
 <code>hasNextInt</code>) first skip any input that matches the delimiter
  pattern, and then attempt to return the next token. Both <code>hasNext()</code>
  and <code>next()</code> methods may block waiting for further input.  Whether a 
 <code>hasNext()</code> method blocks has no connection to whether or not its
  associated <code>next()</code> method will block. The <code>tokens</code> method
  may also block waiting for input. 
 <p>The <code>findInLine()</code>,
  <code>findWithinHorizon()</code>,
  <code>skip()</code>, and <code>findAll()</code>
 ...
 <p>Depending upon the type of delimiting pattern, empty tokens may be
  returned. For example, the pattern <code>"\\s+"</code> will return no empty
  tokens since it matches multiple instances of the delimiter. The delimiting
  pattern <code>"\\s"</code> could return empty tokens since it only passes one
  space at a time. 
 <p> A scanner can read text from any object which implements the <code>java.lang.Readable</code>
  ...
  readable's <code>read()</code> method throws an <code>java.io.IOException</code>
  then the scanner assumes that the end of the input
  has been reached.  The most recent <code>IOException</code> thrown by the
 ...
 <a id="initial-locale">initial locale </a>is the value returned by the <code>Locale.getDefault(Locale.Category.FORMAT)</code>
 ...
 <p>The localized formats are defined in terms of the following parameters,
  ...
  object, <code>df</code>, and its and 
 ...
 <dl>
    <dt><i>NonAsciiDigit</i>:
        <dd>A non-ASCII character c for which
             <code>Character.isDigit</code><code>(c)</code>
                         returns&nbsp;true
    <dt><i>Non0Digit</i>:
        <dd><code>[1-</code><i>Rmax</i><code>] |</code><i>NonASCIIDigit</i>
    <dt><i>Digit</i>:
        <dd><code>[0-</code><i>Rmax</i><code>] |</code><i>NonASCIIDigit</i>
 ...
 <i>Digit</i><code>?</code>
        <dd>&nbsp;&nbsp;&nbsp;&nbsp;<code>(&nbsp;</code><i>LocalGroupSeparator</i>
                          ...
                          <i>Digit</i><code>)+ )</code>
    <dt><i>Numeral</i>:
        <dd><code>( (</code><i>Digit</i><code>+ )
                |</code>
 <i>GroupedNumeral</i><code>)</code>
    <dt><a id="Integer-regex"><i>Integer</i>:</a>
        <dd><code>( [-+]? (</code><i>Numeral</i><code>) )</code>
        <dd><code>|</code><i>LocalPositivePrefix</i> <i>Numeral</i>
                       <i>LocalPositiveSuffix</i>
        <dd><code>|</code><i>LocalNegativePrefix</i> <i>Numeral</i>
                  <i>LocalNegativeSuffix</i>
    <dt><i>DecimalNumeral</i>:
        <dd><i>Numeral</i>
        <dd><code>|</code><i>Numeral</i>
                  <i>LocalDecimalSeparator</i>
                  <i>Digit</i><code>*</code>
        <dd><code>|</code><i>LocalDecimalSeparator</i>
                  <i>Digit</i><code>+</code>
    <dt><i>Exponent</i>:
        <dd><code>( [eE] [+-]?</code><i>Digit</i><code>+ )</code>
    <dt><a id="Decimal-regex"><i>Decimal</i>:</a>
        <dd><code>( [-+]?</code><i>DecimalNumeral</i>
                          <i>Exponent</i><code>? )</code>
        <dd><code>|</code><i>LocalPositivePrefix</i>
                  <i>DecimalNumeral</i>
                  <i>LocalPositiveSuffix</i>
                  <i>Exponent</i><code>?</code>
        <dd><code>|</code><i>LocalNegativePrefix</i>
                  <i>DecimalNumeral</i>
                  <i>LocalNegativeSuffix</i>
                  <i>Exponent</i><code>?</code>
    <dt><i>HexFloat</i>:
    ...
    <dt><i>NonNumber</i>:
        <dd><code>NaN
                           |</code>
 <i>LocalNan</i><code>| Infinity                          |</code>
 <i>LocalInfinity</i>
    <dt><i>SignedNonNumber</i>:
        <dd><code>( [-+]?</code><i>NonNumber</i><code>)</code>
        <dd><code>|</code><i>LocalPositivePrefix</i>
                  <i>NonNumber</i>
                  <i>LocalPositiveSuffix</i>
        <dd><code>|</code><i>LocalNegativePrefix</i>
    ...
    <dt><a id="Float-regex"><i>Float</i></a>:
        <dd><i>Decimal</i>
            <code>|</code><i>HexFloat</i>
            <code>|</code><i>SignedNonNumber</i>
...
/*!
 ...
 @param source A file to be scanned
 @param charset The charset used to convert bytes from the file          into characters to be scanned
 @throw IOException
...
/*!
 @brief Constructs a new <code>Scanner</code> that produces values scanned
  ...
  characters using the specified charset.
 @param source a channel to scan
 @param charset the encoding type used to convert bytes from the         channel into characters to be scanned
 @since 10
 */
- (instancetype __nonnull)initWithJavaNioChannelsReadableByteChannel:(id<JavaNioChannelsReadableByteChannel>)source
                                           withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset;
...
/*!
 ...
 readable also implements the <code>java.io.Closeable</code>
  interface then the readable's <code>close</code> method
...
/*!
 @brief Returns a stream of match results from this scanner.The stream
  contains the same results in the same order that would be returned by
  calling <code>findWithinHorizon(pattern, 0)</code> and then <code>match</code>
  successively as long as <code>findWithinHorizon()</code>
  finds matches.
 ...
 <p>Scanning starts upon initiation of the terminal stream operation, using the
  ...
  other than <code>close</code> and <code>ioException</code> may return undefined results
  or may cause undefined effects on the returned stream. The returned stream's source 
 <code>Spliterator</code> is <em>fail-fast</em> and will, on a best-effort basis, throw a 
 <code>java.util.ConcurrentModificationException</code> if any such calls are detected
 ...
 <p>If this scanner contains a resource that must be released, this scanner
  should be closed, either by calling its <code>close</code> method, or by
  closing the returned stream. Closing the stream will close the underlying scanner. 
 <code>IllegalStateException</code> is thrown if the scanner has been closed when this
  method is called, or if this scanner is closed during stream pipeline execution. 
 <p>As with the <code>findWithinHorizon()</code> methods, this method
 ...
 @throw NullPointerExceptionif pattern is null
 @throw IllegalStateExceptionif this scanner is closed
 @since 9
 */
- (id<JavaUtilStreamStream>)findAllWithJavaUtilRegexPattern:(JavaUtilRegexPattern *)pattern;

/*!
 @brief Returns a stream of match results that match the provided pattern string.
...
@endcode
 ...
 @return a sequential stream of match results
 @throw NullPointerExceptionif patString is null
 @throw IllegalStateExceptionif this scanner is closed
 @throw PatternSyntaxExceptionif the regular expression's syntax is invalid
 @since 9
 - seealso: java.util.regex.Pattern
 */
- (id<JavaUtilStreamStream>)findAllWithNSString:(NSString *)patString;
...
/*!
 ...
 <p>An invocation of this method of the form <code>findInLine(pattern)</code>
...
/*!
 ...
 <code>findWithinHorizon(pattern)</code> behaves in exactly the same way as
  the invocation 
 <code>findWithinHorizon(Pattern.compile(pattern), horizon)</code>.
 @param pattern a string specifying the pattern to search for
 @param horizon the search horizon
 @return the text that matched the specified pattern
 @throw IllegalStateExceptionif this scanner is closed
...
/*!
 ...
 <p> An invocation of this method of the form <code>hasNext(pattern)</code>
  behaves in exactly the same way as the invocation 
...
/*!
 ...
 @return true if and only if this scanner's next token is a valid
          <code>BigInteger</code>
 @throw IllegalStateExceptionif this scanner is closed
 @throw IllegalArgumentExceptionif the radix is out of range
 */
...
/*!
 ...
 <a href="#Integer-regex"><i>Integer</i></a> regular expression
  ...
  <code>findWithinHorizon()</code>, and <code>skip()</code>
...
/*!
 ...
 <p> An invocation of this method of the form <code>next(pattern)</code>
  behaves in exactly the same way as the invocation 
...
/*!
 ...
 <i>Decimal</i></a> regular expression defined
  above then the token is converted into a <code>BigDecimal</code> value as if
  by removing all group separators, mapping non-ASCII digits into ASCII
  digits via the <code>Character.digit</code>, and passing the
  resulting string to the <code>BigDecimal(String)</code>
  constructor.
 @return the <code>BigDecimal</code> scanned from the input
...
/*!
 ...
 .
 <p> An invocation of this method of the form 
 <code>nextBigInteger()</code> behaves in exactly the same way as the
  invocation <code>nextBigInteger(radix)</code>, where <code>radix</code>
  is the default radix of this scanner.
 @return the <code>BigInteger</code> scanned from the input
 @throw InputMismatchException
...
/*!
 ...
 <i>Integer</i></a> regular expression defined
  above then the token is converted into a <code>BigInteger</code> value as if
  by removing all group separators, mapping non-ASCII digits into ASCII
  digits via the <code>Character.digit</code>, and passing the
...
/*!
 @brief Scans the next token of the input as a <code>byte</code>.
 <p> An invocation of this method of the form 
 <code>nextByte()</code> behaves in exactly the same way as the
  invocation <code>nextByte(radix)</code>, where <code>radix</code>
  is the default radix of this scanner.
...
/*!
 ...
 <p> If the next token matches the <a href="#Integer-regex">
 <i>Integer</i></a> regular expression defined
  above then the token is converted into a <code>byte</code> value as if by
...
/*!
 @brief Scans the next token of the input as a <code>double</code>.
 This method will throw <code>InputMismatchException</code>
 ...
 <i>Float</i></a> regular expression defined above
  then the token is converted into a <code>double</code> value as if by
  removing all locale specific prefixes, group separators, and locale
  specific suffixes, then mapping non-ASCII digits into ASCII
  digits via <code>Character.digit</code>, prepending a
  negative sign (-) if the locale specific negative prefixes and suffixes
 ...
 <code>Double.parseDouble</code>. If the token matches
  ...
  appropriate.
 @return the <code>double</code> scanned from the input
 @throw InputMismatchException
...
/*!
 @brief Scans the next token of the input as a <code>float</code>.
 This method will throw <code>InputMismatchException</code>
 ...
 <p> If the next token matches the <a href="#Float-regex">
 <i>Float</i></a> regular expression defined above
  then the token is converted into a <code>float</code> value as if by
  removing all locale specific prefixes, group separators, and locale
  specific suffixes, then mapping non-ASCII digits into ASCII
  digits via <code>Character.digit</code>, prepending a
  negative sign (-) if the locale specific negative prefixes and suffixes
 ...
 <code>Float.parseFloat</code>. If the token matches
  ...
  appropriate.
 @return the <code>float</code> scanned from the input
 @throw InputMismatchException
 if the next token does not match the <i>Float</i>
          regular expression, or is out of range
 @throw NoSuchElementExceptionif input is exhausted
...
/*!
 @brief Scans the next token of the input as an <code>int</code>.
 <p> An invocation of this method of the form 
 <code>nextInt()</code> behaves in exactly the same way as the
  invocation <code>nextInt(radix)</code>, where <code>radix</code>
  is the default radix of this scanner.
...
/*!
 ...
 <p> If the next token matches the <a href="#Integer-regex">
 <i>Integer</i></a> regular expression defined
  above then the token is converted into an <code>int</code> value as if by
  removing all locale specific prefixes, group separators, and locale
  specific suffixes, then mapping non-ASCII digits into ASCII
  digits via <code>Character.digit</code>, prepending a
  negative sign (-) if the locale specific negative prefixes and suffixes
...
/*!
 @brief Scans the next token of the input as a <code>long</code>.
 <p> An invocation of this method of the form 
 <code>nextLong()</code> behaves in exactly the same way as the
  invocation <code>nextLong(radix)</code>, where <code>radix</code>
  is the default radix of this scanner.
 @return the <code>long</code> scanned from the input
 @throw InputMismatchException
 if the next token does not match the <i>Integer</i>
          regular expression, or is out of range
 @throw NoSuchElementExceptionif input is exhausted
...
/*!
 ...
 <p> If the next token matches the <a href="#Integer-regex">
 <i>Integer</i></a> regular expression defined
  above then the token is converted into a <code>long</code> value as if by
  removing all locale specific prefixes, group separators, and locale
  specific suffixes, then mapping non-ASCII digits into ASCII
  digits via <code>Character.digit</code>, prepending a
  negative sign (-) if the locale specific negative prefixes and suffixes
...
/*!
 @brief Scans the next token of the input as a <code>short</code>.
 <p> An invocation of this method of the form 
 <code>nextShort()</code> behaves in exactly the same way as the
  invocation <code>nextShort(radix)</code>, where <code>radix</code>
  is the default radix of this scanner.
 @return the <code>short</code> scanned from the input
 @throw InputMismatchException
 if the next token does not match the <i>Integer</i>
          regular expression, or is out of range
 @throw NoSuchElementExceptionif input is exhausted
...
/*!
 ...
 <p> If the next token matches the <a href="#Integer-regex">
 <i>Integer</i></a> regular expression defined
  above then the token is converted into a <code>short</code> value as if by
  removing all locale specific prefixes, group separators, and locale
  specific suffixes, then mapping non-ASCII digits into ASCII
  digits via <code>Character.digit</code>, prepending a
  negative sign (-) if the locale specific negative prefixes and suffixes
...
/*!
 ...
 <code>useDelimiter()</code>,
  <code>useLocale()</code>, or 
 <code>useRadix()</code>.
  
 <p> An invocation of this method of the form 
 <code>scanner.reset()</code> behaves in exactly the same way as the
  invocation 
 <blockquote>@code
...
/*!
 @brief Skips input that matches a pattern constructed from the specified
  string.
 <p> An invocation of this method of the form <code>skip(pattern)</code>
  behaves in exactly the same way as the invocation 
...
/*!
 @brief Returns a stream of delimiter-separated tokens from this scanner.The
  stream contains the same tokens that would be returned, starting from
  this scanner's current state, by calling the <code>next</code> method
  repeatedly until the <code>hasNext</code> method returns false.
 <p>The resulting stream is sequential and ordered. All stream elements are
  non-null. 
 <p>Scanning starts upon initiation of the terminal stream operation, using the
  current state of this scanner. Subsequent calls to any methods on this scanner
 ...
 @since 9
 */
- (id<JavaUtilStreamStream>)tokens;
...
/*!
 ...
 <p> An invocation of this method of the form 
 <code>useDelimiter(pattern)</code> behaves in exactly the same way as the
  invocation <code>useDelimiter(Pattern.compile(pattern))</code>.
...
FOUNDATION_EXPORT void JavaUtilScanner_initWithJavaIoInputStream_withJavaNioCharsetCharset_(JavaUtilScanner *self, JavaIoInputStream *source, JavaNioCharsetCharset *charset);

FOUNDATION_EXPORT JavaUtilScanner *new_JavaUtilScanner_initWithJavaIoInputStream_withJavaNioCharsetCharset_(JavaIoInputStream *source, JavaNioCharsetCharset *charset) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilScanner *create_JavaUtilScanner_initWithJavaIoInputStream_withJavaNioCharsetCharset_(JavaIoInputStream *source, JavaNioCharsetCharset *charset);
...
FOUNDATION_EXPORT void JavaUtilScanner_initWithJavaIoFile_withJavaNioCharsetCharset_(JavaUtilScanner *self, JavaIoFile *source, JavaNioCharsetCharset *charset);

FOUNDATION_EXPORT JavaUtilScanner *new_JavaUtilScanner_initWithJavaIoFile_withJavaNioCharsetCharset_(JavaIoFile *source, JavaNioCharsetCharset *charset) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilScanner *create_JavaUtilScanner_initWithJavaIoFile_withJavaNioCharsetCharset_(JavaIoFile *source, JavaNioCharsetCharset *charset);
...
FOUNDATION_EXPORT void JavaUtilScanner_initWithJavaNioChannelsReadableByteChannel_withJavaNioCharsetCharset_(JavaUtilScanner *self, id<JavaNioChannelsReadableByteChannel> source, JavaNioCharsetCharset *charset);

FOUNDATION_EXPORT JavaUtilScanner *new_JavaUtilScanner_initWithJavaNioChannelsReadableByteChannel_withJavaNioCharsetCharset_(id<JavaNioChannelsReadableByteChannel> source, JavaNioCharsetCharset *charset) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilScanner *create_JavaUtilScanner_initWithJavaNioChannelsReadableByteChannel_withJavaNioCharsetCharset_(id<JavaNioChannelsReadableByteChannel> source, JavaNioCharsetCharset *charset);

J2OBJC_TYPE_LITERAL_HEADER(JavaUtilScanner)

#endif

#if !defined (JavaUtilScanner_TokenSpliterator_) && (INCLUDE_ALL_JavaUtilScanner || defined(INCLUDE_JavaUtilScanner_TokenSpliterator))
#define JavaUtilScanner_TokenSpliterator_

#define RESTRICT_JavaUtilSpliterators 1
#define INCLUDE_JavaUtilSpliterators_AbstractSpliterator 1
#include "java/util/Spliterators.h"

@class JavaLangBoolean;
@class JavaLangInteger;
@class JavaLangLong;
@class JavaUtilScanner;
@protocol JavaUtilFunctionConsumer;

@interface JavaUtilScanner_TokenSpliterator : JavaUtilSpliterators_AbstractSpliterator {
 @public
  jint expectedCount_;
}
...
- (jboolean)tryAdvanceWithJavaUtilFunctionConsumer:(id<JavaUtilFunctionConsumer>)cons;

#pragma mark Package-Private

- (instancetype __nonnull)initWithJavaUtilScanner:(JavaUtilScanner *)outer$;
...
J2OBJC_EMPTY_STATIC_INIT(JavaUtilScanner_TokenSpliterator)

FOUNDATION_EXPORT void JavaUtilScanner_TokenSpliterator_initWithJavaUtilScanner_(JavaUtilScanner_TokenSpliterator *self, JavaUtilScanner *outer$);

FOUNDATION_EXPORT JavaUtilScanner_TokenSpliterator *new_JavaUtilScanner_TokenSpliterator_initWithJavaUtilScanner_(JavaUtilScanner *outer$) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilScanner_TokenSpliterator *create_JavaUtilScanner_TokenSpliterator_initWithJavaUtilScanner_(JavaUtilScanner *outer$);

J2OBJC_TYPE_LITERAL_HEADER(JavaUtilScanner_TokenSpliterator)

#endif

#if !defined (JavaUtilScanner_FindSpliterator_) && (INCLUDE_ALL_JavaUtilScanner || defined(INCLUDE_JavaUtilScanner_FindSpliterator))
#define JavaUtilScanner_FindSpliterator_
...
@interface JavaUtilScanner_FindSpliterator : JavaUtilSpliterators_AbstractSpliterator {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(JavaUtilScanner_FindSpliterator)

J2OBJC_FIELD_SETTER(JavaUtilScanner_FindSpliterator, pattern_, JavaUtilRegexPattern *)

FOUNDATION_EXPORT void JavaUtilScanner_FindSpliterator_initWithJavaUtilScanner_withJavaUtilRegexPattern_(JavaUtilScanner_FindSpliterator *self, JavaUtilScanner *outer$, JavaUtilRegexPattern *pattern);

FOUNDATION_EXPORT JavaUtilScanner_FindSpliterator *new_JavaUtilScanner_FindSpliterator_initWithJavaUtilScanner_withJavaUtilRegexPattern_(JavaUtilScanner *outer$, JavaUtilRegexPattern *pattern) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilScanner_FindSpliterator *create_JavaUtilScanner_FindSpliterator_initWithJavaUtilScanner_withJavaUtilRegexPattern_(JavaUtilScanner *outer$, JavaUtilRegexPattern *pattern);

J2OBJC_TYPE_LITERAL_HEADER(JavaUtilScanner_FindSpliterator)
