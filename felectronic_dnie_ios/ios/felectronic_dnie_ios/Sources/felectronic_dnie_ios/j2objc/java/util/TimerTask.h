...
/*!
 @brief A task that can be scheduled for one-time or repeated execution by a 
 <code>Timer</code>.
 <p>A timer task is <em>not</em> reusable.  Once a task has been scheduled
  for execution on a <code>Timer</code> or cancelled, subsequent attempts to
  schedule it for execution will throw <code>IllegalStateException</code>.
 @author Josh Bloch
 @since 1.3
 */
