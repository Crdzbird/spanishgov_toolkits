...
@class JavaUtilLocale_IsoCountryCode;
...
/*!
 ...
 This filter operation on the given <code>locales</code> ensures that only
...
/*!
 ...
 This filter operation on the given <code>tags</code> ensures that only
  ...
  given <code>tags</code>. Note that if the given <code>tags</code> is an unordered 
 <code>Collection</code>, the returned matching tag out of duplicate tags is
...
/*!
 ...
 @throw NullPointerExceptionif category is null
...
/*!
 @brief Returns a name for the locale that is appropriate for display to the
  ...
  optional <a href=".
 /Locale.html#def_locale_extension">Unicode extensions</a>
...
/*!
 @brief Returns a name for the locale's script that is appropriate for display to
...
/*!
 ...
 Can be used to create Locales.
  This method is equivalent to <code>getISOCountries(Locale.IsoCountryCode type)</code>
  with <code>type</code>  <code>IsoCountryCode.PART1_ALPHA2</code>.
  <p>
 ...
 <p>
  ...
  can be retrieved from <code>getISOCountries(Locale.IsoCountryCode type)</code> with 
 <code>type</code>  <code>IsoCountryCode.PART3</code>.
 @return An array of ISO 3166 two-letter country codes.
 */
+ (IOSObjectArray * __nonnull)getISOCountries;

/*!
 @brief Returns a <code>Set</code> of ISO3166 country codes for the specified type.
 @param type<code>Locale.IsoCountryCode</code>  specified ISO code type.
 - seealso: java.util.Locale.IsoCountryCode
 @throw NullPointerExceptionif type is null
 @return a <code>Set</code> of ISO country codes for the specified type.
 @since 9
 */
+ (id<JavaUtilSet>)getISOCountriesWithJavaUtilLocale_IsoCountryCode:(JavaUtilLocale_IsoCountryCode *)type;
...
/*!
 @brief Returns the best-matching language tag using the lookup mechanism
  defined in RFC 4647.
 This lookup operation on the given <code>tags</code> ensures that the
...
/*!
 ...
 @throw NullPointerExceptionif category and/or newLocale is null
...
/*!
 ...
 <p>Examples: <ul>
  ...
  <li><code>_GB</code></li>
  <li><code>en_US_WIN</code></li>
  <li><code>de__POSIX</code></li>
  <li><code>zh_CN_#Hans</code></li>
  <li><code>zh_TW_#Hant_x-java</code></li>
  <li><code>th_TH_TH_#u-nu-thai</code></li></ul>
...
FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilLocale_getISOCountriesWithJavaUtilLocale_IsoCountryCode_(JavaUtilLocale_IsoCountryCode *type);
...
#if !defined (JavaUtilLocale_IsoCountryCode_) && (INCLUDE_ALL_JavaUtilLocale || defined(INCLUDE_JavaUtilLocale_IsoCountryCode))
#define JavaUtilLocale_IsoCountryCode_
...
typedef NS_ENUM(jint, JavaUtilLocale_IsoCountryCode_Enum) {
  JavaUtilLocale_IsoCountryCode_Enum_PART1_ALPHA2 = 0,
};
#if J2OBJC_IMPORTED_BY_JAVA_IMPLEMENTATION
#define JavaUtilLocale_IsoCountryCode_ORDINAL jint
#else
#define JavaUtilLocale_IsoCountryCode_ORDINAL JavaUtilLocale_IsoCountryCode_Enum
#endif


/*!
 @brief Enum for specifying the type defined in ISO 3166.This enum is used to
  retrieve the two-letter ISO3166-1 alpha-2, three-letter ISO3166-1
  alpha-3, four-letter ISO3166-3 country codes.
 - seealso: #getISOCountries(Locale.IsoCountryCode)
 @since 9
 */
@interface JavaUtilLocale_IsoCountryCode : JavaLangEnum

#pragma mark Public

+ (JavaUtilLocale_IsoCountryCode *)valueOfWithNSString:(NSString *)name;
...
/*!
 @brief Concrete implementation of this method attempts to compute value
  for iso3166CodesMap for each IsoCountryCode type key.
 */
- (id<JavaUtilSet>)createCountryCodeSet;

/*!
 @brief This method is called from Locale class to retrieve country code set
  for getISOCountries(type)
 */
+ (id<JavaUtilSet>)retrieveISOCountryCodesWithJavaUtilLocale_IsoCountryCode:(JavaUtilLocale_IsoCountryCode *)type;

- (JavaUtilLocale_IsoCountryCode_Enum)toNSEnum;

- (JavaUtilLocale_IsoCountryCode_ORDINAL)ordinal;

@end

J2OBJC_STATIC_INIT(JavaUtilLocale_IsoCountryCode)

/*! INTERNAL ONLY - Use enum accessors declared below. */
FOUNDATION_EXPORT JavaUtilLocale_IsoCountryCode *JavaUtilLocale_IsoCountryCode_values_[];

/*!
 @brief PART1_ALPHA2 is used to represent the ISO3166-1 alpha-2 two letter
  country codes.
 */
inline JavaUtilLocale_IsoCountryCode *JavaUtilLocale_IsoCountryCode_get_PART1_ALPHA2(void);
J2OBJC_ENUM_CONSTANT(JavaUtilLocale_IsoCountryCode, PART1_ALPHA2)

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilLocale_IsoCountryCode_retrieveISOCountryCodesWithJavaUtilLocale_IsoCountryCode_(JavaUtilLocale_IsoCountryCode *type);

FOUNDATION_EXPORT IOSObjectArray *JavaUtilLocale_IsoCountryCode_values(void);

FOUNDATION_EXPORT JavaUtilLocale_IsoCountryCode *JavaUtilLocale_IsoCountryCode_valueOfWithNSString_(NSString *name);

FOUNDATION_EXPORT JavaUtilLocale_IsoCountryCode *JavaUtilLocale_IsoCountryCode_fromOrdinal(JavaUtilLocale_IsoCountryCode_ORDINAL ordinal);

J2OBJC_TYPE_LITERAL_HEADER(JavaUtilLocale_IsoCountryCode)
...
J2OBJC_FIELD_SETTER(JavaUtilLocale_Category, extensionsKey_, NSString *)
...
@endcode
 ...
 <table class="striped">
  ...
  <th scope="col">Language Priority List: <code>"de-DE"</code></th>
  <th scope="col">Language Priority List: <code>"de-*-DE"</code></th>
  </tr>
  </thead>
  <tbody>
...
/*!
 ...
 @throw NullPointerExceptionif the given <code>range</code> is
      <code>null</code>
 @throw IllegalArgumentExceptionif the given <code>range</code> does not
...
/*!
 ...
 @throw IllegalArgumentExceptionif the given <code>range</code> does not
  comply with the syntax of the language range mentioned in RFC 4647
  or if the given <code>weight</code> is less than <code>MIN_WEIGHT</code>
  or greater than <code>MAX_WEIGHT</code>
 */
- (instancetype __nonnull)initWithNSString:(NSString *)range
...
/*!
 @brief Returns an informative string representation of this <code>LanguageRange</code>
  object, consisting of language range and weight if the range is
  weighted and the weight is less than the max weight.
 @return a string representation of this <code>LanguageRange</code> object.
 */
