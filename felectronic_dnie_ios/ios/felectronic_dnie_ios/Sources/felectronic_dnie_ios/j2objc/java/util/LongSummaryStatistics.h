...
FOUNDATION_EXPORT void JavaUtilLongSummaryStatistics_initWithLong_withLong_withLong_withLong_(JavaUtilLongSummaryStatistics *self, jlong count, jlong min, jlong max, jlong sum);

FOUNDATION_EXPORT JavaUtilLongSummaryStatistics *new_JavaUtilLongSummaryStatistics_initWithLong_withLong_withLong_withLong_(jlong count, jlong min, jlong max, jlong sum) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilLongSummaryStatistics *create_JavaUtilLongSummaryStatistics_initWithLong_withLong_withLong_withLong_(jlong count, jlong min, jlong max, jlong sum);
