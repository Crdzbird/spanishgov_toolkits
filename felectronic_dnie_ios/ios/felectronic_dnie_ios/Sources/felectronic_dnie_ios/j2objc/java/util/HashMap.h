...
/*!
 @brief Hash table based implementation of the <code>Map</code> interface.This
  implementation provides all of the optional map operations, and permits 
 <code>null</code> values and the <code>null</code> key.
 (The <code>HashMap</code>
  class is roughly equivalent to <code>Hashtable</code>, except that it is
 ...
 <code>HashMap</code> instance (the number of buckets) plus its size (the number
  of key-value mappings).  Thus, it's very important not to set the initial
  capacity too high (or the load factor too low) if iteration performance is
  important. 
 <p>An instance of <code>HashMap</code> has two parameters that affect its
 ...
 <p>As a general rule, the default load factor (.75) offers a good
  ...
  the operations of the <code>HashMap</code> class, including 
 <code>get</code> and <code>put</code>).  The expected number of entries in
  the map and its load factor should be taken into account when
  setting its initial capacity, so as to minimize the number of
  rehash operations.  If the initial capacity is greater than the
  maximum number of entries divided by the load factor, no rehash
  operations will ever occur. 
 <p>If many mappings are to be stored in a <code>HashMap</code>
...
/*!
 @brief Constructs an empty <code>HashMap</code> with the default initial capacity
  (16) and the default load factor (0.75).
 */
- (instancetype __nonnull)init;

/*!
 @brief Constructs an empty <code>HashMap</code> with the specified initial
...
/*!
 @brief Constructs a new <code>HashMap</code> with the same mappings as the
...
/*!
 @brief Returns a shallow copy of this <code>HashMap</code> instance: the keys and
...
/*!
 ...
 @throw ConcurrentModificationExceptionif it is detected that the
...
/*!
 @brief Returns <code>true</code> if this map contains a mapping for the
  specified key.
 ...
 */
- (JavaUtilHashMap_Node *)getNodeWithId:(id)key;
...
/*!
 @brief Fills an array with this map keys and returns it.This method assumes
  that input array is big enough to fit all the keys.
 Use 
 <code>prepareArray(Object[])</code> to ensure this.
 @param a an array to fill
 @return supplied array
 */
- (IOSObjectArray *)keysToArrayWithNSObjectArray:(IOSObjectArray *)a;
...
/*!
 @brief Prepares the array for <code>Collection.toArray(Object[])</code> implementation.
 ...
 @param a an original array passed to <code>toArray()</code>  method
 @return an array ready to be filled and returned from <code>toArray()</code> method.
 */
- (IOSObjectArray *)prepareArrayWithNSObjectArray:(IOSObjectArray *)a;
...
/*!
 @brief Fills an array with this map values and returns it.This method assumes
  that input array is big enough to fit all the values.
 Use 
 <code>prepareArray(Object[])</code> to ensure this.
 @param a an array to fill
 @return supplied array
 */
- (IOSObjectArray *)valuesToArrayWithNSObjectArray:(IOSObjectArray *)a;
