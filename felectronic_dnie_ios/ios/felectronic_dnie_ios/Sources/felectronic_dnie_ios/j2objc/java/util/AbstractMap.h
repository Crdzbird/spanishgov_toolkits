...
/*!
 @brief This class provides a skeletal implementation of the <code>Map</code>
  interface, to minimize the effort required to implement this interface.
 <p>To implement an unmodifiable map, the programmer needs only to extend this
  class and provide an implementation for the <code>entrySet</code> method, which
  returns a set-view of the map's mappings.  Typically, the returned set
  will, in turn, be implemented atop <code>AbstractSet</code>.  This set should
  not support the <code>add</code> or <code>remove</code> methods, and its iterator
  should not support the <code>remove</code> method. 
 <p>To implement a modifiable map, the programmer must additionally override
  this class's <code>put</code> method (which otherwise throws an 
 <code>UnsupportedOperationException</code>), and the iterator returned by 
 <code>entrySet().iterator()</code> must additionally implement its 
 <code>remove</code> method. 
 <p>The programmer should generally provide a void (no argument) and map
  constructor, as per the recommendation in the <code>Map</code> interface
  specification. 
...
/*!
 @brief Returns a shallow copy of this <code>AbstractMap</code> instance: the keys
...
J2OBJC_FIELD_SETTER(JavaUtilAbstractMap, values_, id<JavaUtilCollection>)
...
/*!
 @brief An Entry maintaining a key and a value.The value may be
  changed using the <code>setValue</code> method.
 This class
...
/*!
 @brief An Entry maintaining an immutable key and value.This class
  does not support method <code>setValue</code>.
 This class may be
...
/*!
 ...
 <code>UnsupportedOperationException</code>, as this class implements
