...
/*!
 @brief Resizable-array implementation of the <code>List</code> interface.Implements
  all optional list operations, and permits all elements, including 
 <code>null</code>.
 In addition to implementing the <code>List</code> interface,
  this class provides methods to manipulate the size of the array that is
  used internally to store the list.  (This class is roughly equivalent to 
 <code>Vector</code>, except that it is unsynchronized.) 
 <p>The <code>size</code>, <code>isEmpty</code>, <code>get</code>, <code>set</code>,
  <code>iterator</code>, and <code>listIterator</code> operations run in constant
  time.  The <code>add</code> operation runs in <i>amortized constant time</i>,
  that is, adding n elements requires O(n) time.  All of the other operations
  run in linear time (roughly speaking).  The constant factor is low compared
  to that for the <code>LinkedList</code> implementation. 
 <p>Each <code>ArrayList</code> instance has a <i>capacity</i>.  The capacity is
  the size of the array used to store the elements in the list.  It is always
  at least as large as the list size.  As elements are added to an ArrayList,
  its capacity grows automatically.  The details of the growth policy are not
  specified beyond the fact that adding an element has constant amortized
  time cost. 
 <p>An application can increase the capacity of an <code>ArrayList</code> instance
  before adding a large number of elements using the <code>ensureCapacity</code>
...
@endcode
 ...
 <code>listIterator</code> methods are <em>fail-fast</em>:
...
/*!
 @brief Returns a shallow copy of this <code>ArrayList</code> instance.
 (The
...
/*!
 @brief Increases the capacity of this <code>ArrayList</code> instance, if
...
/*!
 @brief Trims the capacity of this <code>ArrayList</code> instance to be the
...
- (jboolean)batchRemoveWithJavaUtilCollection:(id<JavaUtilCollection>)c
                                  withBoolean:(jboolean)complement
                                      withInt:(jint)from
                                      withInt:(jint)end;

- (void)checkInvariants;

+ (id)elementAtWithNSObjectArray:(IOSObjectArray *)es
                         withInt:(jint)index;

- (id)elementDataWithInt:(jint)index;

- (jboolean)equalsRangeWithJavaUtilList:(id<JavaUtilList>)other
                                withInt:(jint)from
                                withInt:(jint)to;

- (jint)hashCodeRangeWithInt:(jint)from
                     withInt:(jint)to;

- (jint)indexOfRangeWithId:(id)o
                   withInt:(jint)start
                   withInt:(jint)end;

- (jint)lastIndexOfRangeWithId:(id)o
                       withInt:(jint)start
                       withInt:(jint)end;

/*!
 @brief Removes all elements satisfying the given predicate, from index
...
FOUNDATION_EXPORT id JavaUtilArrayList_elementAtWithNSObjectArray_withInt_(IOSObjectArray *es, jint index);
 ...
 */
- (instancetype __nonnull)initWithJavaUtilArrayList:(JavaUtilArrayList *)outer$
                                            withInt:(jint)origin
                                            withInt:(jint)fence
...
FOUNDATION_EXPORT void JavaUtilArrayList_ArrayListSpliterator_initWithJavaUtilArrayList_withInt_withInt_withInt_(JavaUtilArrayList_ArrayListSpliterator *self, JavaUtilArrayList *outer$, jint origin, jint fence, jint expectedModCount);

FOUNDATION_EXPORT JavaUtilArrayList_ArrayListSpliterator *new_JavaUtilArrayList_ArrayListSpliterator_initWithJavaUtilArrayList_withInt_withInt_withInt_(JavaUtilArrayList *outer$, jint origin, jint fence, jint expectedModCount) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilArrayList_ArrayListSpliterator *create_JavaUtilArrayList_ArrayListSpliterator_initWithJavaUtilArrayList_withInt_withInt_withInt_(JavaUtilArrayList *outer$, jint origin, jint fence, jint expectedModCount);
