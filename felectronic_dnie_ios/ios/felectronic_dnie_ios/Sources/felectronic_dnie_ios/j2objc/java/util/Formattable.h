...
/*!
 @brief The <code>Formattable</code> interface must be implemented by any class that
  needs to perform custom formatting using the <code>'s'</code> conversion
...
@endcode
 ...
 <p> Formattables are not necessarily safe for multithreaded access.  Thread
  ...
  this interface. 
 <p> Unless otherwise specified, passing a <code>null</code> argument to
...
/*!
 ...
 <code>formatter</code> .  Implementing classes may call          <code>formatter.out()</code>
   ...
   or <code>Locale</code>  used by this          <code>formatter</code>
   respectively.
 ...
 @param width The minimum number of characters to be written to the output.
           ...
           <code>width</code>
   then the output will be padded by           <code> ' &nbsp; &nbsp; ' </code>  until the total number of characters          equals width.  The padding is at the beginning by default.  If          the <code>FormattableFlags.LEFT_JUSTIFY</code>  flag is set then the          padding will be at the end.  If <code>width</code>  is <code>-1</code>          then there is no minimum.
 @param precision The maximum number of characters to be written to the output.
           The precision is applied before the width, thus the output will
           be truncated to 
 <code>precision</code>  characters even if the          <code>width</code>  is greater than the 
 <code>precision</code> .  If          <code>precision</code>  is 
