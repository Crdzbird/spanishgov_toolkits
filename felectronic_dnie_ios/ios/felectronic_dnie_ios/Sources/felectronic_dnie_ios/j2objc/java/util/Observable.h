...
/*!
 ...
 <p>
  ...
  may be any object that implements interface <code>Observer</code>. After an
 ...
 <p>
  ...
  and is completely separate from the <code>wait</code> and <code>notify</code>
  mechanism of class <code>Object</code>.
  <p>
  When an observable object is newly created, its set of observers is
  empty. Two observers are considered the same if and only if the 
 <code>equals</code> method returns true for them.
 @author Chris Warth
...
/*!
 @brief Returns the number of observers of this <code>Observable</code> object.
...
/*!
 ...
 <blockquote><code>notifyObservers(null)</code>
 </blockquote>
 - seealso: java.util.Observable#clearChanged()
...
/*!
 @brief Indicates that this object has no longer changed, or that it has
  ...
  so that the <code>hasChanged</code> method will now return <code>false</code>.
...
/*!
 @brief Marks this <code>Observable</code> object as having been changed; the 
