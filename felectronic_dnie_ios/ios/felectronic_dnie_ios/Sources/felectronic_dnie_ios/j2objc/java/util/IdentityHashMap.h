...
/*!
 @brief This class implements the <code>Map</code> interface with a hash table, using
  reference-equality in place of object-equality when comparing keys (and
  values).In other words, in an <code>IdentityHashMap</code>, two keys 
 <code>k1</code> and <code>k2</code> are considered equal if and only if 
 <code>(k1==k2)</code>.
 (In normal <code>Map</code> implementations (like 
 <code>HashMap</code>) two keys <code>k1</code> and <code>k2</code> are considered equal
  if and only if <code>(k1==null ? k2==null : k1.equals(k2))</code>.)
  
 <p><b>This class is <i>not</i> a general-purpose <code>Map</code>
 ...
 <p>This class provides constant-time performance for the basic
  operations (<code>get</code> and <code>put</code>), assuming the system
...
@endcode
 ...
 <p>The iterators returned by the <code>iterator</code> method of the
  collections returned by all of this class's "collection view
  methods" are <i>fail-fast</i>: if the map is structurally modified
  at any time after the iterator is created, in any way except
  through the iterator's own <code>remove</code> method, the iterator
...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>expectedMaxSize</code> is negative
 */
...
/*!
 ...
 <code>Map.Entry</code>.  The set is backed by the map, so changes
  to the map are reflected in the set, and vice-versa.  If the
  map is modified while an iteration over the set is in progress,
  the results of the iteration are undefined.  The set supports
  element removal, which removes the corresponding mapping from
  the map, via the <code>Iterator.remove</code>, <code>Set.remove</code>,
  <code>removeAll</code>, <code>retainAll</code> and <code>clear</code>
  methods.  It does not support the <code>add</code> or 
 <code>addAll</code> methods. 
 <p>Like the backing map, the <code>Map.Entry</code> objects in the set
  returned by this method define key and value equality as
  reference-equality rather than object-equality.  This affects the
  behavior of the <code>equals</code> and <code>hashCode</code> methods of these 
 <code>Map.Entry</code> objects.  A reference-equality based <code>Map.Entry
  e</code>
  is equal to an object <code>o</code> if and only if <code>o</code> is a 
 <code>Map.Entry</code> and <code>e.getKey()==o.getKey() &&
  e.getValue()==o.getValue()</code>
 .  To accommodate these equals
  semantics, the <code>hashCode</code> method returns 
...
/*!
 ...
 More formally, this
  map is equal to another map <code>m</code> if and only if 
 <code>this.entrySet().equals(m.entrySet())</code>.
 ...
 <code>Object.equals</code> contract may be violated if this map is compared
  ...
  guaranteed to hold among <code>IdentityHashMap</code> instances.</b>
...
/*!
 ...
 This ensures that <code>m1.equals(m2)</code>
  implies that <code>m1.hashCode()==m2.hashCode()</code> for any two 
 <code>IdentityHashMap</code> instances <code>m1</code> and <code>m2</code>, as
 ...
 <code>entrySet</code> method, it is possible that the contractual
  ...
  an <code>IdentityHashMap</code> instance and the other is a normal map.</b>
...
/*!
 @brief Returns <code>true</code> if this identity hash map contains no key-value
  mappings.
 @return <code>true</code> if this identity hash map contains no key-value
          mappings
 */
- (jboolean)isEmpty;
...
/*!
 ...
 <code>clear</code> methods.  It does not support the <code>add</code> or 
 <code>addAll</code> methods. 
 ...
 <code>hashCode</code> methods.</b>
  
 <p><b>The <code>equals</code> method of the returned set returns <code>true</code>
 ...
 <code>Object.equals</code> contract is guaranteed to hold among sets
  returned by this method.</b>
  
 <p>The <code>hashCode</code> method of the returned set returns the sum of the 
 <i>identity hashcodes</i> of the elements in the set, rather than
  the sum of their hashcodes.  This is mandated by the change in the
  semantics of the <code>equals</code> method, in order to enforce the
  general contract of the <code>Object.hashCode</code> method among sets
...
/*!
 ...
 The collection is backed by the map, so changes to the map are
  ...
  <code>retainAll</code> and <code>clear</code> methods.  It does not
  support the <code>add</code> or <code>addAll</code> methods. 
 <p><b>While the object returned by this method implements the 
 ...
 <code>containsAll</code> methods.</b>
 */
