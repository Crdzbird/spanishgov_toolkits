...
/*!
 ...
 <p>The iterator returned by the <code>iterator</code> method traverses the
 ...
 <p>Null elements are not permitted.  Attempts to insert a null element
  ...
  properly. 
 <P>Like most collection implementations, <code>EnumSet</code> is not
...
@interface JavaUtilEnumSet : JavaUtilAbstractSet < NSCopying, JavaIoSerializable > {
 @public
  ...
  /*!
   @brief All of the values comprising E.
...
/*!
 ...
 @throw NullPointerExceptionif <code>elementType</code> is null
 */
...
/*!
 @brief Creates an enum set initialized from the specified collection.If
  the specified collection is an <code>EnumSet</code> instance, this static
  factory method behaves identically to <code>copyOf(EnumSet)</code>.
 Otherwise, the specified collection must contain at least one element
  (in order to determine the new enum set's element type).
 @param c the collection from which to initialize this enum set
 @return An enum set initialized from the given collection.
 @throw IllegalArgumentExceptionif <code>c</code> is not an
...
/*!
 ...
 @throw NullPointerExceptionif <code>e</code> is null
...
/*!
 @brief Returns a 
 <a href="../..
 /serialized-form.html#java.util.EnumSet.SerializationProxy">
  SerializationProxy</a>
  representing the state of this instance.
 @return a <code>SerializationProxy</code>
  representing the state of this instance
 */
- (id)writeReplace;
...
FOUNDATION_EXPORT IOSObjectArray *JavaUtilEnumSet_access$000(void);
