...
/*!
 ...
 <h2><a id="unmodifiable">Unmodifiable Sets</a></h2>
  <p>The <code>Set.of</code> and 
 <code>Set.copyOf</code> static factory methods
  provide a convenient way to create unmodifiable sets. The <code>Set</code>
...
/*!
 @brief Returns an unmodifiable set containing zero elements.
...
/*!
 @brief Returns an unmodifiable set containing one element.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the single element
 @return a <code>Set</code> containing the specified element
 @throw NullPointerExceptionif the element is <code>null</code>
 @since 9
 */
+ (id<JavaUtilSet>)ofWithId:(id)e1;

/*!
 @brief Returns an unmodifiable set containing two elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @return a <code>Set</code> containing the specified elements
 @throw IllegalArgumentExceptionif the elements are duplicates
 @throw NullPointerExceptionif an element is <code>null</code>
 @since 9
 */
+ (id<JavaUtilSet>)ofWithId:(id)e1
                     withId:(id)e2;
...
/*!
 @brief Returns an unmodifiable set containing three elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
 @return a <code>Set</code> containing the specified elements
 @throw IllegalArgumentExceptionif there are any duplicate elements
 @throw NullPointerExceptionif an element is <code>null</code>
 @since 9
 */
+ (id<JavaUtilSet>)ofWithId:(id)e1
...
/*!
 @brief Returns an unmodifiable set containing four elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing five elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing six elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing seven elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing eight elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing nine elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing ten elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param e1 the first element
 @param e2 the second element
 @param e3 the third element
...
/*!
 @brief Returns an unmodifiable set containing an arbitrary number of elements.
 See <a href="#unmodifiable">Unmodifiable Sets</a> for details.
 @param elements the elements to be contained in the set
 @return a <code>Set</code> containing the specified elements
 @throw IllegalArgumentExceptionif there are any duplicate elements
 @throw NullPointerExceptionif an element is <code>null</code> or if the array is <code>null</code>
 @since 9
 */
+ (id<JavaUtilSet>)ofWithNSObjectArray:(IOSObjectArray *)elements;

/*!
 @brief Returns an <a href="#unmodifiable">unmodifiable Set</a> containing the elements
  of the given Collection.The given Collection must not be null, and it must not
  contain any null elements.
 If the given Collection contains duplicate elements,
 ...
 @param coll a <code>Collection</code>  from which elements are drawn, must be non-null
 @return a <code>Set</code> containing the elements of the given <code>Collection</code>
 @throw NullPointerExceptionif coll is null, or if it contains any nulls
 @since 10
 */
+ (id<JavaUtilSet>)copyOfWithJavaUtilCollection:(id<JavaUtilCollection>)coll OBJC_METHOD_FAMILY_NONE;
...
FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_of(void);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_(id e1);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_(id e1, id e2);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_(id e1, id e2, id e3);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_(id e1, id e2, id e3, id e4);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5, id e6);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5, id e6, id e7);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5, id e6, id e7, id e8);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5, id e6, id e7, id e8, id e9);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithId_withId_withId_withId_withId_withId_withId_withId_withId_withId_(id e1, id e2, id e3, id e4, id e5, id e6, id e7, id e8, id e9, id e10);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_ofWithNSObjectArray_(IOSObjectArray *elements);

FOUNDATION_EXPORT id<JavaUtilSet> JavaUtilSet_copyOfWithJavaUtilCollection_(id<JavaUtilCollection> coll);
