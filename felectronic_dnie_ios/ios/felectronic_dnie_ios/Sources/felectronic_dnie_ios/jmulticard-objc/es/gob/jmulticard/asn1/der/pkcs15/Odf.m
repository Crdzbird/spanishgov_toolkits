...
#error "es/gob/jmulticard/asn1/der/pkcs15/Odf must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (NSString *)description {
  return JreStrcat("$@$@$@", @"ODF: \n Ruta hacia el CDF: ", [self getCdfPath], @"\n Ruta hacia el PrKDF: ", [self getPrKdfPath], @"\n Ruta hacia el PuKDF: ", [self getPuKdfPath]);
}
