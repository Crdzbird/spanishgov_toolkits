...
#error "es/gob/jmulticard/asn1/custom/fnmt/ceres/CeresX509CertificateAttributesContextSpecific must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (void)checkTagWithByte:(jbyte)tag {
  if (EsGobJmulticardAsn1CustomFnmtCeresCeresX509CertificateAttributesContextSpecific_TAG != tag) {
    @throw create_EsGobJmulticardAsn1Asn1Exception_initWithNSString_(JreStrcat("$$$$", @"CeresX509CertificateAttributesContextSpecific esperaba una etiqueta especifica de contexto ", EsGobJmulticardHexUtils_hexifyWithByteArray_withBoolean_([IOSByteArray arrayWithBytes:(jbyte[]){ EsGobJmulticardAsn1CustomFnmtCeresCeresX509CertificateAttributesContextSpecific_TAG } count:1], false), @" pero ha encontrado ", EsGobJmulticardHexUtils_hexifyWithByteArray_withBoolean_([IOSByteArray arrayWithBytes:(jbyte[]){ tag } count:1], false)));
  }
}
