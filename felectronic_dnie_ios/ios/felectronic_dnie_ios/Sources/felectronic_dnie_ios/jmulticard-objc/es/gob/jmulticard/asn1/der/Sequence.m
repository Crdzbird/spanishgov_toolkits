...
#error "es/gob/jmulticard/asn1/der/Sequence must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (void)decodeValue {
  EsGobJmulticardAsn1Tlv *mainTlv = create_EsGobJmulticardAsn1Tlv_initWithByteArray_([self getBytes]);
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(elementsTypes_))->size_; i++) {
    remainingBytes = [IOSByteArray arrayWithLength:((IOSByteArray *) nil_chk(rawValue))->size_ - offset];
    ...
    @catch (JavaLangException *e) {
      ...
      @throw create_EsGobJmulticardAsn1Asn1Exception_initWithNSString_withJavaLangThrowable_(JreStrcat("$I$$$", @"Error en el elemento ", i, @" (", [((IOSClass *) nil_chk([((EsGobJmulticardAsn1OptionalDecoderObjectElement *) nil_chk(IOSObjectArray_Get(elementsTypes_, i))) getElementType])) getName], @") de la secuencia ASN.1"), e);
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LEsGobJmulticardAsn1DecoderObject;", 0x14, 2, 3, -1, -1, -1, -1 },
  };
