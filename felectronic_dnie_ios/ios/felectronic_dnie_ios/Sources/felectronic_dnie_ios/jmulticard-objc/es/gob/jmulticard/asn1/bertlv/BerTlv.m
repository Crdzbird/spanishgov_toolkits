...
#error "es/gob/jmulticard/asn1/bertlv/BerTlv must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (IOSByteArray *)getValue {
  ...
  IOSByteArray *out = [IOSByteArray arrayWithLength:value_->size_];
...
- (NSString *)description {
  return JreStrcat("$@$I$$C", @"[TLV: T=", tag_, @"; L=", length_, @"d; V=", (value_ == nil ? @"null" : EsGobJmulticardHexUtils_hexifyWithByteArray_withBoolean_(value_, false)), ']');
}
...
EsGobJmulticardAsn1BertlvBerTlv *EsGobJmulticardAsn1BertlvBerTlv_createInstanceWithByteArray_(IOSByteArray *stream) {
  ...
  EsGobJmulticardAsn1BertlvBerTlv *tlv = create_EsGobJmulticardAsn1BertlvBerTlv_init();
  EsGobJmulticardAsn1BertlvBerTlv_decodeWithJavaIoByteArrayInputStream_(tlv, create_JavaIoByteArrayInputStream_initWithByteArray_(stream));
  return tlv;
}
...
void EsGobJmulticardAsn1BertlvBerTlv_decodeWithJavaIoByteArrayInputStream_(EsGobJmulticardAsn1BertlvBerTlv *self, JavaIoByteArrayInputStream *stream) {
  JreStrongAssignAndConsume(&self->tag_, new_EsGobJmulticardAsn1BertlvBerTlvIdentifier_initPackagePrivate());
  ...
  if (self->length_ == 128) {
    ...
    len -= 2;
    JreStrongAssignAndConsume(&self->value_, [IOSByteArray newArrayWithLength:len]);
    [stream reset];
    ...
    JreStrongAssignAndConsume(&self->value_, [IOSByteArray newArrayWithLength:self->length_]);
