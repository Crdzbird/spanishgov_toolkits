...
#error "es/gob/jmulticard/apdu/iso7816four/MseSetAuthenticationKeyApduCommand must not be compiled with ARC (-fobjc-arc)"
#endif
...
void EsGobJmulticardApduIso7816fourMseSetAuthenticationKeyApduCommand_initWithByte_withByteArray_withByteArray_(EsGobJmulticardApduIso7816fourMseSetAuthenticationKeyApduCommand *self, jbyte cla, IOSByteArray *publicKeyFileId, IOSByteArray *privateKeyRef) {
  EsGobJmulticardApduIso7816fourMseSetAuthenticationTemplateApduCommand_initWithByte_withByteArray_(self, cla, EsGobJmulticardApduIso7816fourMseSetAuthenticationKeyApduCommand_buidDataWithByteArray_withByteArray_(publicKeyFileId, privateKeyRef));
}
...
IOSByteArray *EsGobJmulticardApduIso7816fourMseSetAuthenticationKeyApduCommand_buidDataWithByteArray_withByteArray_(IOSByteArray *publicKeyFileId, IOSByteArray *privateKeyRef) {
  ...
  IOSByteArray *publicKeyFileIdCompleted = [IOSByteArray arrayWithLength:12];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(publicKeyFileId, 0, publicKeyFileIdCompleted, publicKeyFileIdCompleted->size_ - ((IOSByteArray *) nil_chk(publicKeyFileId))->size_, publicKeyFileId->size_);
  ...
  IOSByteArray *ret = [IOSByteArray arrayWithLength:publicKeyFileIdCompleted->size_ + ((IOSByteArray *) nil_chk(privateKeyRef))->size_ + 4];
