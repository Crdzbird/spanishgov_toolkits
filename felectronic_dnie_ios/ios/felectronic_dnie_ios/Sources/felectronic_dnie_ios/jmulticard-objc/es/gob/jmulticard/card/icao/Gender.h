...
typedef NS_ENUM(jint, EsGobJmulticardCardIcaoGender_Enum) {
...
#define EsGobJmulticardCardIcaoGender_ORDINAL jint
#else
#define EsGobJmulticardCardIcaoGender_ORDINAL EsGobJmulticardCardIcaoGender_Enum
#endif


@interface EsGobJmulticardCardIcaoGender : JavaLangEnum

@property (readonly, class, nonnull) EsGobJmulticardCardIcaoGender *MALE NS_SWIFT_NAME(MALE);
@property (readonly, class, nonnull) EsGobJmulticardCardIcaoGender *FEMALE NS_SWIFT_NAME(FEMALE);
@property (readonly, class, nonnull) EsGobJmulticardCardIcaoGender *OTHER NS_SWIFT_NAME(OTHER);
#pragma mark Public
...
FOUNDATION_EXPORT EsGobJmulticardCardIcaoGender *EsGobJmulticardCardIcaoGender_fromOrdinal(EsGobJmulticardCardIcaoGender_ORDINAL ordinal);
