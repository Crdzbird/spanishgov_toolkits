...
#error "es/gob/jmulticard/asn1/der/pkcs15/CommonCertificateAttributes must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (IOSByteArray *)getId {
  if ([self getElementAtWithInt:0] == nil) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(@"No existe el identificador dentro del objeto");
  }
