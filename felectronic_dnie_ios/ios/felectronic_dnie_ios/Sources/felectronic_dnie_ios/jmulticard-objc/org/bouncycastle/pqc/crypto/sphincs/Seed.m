...
#error "org/bouncycastle/pqc/crypto/sphincs/Seed must not be compiled with ARC (-fobjc-arc)"
#endif
...
void OrgBouncycastlePqcCryptoSphincsSeed_get_seedWithOrgBouncycastlePqcCryptoSphincsHashFunctions_withByteArray_withInt_withByteArray_withOrgBouncycastlePqcCryptoSphincsTree_leafaddr_(OrgBouncycastlePqcCryptoSphincsHashFunctions *hs, IOSByteArray *seed, jint seedOff, IOSByteArray *sk, OrgBouncycastlePqcCryptoSphincsTree_leafaddr *a) {
  ...
  IOSByteArray *buffer = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoSphincsSPHINCS256Config_SEED_BYTES + 8];
  jlong t;
  jint i;
...
void OrgBouncycastlePqcCryptoSphincsSeed_prgWithByteArray_withInt_withLong_withByteArray_withInt_(IOSByteArray *r, jint rOff, jlong rlen, IOSByteArray *key, jint keyOff) {
  OrgBouncycastlePqcCryptoSphincsSeed_initialize();
  IOSByteArray *nonce = [IOSByteArray arrayWithLength:8];
  id<OrgBouncycastleCryptoStreamCipher> cipher = create_OrgBouncycastleCryptoEnginesChaChaEngine_initWithInt_(12);
  [cipher init__WithBoolean:true withOrgBouncycastleCryptoCipherParameters:create_OrgBouncycastleCryptoParamsParametersWithIV_initWithOrgBouncycastleCryptoCipherParameters_withByteArray_(create_OrgBouncycastleCryptoParamsKeyParameter_initWithByteArray_withInt_withInt_(key, keyOff, 32), nonce)];
