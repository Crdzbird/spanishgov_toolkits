...
#error "org/bouncycastle/pqc/crypto/cmce/GF13 must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (jshort)gf_mulWithShort:(jshort)in0
  ...
  t1 = in1;
  tmp = t0 * (t1 & 1);
  for (i = 1; i < GFBITS_; i++) tmp ^= (t0 * (t1 & (JreLShift32(1, i))));
...
- (jshort)gf_sq2WithShort:(jshort)inArg {
  jint i;
  IOSLongArray *B = [IOSLongArray arrayWithLongs:(jlong[]){ (jlong) 0x1111111111111111LL, (jlong) 0x0303030303030303LL, (jlong) 0x000F000F000F000FLL, (jlong) 0x000000FF000000FFLL } count:4];
  IOSLongArray *M = [IOSLongArray arrayWithLongs:(jlong[]){ (jlong) 0x0001FF0000000000LL, (jlong) 0x000000FF80000000LL, (jlong) 0x000000007FC00000LL, (jlong) 0x00000000003FE000LL } count:4];
  jlong x = inArg;
  jlong t;
...
jshort OrgBouncycastlePqcCryptoCmceGF13_gf_sqmulWithShort_withShort_(OrgBouncycastlePqcCryptoCmceGF13 *self, jshort inArg, jshort m) {
  ...
  jlong t1;
  jlong t;
  IOSLongArray *M = [IOSLongArray arrayWithLongs:(jlong[]){ (jlong) 0x0000001FF0000000LL, (jlong) 0x000000000FF80000LL, (jlong) 0x000000000007E000LL } count:3];
  t0 = inArg;
  t1 = m;
...
jshort OrgBouncycastlePqcCryptoCmceGF13_gf_sq2mulWithShort_withShort_(OrgBouncycastlePqcCryptoCmceGF13 *self, jshort inArg, jshort m) {
  ...
  jlong t1;
  jlong t;
  IOSLongArray *M = [IOSLongArray arrayWithLongs:(jlong[]){ (jlong) 0x1FF0000000000000LL, (jlong) 0x000FF80000000000LL, (jlong) 0x000007FC00000000LL, (jlong) 0x00000003FE000000LL, (jlong) 0x0000000001FE0000LL, (jlong) 0x000000000001E000LL } count:6];
  t0 = inArg;
  t1 = m;
