...
#error "org/bouncycastle/crypto/engines/AESEngine must not be compiled with ARC (-fobjc-arc)"
#endif
...
withOrgBouncycastleCryptoCipherParameters:(id<OrgBouncycastleCryptoCipherParameters>)params {
  if ([params isKindOfClass:[OrgBouncycastleCryptoParamsKeyParameter class]]) {
    JreStrongAssign(&WorkingKey_, OrgBouncycastleCryptoEnginesAESEngine_generateWorkingKeyWithByteArray_withBoolean_(self, [((OrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((OrgBouncycastleCryptoParamsKeyParameter *) params))) getKey], forEncryption));
    self->forEncryption_ = forEncryption;
    if (forEncryption) {
      JreStrongAssign(&s_, OrgBouncycastleUtilArrays_cloneWithByteArray_(OrgBouncycastleCryptoEnginesAESEngine_S));
    }
    else {
      JreStrongAssign(&s_, OrgBouncycastleUtilArrays_cloneWithByteArray_(OrgBouncycastleCryptoEnginesAESEngine_Si));
    }
    return;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to AES init - ", [[((id<OrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
                    ...
                    withByteArray:(IOSByteArray *)outArg
                          withInt:(jint)outOff {
  if (WorkingKey_ == nil) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(@"AES engine not initialised");
  }
...
- (id<OrgBouncycastleCryptoBlockCipher>)newInstance {
  return create_OrgBouncycastleCryptoEnginesAESEngine_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[7].selector = @selector(init__WithBoolean:withOrgBouncycastleCryptoCipherParameters:);
  ...
  methods[12].selector = @selector(encryptBlockWithByteArray:withInt:withByteArray:withInt:withIntArray2:);
  methods[13].selector = @selector(decryptBlockWithByteArray:withInt:withByteArray:withInt:withIntArray2:);
  methods[14].selector = @selector(newInstance);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "S", "[B", .constantValue.asLong = 0, 0x1a, -1, 16, -1, -1 },
    { "Si", "[B", .constantValue.asLong = 0, 0x1a, -1, 17, -1, -1 },
    { "rcon", "[I", .constantValue.asLong = 0, 0x1a, -1, 18, -1, -1 },
    { "T0", "[I", .constantValue.asLong = 0, 0x1a, -1, 19, -1, -1 },
    { "Tinv0", "[I", .constantValue.asLong = 0, 0x1a, -1, 20, -1, -1 },
...
IOSObjectArray *OrgBouncycastleCryptoEnginesAESEngine_generateWorkingKeyWithByteArray_withBoolean_(OrgBouncycastleCryptoEnginesAESEngine *self, IOSByteArray *key, jboolean forEncryption) {
  ...
  if (keyLen < 16 || keyLen > 32 || (keyLen & 7) != 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Key length not 128/192/256 bits.");
  }
  jint KC = JreURShift32(keyLen, 2);
  self->ROUNDS_ = KC + 6;
  IOSObjectArray *W = [IOSIntArray arrayWithDimensions:2 lengths:(jint[]){ self->ROUNDS_ + 1, 4 }];
  switch (KC) {
    case 4:
    {
    ...
    default:
    {
      @throw create_JavaLangIllegalStateException_initWithNSString_(@"Should never get here");
    }
  }
  if (!forEncryption) {
