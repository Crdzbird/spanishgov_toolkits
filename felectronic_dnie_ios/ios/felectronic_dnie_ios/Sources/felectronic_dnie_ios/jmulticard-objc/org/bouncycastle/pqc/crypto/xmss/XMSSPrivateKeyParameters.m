...
#error "org/bouncycastle/pqc/crypto/xmss/XMSSPrivateKeyParameters must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *)rollKey {
  @synchronized(self) {
    if ([((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getIndex] < [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getMaxIndex]) {
      JreVolatileStrongAssign(&bdsState_, [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getNextStateWithByteArray:publicSeed_ withByteArray:secretKeySeed_ withOrgBouncycastlePqcCryptoXmssOTSHashAddress:(OrgBouncycastlePqcCryptoXmssOTSHashAddress *) cast_chk([create_OrgBouncycastlePqcCryptoXmssOTSHashAddress_Builder_init() build], [OrgBouncycastlePqcCryptoXmssOTSHashAddress class])]);
    }
    else {
      JreVolatileStrongAssign(&bdsState_, create_OrgBouncycastlePqcCryptoXmssBDS_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_withInt_withInt_(params_, [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getMaxIndex], [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getMaxIndex] + 1));
    }
...
- (OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *)extractKeyShardWithInt:(jint)usageCount {
  ...
  @synchronized(self) {
    if (usageCount <= [self getUsagesRemaining]) {
      OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *keyParams = [((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk([create_OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_(params_) withSecretKeySeedWithByteArray:secretKeySeed_])) withSecretKeyPRFWithByteArray:secretKeyPRF_])) withPublicSeedWithByteArray:publicSeed_])) withRootWithByteArray:root_])) withIndexWithInt:[self getIndex]])) withBDSStateWithOrgBouncycastlePqcCryptoXmssBDS:[((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) withMaxIndexWithInt:[((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getIndex] + usageCount - 1 withOrgBouncycastleAsn1ASN1ObjectIdentifier:[((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(params_)) getTreeDigestOID]]])) build];
      if (usageCount == [self getUsagesRemaining]) {
        JreVolatileStrongAssign(&bdsState_, create_OrgBouncycastlePqcCryptoXmssBDS_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_withInt_withInt_(params_, [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getMaxIndex], [self getIndex] + usageCount));
      }
      else {
        OrgBouncycastlePqcCryptoXmssOTSHashAddress *hashAddress = (OrgBouncycastlePqcCryptoXmssOTSHashAddress *) cast_chk([create_OrgBouncycastlePqcCryptoXmssOTSHashAddress_Builder_init() build], [OrgBouncycastlePqcCryptoXmssOTSHashAddress class]);
        for (jint i = 0; i != usageCount; i++) {
          JreVolatileStrongAssign(&bdsState_, [((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(JreLoadVolatileId(&bdsState_))) getNextStateWithByteArray:publicSeed_ withByteArray:secretKeySeed_ withOrgBouncycastlePqcCryptoXmssOTSHashAddress:hashAddress]);
        }
      }
...
- (IOSByteArray *)toByteArray {
  @synchronized(self) {
    ...
    @catch (JavaIoIOException *e) {
      @throw create_JavaLangRuntimeException_initWithNSString_(JreStrcat("$$", @"error serializing bds state: ", [e getMessage]));
    }
...
void OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_initWithOrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder_(OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *self, OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *builder) {
  OrgBouncycastlePqcCryptoXmssXMSSKeyParameters_initWithBoolean_withNSString_(self, true, [((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *) nil_chk(builder))->params_)) getTreeDigest]);
  ...
  if (privateKey != nil) {
    ...
    @try {
      ...
      if ([((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk(bdsImport)) getIndex] != index) {
        @throw create_JavaLangIllegalStateException_initWithNSString_(@"serialized BDS has wrong index");
      }
      JreVolatileStrongAssign(&self->bdsState_, [bdsImport withWOTSDigestWithOrgBouncycastleAsn1ASN1ObjectIdentifier:[builder->params_ getTreeDigestOID]]);
    }
    @catch (JavaIoIOException *e) {
    ...
    else if (builder->index_ < (JreLShift32(1, [self->params_ getHeight])) - 2 && tmpPublicSeed != nil && tmpSecretKeySeed != nil) {
      JreVolatileStrongAssign(&self->bdsState_, create_OrgBouncycastlePqcCryptoXmssBDS_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_withByteArray_withByteArray_withOrgBouncycastlePqcCryptoXmssOTSHashAddress_withInt_(self->params_, tmpPublicSeed, tmpSecretKeySeed, (OrgBouncycastlePqcCryptoXmssOTSHashAddress *) cast_chk([create_OrgBouncycastlePqcCryptoXmssOTSHashAddress_Builder_init() build], [OrgBouncycastlePqcCryptoXmssOTSHashAddress class]), builder->index_));
    }
    else {
      JreVolatileStrongAssign(&self->bdsState_, create_OrgBouncycastlePqcCryptoXmssBDS_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_withInt_withInt_(self->params_, (JreLShift32(1, [self->params_ getHeight])) - 1, builder->index_));
    }
...
- (OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder *)withBDSStateWithOrgBouncycastlePqcCryptoXmssBDS:(OrgBouncycastlePqcCryptoXmssBDS *)valBDS {
  JreStrongAssign(&bdsState_, valBDS);
  return self;
}
...
- (OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *)build {
  return create_OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_initWithOrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters_Builder_(self);
}
