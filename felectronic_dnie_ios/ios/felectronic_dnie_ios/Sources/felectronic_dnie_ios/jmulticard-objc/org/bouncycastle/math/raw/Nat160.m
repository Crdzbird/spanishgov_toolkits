...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/math/raw/Nat160.java
//
...
#error "org/bouncycastle/math/raw/Nat160 must not be compiled with ARC (-fobjc-arc)"
#endif
...
IOSIntArray *OrgBouncycastleMathRawNat160_create() {
  OrgBouncycastleMathRawNat160_initialize();
  return [IOSIntArray arrayWithLength:5];
}

IOSIntArray *OrgBouncycastleMathRawNat160_createExt() {
  OrgBouncycastleMathRawNat160_initialize();
  return [IOSIntArray arrayWithLength:10];
}
...
JavaMathBigInteger *OrgBouncycastleMathRawNat160_toBigIntegerWithIntArray_(IOSIntArray *x) {
  OrgBouncycastleMathRawNat160_initialize();
  IOSByteArray *bs = [IOSByteArray arrayWithLength:20];
  for (jint i = 0; i < 5; ++i) {
