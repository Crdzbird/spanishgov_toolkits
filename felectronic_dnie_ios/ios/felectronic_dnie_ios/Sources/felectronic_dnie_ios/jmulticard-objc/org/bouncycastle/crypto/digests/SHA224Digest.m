...
#error "org/bouncycastle/crypto/digests/SHA224Digest must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (IOSIntArray *)K {
  return OrgBouncycastleCryptoDigestsSHA224Digest_K;
}
...
- (id<OrgBouncycastleUtilMemoable>)copy__ {
  return create_OrgBouncycastleCryptoDigestsSHA224Digest_initWithOrgBouncycastleCryptoDigestsSHA224Digest_(self);
}
