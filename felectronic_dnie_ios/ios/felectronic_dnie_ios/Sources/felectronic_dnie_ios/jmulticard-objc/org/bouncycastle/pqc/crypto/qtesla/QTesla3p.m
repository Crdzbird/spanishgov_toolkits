...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/pqc/crypto/qtesla/QTesla3p.java
//
...
#error "org/bouncycastle/pqc/crypto/qtesla/QTesla3p must not be compiled with ARC (-fobjc-arc)"
#endif
...
__attribute__((unused)) static jint OrgBouncycastlePqcCryptoQteslaQTesla3p_atWithByteArray_withInt_withInt_(IOSByteArray *bs, jint base, jint index);
...
jint OrgBouncycastlePqcCryptoQteslaQTesla3p_generateKeyPairWithByteArray_withByteArray_withJavaSecuritySecureRandom_(IOSByteArray *publicKey, IOSByteArray *privateKey, JavaSecuritySecureRandom *secureRandom) {
  ...
  jint nonce = 0;
  IOSByteArray *randomness = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES];
  IOSByteArray *randomnessExtended = [IOSByteArray arrayWithLength:(OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K + 3) * OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES];
  IOSLongArray *secretPolynomial = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *errorPolynomial = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *A = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *T = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *s_ntt = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  [((JavaSecuritySecureRandom *) nil_chk(secureRandom)) nextBytesWithByteArray:randomness];
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomnessExtended, 0, (OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K + 3) * OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES, randomness, 0, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES);
...
jint OrgBouncycastlePqcCryptoQteslaQTesla3p_generateSignatureWithByteArray_withByteArray_withInt_withInt_withByteArray_withJavaSecuritySecureRandom_(IOSByteArray *signature, IOSByteArray *message, jint messageOffset, jint messageLength, IOSByteArray *privateKey, JavaSecuritySecureRandom *secureRandom) {
  OrgBouncycastlePqcCryptoQteslaQTesla3p_initialize();
  IOSByteArray *c = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_C_BYTES];
  IOSByteArray *randomness = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES];
  IOSByteArray *randomness_input = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES + OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES + 2 * OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES];
  IOSIntArray *pos_list = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_H];
  IOSShortArray *sign_list = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_H];
  IOSLongArray *y = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *y_ntt = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *Sc = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *z = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *v = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *Ec = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *a = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  jint k;
  jint nonce = 0;
  jboolean rsp = false;
  ...
  {
    IOSByteArray *tmp = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES];
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomness_input, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES + OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES, OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES, message, 0, messageLength);
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomness, 0, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES, randomness_input, 0, randomness_input->size_ - OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES);
...
jint OrgBouncycastlePqcCryptoQteslaQTesla3p_verifyingWithByteArray_withByteArray_withInt_withInt_withByteArray_(IOSByteArray *message, IOSByteArray *signature, jint signatureOffset, jint signatureLength, IOSByteArray *publicKey) {
  OrgBouncycastlePqcCryptoQteslaQTesla3p_initialize();
  IOSByteArray *c = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_C_BYTES];
  IOSByteArray *c_sig = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_C_BYTES];
  IOSByteArray *seed = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES];
  IOSByteArray *hm = [IOSByteArray arrayWithLength:2 * OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES];
  IOSIntArray *pos_list = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_H];
  IOSShortArray *sign_list = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_H];
  IOSIntArray *pk_t = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *w = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *a = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *Tc = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K];
  IOSLongArray *z = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSLongArray *z_ntt = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  jint k = 0;
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(hm, 0, OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES, message, 0, ((IOSByteArray *) nil_chk(message))->size_);
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_encodePrivateKeyWithByteArray_withLongArray_withLongArray_withByteArray_withInt_withByteArray_(IOSByteArray *privateKey, IOSLongArray *secretPolynomial, IOSLongArray *errorPolynomial, IOSByteArray *seed, jint seedOffset, IOSByteArray *publicKey) {
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(privateKey, skPtr, OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES, publicKey, 0, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_PUBLICKEYBYTES - OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_SEEDBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_encodeCWithIntArray_withShortArray_withByteArray_withInt_(IOSIntArray *positionList, IOSShortArray *signList, IOSByteArray *output, jint outputOffset) {
  ...
  IOSShortArray *C = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
  IOSByteArray *randomness = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE];
  OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK128SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(randomness, 0, OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE, domainSeparator++, output, outputOffset, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_hashFunctionWithByteArray_withInt_withLongArray_withByteArray_withInt_(IOSByteArray *output, jint outputOff, IOSLongArray *v, IOSByteArray *hm, jint hmOff) {
  ...
  jint mask;
  jint cL;
  IOSByteArray *T = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N + 2 * OrgBouncycastlePqcCryptoQteslaQTesla3p_HM_BYTES];
  for (jint k = 0; k < OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_K; k++) {
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK256WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(output, outputOff, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_C_BYTES, T, 0, T->size_);
}
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_sample_yWithLongArray_withByteArray_withInt_withInt_(IOSLongArray *y, IOSByteArray *seed, jint seedOffset, jint nonce) {
  ...
  IOSByteArray *buf = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla3p_BPLUS1BYTES + 1];
  jint nbytes = OrgBouncycastlePqcCryptoQteslaQTesla3p_BPLUS1BYTES;
  jshort dmsp = (jshort) (JreLShift32(nonce, 8));
  OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK256SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(buf, 0, OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N * nbytes, dmsp++, seed, seedOffset, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES);
...
jboolean OrgBouncycastlePqcCryptoQteslaQTesla3p_checkPolynomialWithLongArray_withInt_withInt_(IOSLongArray *polynomial, jint polyOffset, jint bound) {
  ...
  jlong temp;
  jlong mask;
  IOSLongArray *list = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_N];
...
+ (void)initialize {
  if (self == [OrgBouncycastlePqcCryptoQteslaQTesla3p_Gaussian class]) {
LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFF4DLL, (jlong) 0x1E959E3FLL, (jlong) 0x4A29BB03LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFBELL, (jlong) 0x7C23D3D9LL, (jlong) 0x71DC92E4LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFE8LL, (jlong) 0x55110485LL, (jlong) 0x0E1813E2LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFF7LL, (jlong) 0x5EBC7B7BLL, (jlong) 0x2DFEE922LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFDLL, (jlong) 0x0EDB0975LL, (jlong) 0x0C9F1639LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x00DDA1A1LL, (jlong) 0x6DE86AA0LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x54CF6D87LL, (jlong) 0x023F1F47LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7186FF6ALL, (jlong) 0x5B71BF8CLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7B375EBCLL, (jlong) 0x767A89DCLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7E70BA89LL, (jlong) 0x44EBCEAALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7F7F98B5LL, (jlong) 0x44C8E44ALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FD744C2LL, (jlong) 0x448EE5A4LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FF34165LL, (jlong) 0x008855D0LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFC1110LL, (jlong) 0x754A60B6LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFECD77LL, (jlong) 0x44BE6D4ALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFA3F4LL, (jlong) 0x7400A73ELL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFE4BDLL, (jlong) 0x1143830BLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFF809LL, (jlong) 0x1A385059LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFDB4LL, (jlong) 0x41CA0794LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFF59LL, (jlong) 0x02FFB605LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFD1LL, (jlong) 0x18360E8DLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFF3LL, (jlong) 0x072A0E9ALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFCLL, (jlong) 0x3C1BFEB0LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x066EBCDDLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x5FBE171ALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x778EB81FLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7DD211FELL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7F71F071LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FDC528FLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FF7298CLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFDD739LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFF7ACALL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFE056LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFF893LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFE48LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFF9CLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFE9LL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFBLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL, (jlong) 0x7FFFFFFFLL } count:444]);
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_Gaussian_sample_gauss_polyWithInt_withByteArray_withInt_withLongArray_withInt_(jint nonce, IOSByteArray *seed, jint seedOffset, IOSLongArray *poly, jint polyOffset) {
  ...
  IOSByteArray *samp = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_Gaussian_CHUNK_SIZE * OrgBouncycastlePqcCryptoQteslaQTesla3p_Gaussian_CDT_COLS * 4];
  IOSIntArray *c = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla3p_Gaussian_CDT_COLS];
  jint borrow;
  jint sign;
...
void OrgBouncycastlePqcCryptoQteslaQTesla3p_QTesla3PPolynomial_poly_uniformWithLongArray_withByteArray_withInt_(IOSLongArray *a, IOSByteArray *seed, jint seedOffset) {
  ...
  IOSByteArray *buf = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_GEN_A];
  jshort dmsp = 0;
  OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK128SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(buf, 0, OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE * OrgBouncycastlePqcCryptoQteslaQTesla3p_PARAM_GEN_A, dmsp++, seed, seedOffset, OrgBouncycastlePqcCryptoQteslaQTesla3p_CRYPTO_RANDOMBYTES);
