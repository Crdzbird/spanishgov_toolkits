...
#error "org/bouncycastle/pqc/crypto/xmss/LTreeAddress must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastlePqcCryptoXmssXMSSAddress *)build {
  return create_OrgBouncycastlePqcCryptoXmssLTreeAddress_initPackagePrivateWithOrgBouncycastlePqcCryptoXmssLTreeAddress_Builder_(self);
}
