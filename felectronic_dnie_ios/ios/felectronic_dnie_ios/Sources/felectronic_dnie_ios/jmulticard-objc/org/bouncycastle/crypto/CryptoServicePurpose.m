...
#error "org/bouncycastle/crypto/CryptoServicePurpose must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (OrgBouncycastleCryptoCryptoServicePurpose *)AGREEMENT {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, AGREEMENT);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)ENCRYPTION {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, ENCRYPTION);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)DECRYPTION {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, DECRYPTION);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)KEYGEN {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, KEYGEN);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)SIGNING {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, SIGNING);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)VERIFYING {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, VERIFYING);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)AUTHENTICATION {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, AUTHENTICATION);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)VERIFICATION {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, VERIFICATION);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)PRF {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, PRF);
}

+ (OrgBouncycastleCryptoCryptoServicePurpose *)ANY {
  return JreEnum(OrgBouncycastleCryptoCryptoServicePurpose, ANY);
}
...
- (OrgBouncycastleCryptoCryptoServicePurpose_ORDINAL)ordinal {
  return (OrgBouncycastleCryptoCryptoServicePurpose_ORDINAL)[super ordinal];
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleCryptoCryptoServicePurpose class]) {
    ...
    id e;
    for (jint i = 0; i < 10; i++) {
      ((void)(OrgBouncycastleCryptoCryptoServicePurpose_values_[i] = e = objc_constructInstance(self, (void *)ptr)), ptr += objSize);
      OrgBouncycastleCryptoCryptoServicePurpose_initWithNSString_withInt_(e, JreEnumConstantName(OrgBouncycastleCryptoCryptoServicePurpose_class_(), i), i);
    }
...
OrgBouncycastleCryptoCryptoServicePurpose *OrgBouncycastleCryptoCryptoServicePurpose_fromOrdinal(OrgBouncycastleCryptoCryptoServicePurpose_ORDINAL ordinal) {
  OrgBouncycastleCryptoCryptoServicePurpose_initialize();
  if (ordinal >= 10) {
    return nil;
  }
