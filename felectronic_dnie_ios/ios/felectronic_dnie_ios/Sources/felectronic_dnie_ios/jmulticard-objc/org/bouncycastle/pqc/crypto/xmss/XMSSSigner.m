...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/pqc/crypto/xmss/XMSSSigner.java
//
...
#error "org/bouncycastle/pqc/crypto/xmss/XMSSSigner must not be compiled with ARC (-fobjc-arc)"
#endif
...
withOrgBouncycastleCryptoCipherParameters:(id<OrgBouncycastleCryptoCipherParameters>)param {
  if (forSigning) {
    initSign_ = true;
    hasGenerated_ = false;
    JreStrongAssign(&privateKey_, (OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) cast_chk(param, [OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters class]));
    JreStrongAssign(&params_, [((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) nil_chk(privateKey_)) getParameters]);
  }
  else {
    initSign_ = false;
    JreStrongAssign(&publicKey_, (OrgBouncycastlePqcCryptoXmssXMSSPublicKeyParameters *) cast_chk(param, [OrgBouncycastlePqcCryptoXmssXMSSPublicKeyParameters class]));
    JreStrongAssign(&params_, [((OrgBouncycastlePqcCryptoXmssXMSSPublicKeyParameters *) nil_chk(publicKey_)) getParameters]);
  }
  JreStrongAssign(&wotsPlus_, [((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(params_)) getWOTSPlus]);
  JreStrongAssign(&khf_, [((OrgBouncycastlePqcCryptoXmssWOTSPlus *) nil_chk(wotsPlus_)) getKhf]);
}
...
- (IOSByteArray *)generateSignatureWithByteArray:(IOSByteArray *)message {
  ...
  @synchronized(privateKey_) {
    if ([privateKey_ getUsagesRemaining] <= 0) {
      @throw create_OrgBouncycastlePqcCryptoExhaustedPrivateKeyException_initWithNSString_(@"no usages of private key remaining");
    }
    ...
    @try {
      ...
      IOSByteArray *concatenated = OrgBouncycastleUtilArrays_concatenateWithByteArray_withByteArray_withByteArray_(random, [((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) nil_chk(privateKey_)) getRoot], OrgBouncycastlePqcCryptoXmssXMSSUtil_toBytesBigEndianWithLong_withInt_(index, [((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(params_)) getTreeDigestSize]));
      ...
      return JreRetainedLocalValue([((OrgBouncycastlePqcCryptoXmssXMSSReducedSignature *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSReducedSignature_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSReducedSignature_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSSignature_Builder *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSSignature_Builder *) nil_chk([create_OrgBouncycastlePqcCryptoXmssXMSSSignature_Builder_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_(params_) withIndexWithInt:index])) withRandomWithByteArray:random])) withWOTSPlusSignatureWithOrgBouncycastlePqcCryptoXmssWOTSPlusSignature:wotsPlusSignature])) withAuthPathWithJavaUtilList:[((OrgBouncycastlePqcCryptoXmssBDS *) nil_chk([((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) nil_chk(privateKey_)) getBDSState])) getAuthenticationPath]])) build])) toByteArray]);
    }
    @finally {
      ...
      [((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) nil_chk(privateKey_)) rollKey];
    }
  }
}
...
- (jboolean)verifySignatureWithByteArray:(IOSByteArray *)message
  ...
  OrgBouncycastlePqcCryptoXmssXMSSSignature *sig = JreRetainedLocalValue([((OrgBouncycastlePqcCryptoXmssXMSSSignature_Builder *) nil_chk([create_OrgBouncycastlePqcCryptoXmssXMSSSignature_Builder_initWithOrgBouncycastlePqcCryptoXmssXMSSParameters_(params_) withSignatureWithByteArray:signature])) build]);
  jint index = [((OrgBouncycastlePqcCryptoXmssXMSSSignature *) nil_chk(sig)) getIndex];
  [((OrgBouncycastlePqcCryptoXmssWOTSPlus *) nil_chk(wotsPlus_)) importKeysWithByteArray:[IOSByteArray arrayWithLength:[((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(params_)) getTreeDigestSize]] withByteArray:[((OrgBouncycastlePqcCryptoXmssXMSSPublicKeyParameters *) nil_chk(publicKey_)) getPublicSeed]];
  IOSByteArray *concatenated = OrgBouncycastleUtilArrays_concatenateWithByteArray_withByteArray_withByteArray_([sig getRandom], [((OrgBouncycastlePqcCryptoXmssXMSSPublicKeyParameters *) nil_chk(publicKey_)) getRoot], OrgBouncycastlePqcCryptoXmssXMSSUtil_toBytesBigEndianWithLong_withInt_(index, [((OrgBouncycastlePqcCryptoXmssXMSSParameters *) nil_chk(params_)) getTreeDigestSize]));
  IOSByteArray *messageDigest = [((OrgBouncycastlePqcCryptoXmssKeyedHashFunctions *) nil_chk(khf_)) HMsgWithByteArray:concatenated withByteArray:message];
...
- (OrgBouncycastleCryptoParamsAsymmetricKeyParameter *)getUpdatedPrivateKey {
  @synchronized(privateKey_) {
    if (hasGenerated_) {
      OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *privKey = JreRetainedLocalValue(privateKey_);
      ...
      OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *privKey = JreRetainedLocalValue(privateKey_);
      if (privKey != nil) {
        JreStrongAssign(&privateKey_, [((OrgBouncycastlePqcCryptoXmssXMSSPrivateKeyParameters *) nil_chk(privateKey_)) getNextKey]);
      }
      return JreRetainedLocalValue(privKey);
    }
  }
