...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/math/ec/custom/sec/SecT193R2Point.java
//
...
#error "org/bouncycastle/math/ec/custom/sec/SecT193R2Point must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastleMathEcECPoint *)detach {
  return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(nil, [self getAffineXCoord], [self getAffineYCoord]);
}
...
- (OrgBouncycastleMathEcECPoint *)addWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X2)) isZero]) {
    ...
    if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X3)) isZero]) {
      return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, X3, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
    }
    ...
    if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X3)) isZero]) {
      return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, X3, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getB])) sqrt]);
    }
  ...
  return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve, X3, L3, [IOSObjectArray arrayWithObjects:(id[]){ Z3 } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
...
- (OrgBouncycastleMathEcECPoint *)twice {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(T)) isZero]) {
    return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, T, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
  }
...
- (OrgBouncycastleMathEcECPoint *)twicePlusWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(A)) isZero]) {
    return create_OrgBouncycastleMathEcCustomSecSecT193R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, A, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
  }
