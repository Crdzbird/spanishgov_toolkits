...
#error "org/bouncycastle/pqc/math/ntru/polynomial/LongPolynomial5 must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastlePqcMathNtruPolynomialLongPolynomial5 *)multWithOrgBouncycastlePqcMathNtruPolynomialTernaryPolynomial:(id<OrgBouncycastlePqcMathNtruPolynomialTernaryPolynomial>)poly2 {
  IOSObjectArray *prod = [IOSLongArray arrayWithDimensions:2 lengths:(jint[]){ 5, ((IOSLongArray *) nil_chk(coeffs_))->size_ + JreIntDiv(([((id<OrgBouncycastlePqcMathNtruPolynomialTernaryPolynomial>) nil_chk(poly2)) size] + 4), 5) - 1 }];
  ...
  return create_OrgBouncycastlePqcMathNtruPolynomialLongPolynomial5_initWithLongArray_withInt_(cCoeffs, numCoeffs_);
}
...
void OrgBouncycastlePqcMathNtruPolynomialLongPolynomial5_initWithOrgBouncycastlePqcMathNtruPolynomialIntegerPolynomial_(OrgBouncycastlePqcMathNtruPolynomialLongPolynomial5 *self, OrgBouncycastlePqcMathNtruPolynomialIntegerPolynomial *p) {
  ...
  JreStrongAssignAndConsume(&self->coeffs_, [IOSLongArray newArrayWithLength:JreIntDiv((self->numCoeffs_ + 4), 5)]);
  jint cIdx = 0;
  jint shift = 0;
