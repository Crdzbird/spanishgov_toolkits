...
@property (readonly, class, strong) OrgBouncycastlePqcCryptoLmsLMOtsParameters *sha256_n32_w1 NS_SWIFT_NAME(sha256_n32_w1);
@property (readonly, class, strong) OrgBouncycastlePqcCryptoLmsLMOtsParameters *sha256_n32_w2 NS_SWIFT_NAME(sha256_n32_w2);
@property (readonly, class, strong) OrgBouncycastlePqcCryptoLmsLMOtsParameters *sha256_n32_w4 NS_SWIFT_NAME(sha256_n32_w4);
@property (readonly, class, strong) OrgBouncycastlePqcCryptoLmsLMOtsParameters *sha256_n32_w8 NS_SWIFT_NAME(sha256_n32_w8);
