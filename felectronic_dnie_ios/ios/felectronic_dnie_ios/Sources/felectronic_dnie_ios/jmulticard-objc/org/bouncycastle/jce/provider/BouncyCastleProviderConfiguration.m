...
#error "org/bouncycastle/jce/provider/BouncyCastleProviderConfiguration must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (void)setParameterWithNSString:(NSString *)parameterName
  ...
  if ([((NSString *) nil_chk(OrgBouncycastleJcajceProviderConfigConfigurableProvider_THREAD_LOCAL_EC_IMPLICITLY_CA)) isEqual:parameterName]) {
    ...
    if ([parameter isKindOfClass:[OrgBouncycastleJceSpecECParameterSpec class]] || parameter == nil) {
      JreVolatileStrongAssign(&ecImplicitCaParams_, (OrgBouncycastleJceSpecECParameterSpec *) cast_chk(parameter, [OrgBouncycastleJceSpecECParameterSpec class]));
    }
    else {
      JreVolatileStrongAssign(&ecImplicitCaParams_, OrgBouncycastleJcajceProviderAsymmetricUtilEC5Util_convertSpecWithJavaSecuritySpecECParameterSpec_((JavaSecuritySpecECParameterSpec *) cast_chk(parameter, [JavaSecuritySpecECParameterSpec class])));
    }
  }
    ...
    if ([parameter isKindOfClass:[JavaxCryptoSpecDHParameterSpec class]] || [IOSClass_arrayType(JavaxCryptoSpecDHParameterSpec_class_(), 1) isInstance:parameter] || parameter == nil) {
      ...
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"not a valid DHParameterSpec");
    }
    if (dhSpec == nil) {
    ...
    if ([parameter isKindOfClass:[JavaxCryptoSpecDHParameterSpec class]] || [IOSClass_arrayType(JavaxCryptoSpecDHParameterSpec_class_(), 1) isInstance:parameter] || parameter == nil) {
      JreVolatileStrongAssign(&dhDefaultParams_, parameter);
    }
    else {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"not a valid DHParameterSpec or DHParameterSpec[]");
    }
  }
    ...
    JreVolatileStrongAssign(&acceptableNamedCurves_, (id<JavaUtilSet>) cast_check(parameter, JavaUtilSet_class_()));
  }
    ...
    JreVolatileStrongAssign(&additionalECParameters_, (id<JavaUtilMap>) cast_check(parameter, JavaUtilMap_class_()));
  }
}
...
- (JavaxCryptoSpecDHParameterSpec *)getDHDefaultParametersWithInt:(jint)keySize {
  id params = JreRetainedLocalValue([((JavaLangThreadLocal *) nil_chk(dhThreadSpec_)) get]);
  if (params == nil) {
  ...
  if ([params isKindOfClass:[JavaxCryptoSpecDHParameterSpec class]]) {
    ...
    IOSObjectArray *specs = (IOSObjectArray *) cast_check(params, IOSClass_arrayType(JavaxCryptoSpecDHParameterSpec_class_(), 1));
    {
      ...
      while (b__ < e__) {
        JavaxCryptoSpecDHParameterSpec *spec = RETAIN_AND_AUTORELEASE(*b__++);
        if ([((JavaMathBigInteger *) nil_chk([spec getP])) bitLength] == keySize) {
          return spec;
        }
      }
    }
  ...
  if (dhParams != nil) {
    return create_OrgBouncycastleJcajceSpecDHDomainParameterSpec_initWithOrgBouncycastleCryptoParamsDHParameters_(dhParams);
  }
  return nil;
}
...
- (JavaSecuritySpecDSAParameterSpec *)getDSADefaultParametersWithInt:(jint)keySize {
  ...
  if (dsaParams != nil) {
    return create_JavaSecuritySpecDSAParameterSpec_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_([dsaParams getP], [dsaParams getQ], [dsaParams getG]);
  }
  return nil;
}
...
- (void)dealloc {
  RELEASE_(ecThreadSpec_);
  RELEASE_(dhThreadSpec_);
...
+ (void)initialize {
  if (self == [OrgBouncycastleJceProviderBouncyCastleProviderConfiguration class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_EC_LOCAL_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_THREAD_LOCAL_EC_IMPLICITLY_CA));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_EC_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_EC_IMPLICITLY_CA));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_DH_LOCAL_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_THREAD_LOCAL_DH_DEFAULT_PARAMS));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_DH_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_DH_DEFAULT_PARAMS));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_EC_CURVE_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_ACCEPTABLE_EC_CURVES));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_BC_ADDITIONAL_EC_CURVE_PERMISSION, new_OrgBouncycastleJcajceProviderConfigProviderConfigurationPermission_initWithNSString_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, OrgBouncycastleJcajceProviderConfigConfigurableProvider_ADDITIONAL_EC_PARAMETERS));
...
void OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_initPackagePrivate(OrgBouncycastleJceProviderBouncyCastleProviderConfiguration *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->ecThreadSpec_, new_JavaLangThreadLocal_init());
  JreStrongAssignAndConsume(&self->dhThreadSpec_, new_JavaLangThreadLocal_init());
  JreVolatileStrongAssign(&self->acceptableNamedCurves_, create_JavaUtilHashSet_init());
  JreVolatileStrongAssign(&self->additionalECParameters_, create_JavaUtilHashMap_init());
}
