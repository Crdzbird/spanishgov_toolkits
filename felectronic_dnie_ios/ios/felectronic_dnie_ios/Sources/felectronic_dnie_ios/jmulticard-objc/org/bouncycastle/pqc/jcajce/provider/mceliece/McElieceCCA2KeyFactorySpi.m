...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/pqc/jcajce/provider/mceliece/McElieceCCA2KeyFactorySpi.java
//
...
#error "org/bouncycastle/pqc/jcajce/provider/mceliece/McElieceCCA2KeyFactorySpi must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (NSString *)OID {
  return OrgBouncycastlePqcJcajceProviderMcelieceMcElieceCCA2KeyFactorySpi_OID;
}
  ...
  if ([keySpec isKindOfClass:[JavaSecuritySpecX509EncodedKeySpec class]]) {
    ...
    @try {
      if ([((OrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, mcElieceCca2))) equalsWithOrgBouncycastleAsn1ASN1Primitive:[((OrgBouncycastleAsn1X509AlgorithmIdentifier *) nil_chk([((OrgBouncycastleAsn1X509SubjectPublicKeyInfo *) nil_chk(pki)) getAlgorithm])) getAlgorithm]]) {
        ...
        return create_OrgBouncycastlePqcJcajceProviderMcelieceBCMcElieceCCA2PublicKey_initWithOrgBouncycastlePqcCryptoMcelieceMcElieceCCA2PublicKeyParameters_(create_OrgBouncycastlePqcCryptoMcelieceMcElieceCCA2PublicKeyParameters_initWithInt_withInt_withOrgBouncycastlePqcMathLinearalgebraGF2Matrix_withNSString_([((OrgBouncycastlePqcAsn1McElieceCCA2PublicKey *) nil_chk(key)) getN], [key getT], [key getG], [((id<OrgBouncycastleCryptoDigest>) nil_chk(OrgBouncycastlePqcJcajceProviderMcelieceUtils_getDigestWithOrgBouncycastleAsn1X509AlgorithmIdentifier_([key getDigest]))) getAlgorithmName]));
      }
      else {
...
- (id<JavaSecurityKey>)translateKeyWithJavaSecurityKey:(id<JavaSecurityKey>)key {
  if (([key isKindOfClass:[OrgBouncycastlePqcJcajceProviderMcelieceBCMcElieceCCA2PrivateKey class]]) || ([key isKindOfClass:[OrgBouncycastlePqcJcajceProviderMcelieceBCMcElieceCCA2PublicKey class]])) {
    return key;
  }
