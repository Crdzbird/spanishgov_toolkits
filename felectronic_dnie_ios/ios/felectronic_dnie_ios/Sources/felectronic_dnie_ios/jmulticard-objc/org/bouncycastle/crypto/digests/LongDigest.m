...
#error "org/bouncycastle/crypto/digests/LongDigest must not be compiled with ARC (-fobjc-arc)"
#endif
...
inline jint OrgBouncycastleCryptoDigestsLongDigest_get_BYTE_LENGTH(void);
#define OrgBouncycastleCryptoDigestsLongDigest_BYTE_LENGTH 128
J2OBJC_STATIC_FIELD_CONSTANT(OrgBouncycastleCryptoDigestsLongDigest, BYTE_LENGTH, jint)
...
IOSLongArray *OrgBouncycastleCryptoDigestsLongDigest_K;

@implementation OrgBouncycastleCryptoDigestsLongDigest

+ (IOSLongArray *)K {
  return OrgBouncycastleCryptoDigestsLongDigest_K;
}
...
- (void)reset {
  ...
  wOff_ = 0;
  JavaUtilArrays_fillWithLongArray_withLong_(W_, 0);
}
...
- (void)processBlock {
  ...
  for (jint i = 0; i < 10; i++) {
    jint unseq$1 = t;
    h += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, e) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, e, f, g) + IOSLongArray_Get(nil_chk(OrgBouncycastleCryptoDigestsLongDigest_K), unseq$1) + IOSLongArray_Get(nil_chk(W_), t++);
    d += h;
    ...
    jint unseq$2 = t;
    g += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, d) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, d, e, f) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$2) + IOSLongArray_Get(W_, t++);
    c += g;
    ...
    jint unseq$3 = t;
    f += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, c) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, c, d, e) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$3) + IOSLongArray_Get(W_, t++);
    b += f;
    ...
    jint unseq$4 = t;
    e += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, b) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, b, c, d) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$4) + IOSLongArray_Get(W_, t++);
    a += e;
    ...
    jint unseq$5 = t;
    d += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, a) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, a, b, c) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$5) + IOSLongArray_Get(W_, t++);
    h += d;
    ...
    jint unseq$6 = t;
    c += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, h) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, h, a, b) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$6) + IOSLongArray_Get(W_, t++);
    g += c;
    ...
    jint unseq$7 = t;
    b += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, g) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, g, h, a) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$7) + IOSLongArray_Get(W_, t++);
    f += b;
    ...
    jint unseq$8 = t;
    a += OrgBouncycastleCryptoDigestsLongDigest_Sum1WithLong_(self, f) + OrgBouncycastleCryptoDigestsLongDigest_ChWithLong_withLong_withLong_(self, f, g, h) + IOSLongArray_Get(OrgBouncycastleCryptoDigestsLongDigest_K, unseq$8) + IOSLongArray_Get(W_, t++);
    e += a;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initWithOrgBouncycastleCryptoDigestsLongDigest:);
  methods[2].selector = @selector(copyInWithOrgBouncycastleCryptoDigestsLongDigest:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "BYTE_LENGTH", "I", .constantValue.asInt = OrgBouncycastleCryptoDigestsLongDigest_BYTE_LENGTH, 0x1a, -1, -1, -1, -1 },
...
void OrgBouncycastleCryptoDigestsLongDigest_init(OrgBouncycastleCryptoDigestsLongDigest *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->xBuf_, [IOSByteArray newArrayWithLength:8]);
  JreStrongAssignAndConsume(&self->W_, [IOSLongArray newArrayWithLength:80]);
  self->xBufOff_ = 0;
  [self reset];
}
