...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/math/ec/custom/sec/SecT113R2Point.java
//
...
#error "org/bouncycastle/math/ec/custom/sec/SecT113R2Point must not be compiled with ARC (-fobjc-arc)"
#endif
...
@implementation OrgBouncycastleMathEcCustomSecSecT113R2Point
...
- (instancetype)initWithOrgBouncycastleMathEcECCurve:(OrgBouncycastleMathEcECCurve *)curve
  ...
  OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(self, curve, x, y);
  return self;
}
...
- (instancetype)initWithOrgBouncycastleMathEcECCurve:(OrgBouncycastleMathEcECCurve *)curve
  ...
  OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(self, curve, x, y, zs);
  return self;
}

- (OrgBouncycastleMathEcECPoint *)detach {
  return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(nil, [self getAffineXCoord], [self getAffineYCoord]);
}
...
- (OrgBouncycastleMathEcECPoint *)addWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X2)) isZero]) {
    ...
    if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X3)) isZero]) {
      return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, X3, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
    }
    ...
    if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(X3)) isZero]) {
      return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, X3, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getB])) sqrt]);
    }
  ...
  return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve, X3, L3, [IOSObjectArray arrayWithObjects:(id[]){ Z3 } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
...
- (OrgBouncycastleMathEcECPoint *)twice {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(T)) isZero]) {
    return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, T, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
  }
...
- (OrgBouncycastleMathEcECPoint *)twicePlusWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  if ([((OrgBouncycastleMathEcECFieldElement *) nil_chk(A)) isZero]) {
    return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, A, [((OrgBouncycastleMathEcECFieldElement *) nil_chk([curve getB])) sqrt]);
  }
...
- (OrgBouncycastleMathEcECPoint *)negate {
  ...
  OrgBouncycastleMathEcECFieldElement *L = y_;
  OrgBouncycastleMathEcECFieldElement *Z = IOSObjectArray_Get(nil_chk(zs_), 0);
  return create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve_, X, [((OrgBouncycastleMathEcECFieldElement *) nil_chk(L)) addWithOrgBouncycastleMathEcECFieldElement:Z], [IOSObjectArray arrayWithObjects:(id[]){ Z } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgBouncycastleMathEcCustomSecSecT113R2Point = { "SecT113R2Point", "org.bouncycastle.math.ec.custom.sec", ptrTable, methods, NULL, 7, 0x1, 9, 0, -1, -1, -1, -1, -1 };
  return &_OrgBouncycastleMathEcCustomSecSecT113R2Point;
}
...
OrgBouncycastleMathEcCustomSecSecT113R2Point *new_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(OrgBouncycastleMathEcECCurve *curve, OrgBouncycastleMathEcECFieldElement *x, OrgBouncycastleMathEcECFieldElement *y) {
  J2OBJC_NEW_IMPL(OrgBouncycastleMathEcCustomSecSecT113R2Point, initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_, curve, x, y)
}
...
OrgBouncycastleMathEcCustomSecSecT113R2Point *create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(OrgBouncycastleMathEcECCurve *curve, OrgBouncycastleMathEcECFieldElement *x, OrgBouncycastleMathEcECFieldElement *y) {
  J2OBJC_CREATE_IMPL(OrgBouncycastleMathEcCustomSecSecT113R2Point, initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_, curve, x, y)
}
...
OrgBouncycastleMathEcCustomSecSecT113R2Point *new_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(OrgBouncycastleMathEcECCurve *curve, OrgBouncycastleMathEcECFieldElement *x, OrgBouncycastleMathEcECFieldElement *y, IOSObjectArray *zs) {
  J2OBJC_NEW_IMPL(OrgBouncycastleMathEcCustomSecSecT113R2Point, initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_, curve, x, y, zs)
}
...
OrgBouncycastleMathEcCustomSecSecT113R2Point *create_OrgBouncycastleMathEcCustomSecSecT113R2Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(OrgBouncycastleMathEcECCurve *curve, OrgBouncycastleMathEcECFieldElement *x, OrgBouncycastleMathEcECFieldElement *y, IOSObjectArray *zs) {
  J2OBJC_CREATE_IMPL(OrgBouncycastleMathEcCustomSecSecT113R2Point, initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_, curve, x, y, zs)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgBouncycastleMathEcCustomSecSecT113R2Point)
