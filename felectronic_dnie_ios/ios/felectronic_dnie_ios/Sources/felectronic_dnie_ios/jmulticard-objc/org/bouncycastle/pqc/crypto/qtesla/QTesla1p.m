...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/pqc/crypto/qtesla/QTesla1p.java
//
...
#error "org/bouncycastle/pqc/crypto/qtesla/QTesla1p must not be compiled with ARC (-fobjc-arc)"
#endif
...
jint OrgBouncycastlePqcCryptoQteslaQTesla1p_generateKeyPairWithByteArray_withByteArray_withJavaSecuritySecureRandom_(IOSByteArray *publicKey, IOSByteArray *privateKey, JavaSecuritySecureRandom *secureRandom) {
  ...
  jint nonce = 0;
  IOSByteArray *randomness = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES];
  IOSByteArray *randomnessExtended = [IOSByteArray arrayWithLength:(OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K + 3) * OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES];
  IOSIntArray *secretPolynomial = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *errorPolynomial = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *A = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *T = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *s_ntt = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  [((JavaSecuritySecureRandom *) nil_chk(secureRandom)) nextBytesWithByteArray:randomness];
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomnessExtended, 0, (OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K + 3) * OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES, randomness, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES);
...
jint OrgBouncycastlePqcCryptoQteslaQTesla1p_generateSignatureWithByteArray_withByteArray_withInt_withInt_withByteArray_withJavaSecuritySecureRandom_(IOSByteArray *signature, IOSByteArray *message, jint messageOffset, jint messageLength, IOSByteArray *privateKey, JavaSecuritySecureRandom *secureRandom) {
  OrgBouncycastlePqcCryptoQteslaQTesla1p_initialize();
  IOSByteArray *c = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_C_BYTES];
  IOSByteArray *randomness = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES];
  IOSByteArray *randomness_input = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES + OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES + 2 * OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES];
  IOSIntArray *pos_list = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_H];
  IOSShortArray *sign_list = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_H];
  IOSIntArray *y = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *y_ntt = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *Sc = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *z = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *v = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *Ec = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *a = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  jint k;
  jint nonce = 0;
  jboolean rsp = false;
  ...
  {
    IOSByteArray *tmp = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES];
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomness_input, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES + OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES, OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES, message, 0, messageLength);
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(randomness, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES, randomness_input, 0, randomness_input->size_ - OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES);
...
jint OrgBouncycastlePqcCryptoQteslaQTesla1p_verifyingWithByteArray_withByteArray_withInt_withInt_withByteArray_(IOSByteArray *message, IOSByteArray *signature, jint signatureOffset, jint signatureLength, IOSByteArray *publicKey) {
  OrgBouncycastlePqcCryptoQteslaQTesla1p_initialize();
  IOSByteArray *c = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_C_BYTES];
  IOSByteArray *c_sig = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_C_BYTES];
  IOSByteArray *seed = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES];
  IOSByteArray *hm = [IOSByteArray arrayWithLength:2 * OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES];
  IOSIntArray *pos_list = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_H];
  IOSShortArray *sign_list = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_H];
  IOSIntArray *pk_t = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *w = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *a = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *Tc = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K];
  IOSIntArray *z = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  IOSIntArray *z_ntt = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  jint k = 0;
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(hm, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES, message, 0, ((IOSByteArray *) nil_chk(message))->size_);
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(hm, OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES, OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES, publicKey, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_PUBLICKEYBYTES - OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_encodePrivateKeyWithByteArray_withIntArray_withIntArray_withByteArray_withInt_withByteArray_(IOSByteArray *privateKey, IOSIntArray *secretPolynomial, IOSIntArray *errorPolynomial, IOSByteArray *seed, jint seedOffset, IOSByteArray *publicKey) {
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(privateKey, skPtr, OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES, publicKey, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_PUBLICKEYBYTES - OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_encodeCWithIntArray_withShortArray_withByteArray_withInt_(IOSIntArray *positionList, IOSShortArray *signList, IOSByteArray *output, jint outputOffset) {
  ...
  IOSShortArray *C = [IOSShortArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_hashFunctionWithByteArray_withInt_withIntArray_withByteArray_withInt_(IOSByteArray *output, jint outputOffset, IOSIntArray *v, IOSByteArray *message, jint messageOffset) {
  ...
  jint mask;
  jint cL;
  IOSByteArray *T = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N + 2 * OrgBouncycastlePqcCryptoQteslaQTesla1p_HM_BYTES];
  for (jint k = 0; k < OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_K; k++) {
  ...
  OrgBouncycastlePqcCryptoQteslaHashUtils_secureHashAlgorithmKECCAK128WithByteArray_withInt_withInt_withByteArray_withInt_withInt_(output, outputOffset, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_C_BYTES, T, 0, T->size_);
}
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_sample_yWithIntArray_withByteArray_withInt_withInt_(IOSIntArray *y, IOSByteArray *seed, jint seedOffset, jint nonce) {
  ...
  IOSByteArray *buf = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * OrgBouncycastlePqcCryptoQteslaQTesla1p_BPLUS1BYTES + 1];
  jint nbytes = OrgBouncycastlePqcCryptoQteslaQTesla1p_BPLUS1BYTES;
  jshort dmsp = (jshort) (JreLShift32(nonce, 8));
  OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK128SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(buf, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N * nbytes, dmsp++, seed, seedOffset, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES);
...
jboolean OrgBouncycastlePqcCryptoQteslaQTesla1p_checkPolynomialWithIntArray_withInt_withInt_(IOSIntArray *polynomial, jint polyOffset, jint bound) {
  ...
  jint temp;
  jint mask;
  IOSIntArray *list = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
...
+ (void)initialize {
  if (self == [OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian class]) {
    JreStrongAssignAndConsume(&OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_cdt_v, [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x00000000, (jint) 0x00000000, (jint) 0x0601F22A, (jint) 0x280663D4, (jint) 0x11F09FFA, (jint) 0x162FE23D, (jint) 0x1DA089E9, (jint) 0x437226E8, (jint) 0x28EAB25D, (jint) 0x04C51FE2, (jint) 0x33AC2F26, (jint) 0x14FDBA70, (jint) 0x3DC767DC, (jint) 0x4565C960, (jint) 0x4724FC62, (jint) 0x3342C78A, (jint) 0x4FB448F4, (jint) 0x5229D06D, (jint) 0x576B8599, (jint) 0x7423407F, (jint) 0x5E4786DA, (jint) 0x3210BAF7, (jint) 0x644B2C92, (jint) 0x431B3947, (jint) 0x697E90CE, (jint) 0x77C362C4, (jint) 0x6DEE0B96, (jint) 0x2798C9CE, (jint) 0x71A92144, (jint) 0x5765FCE4, (jint) 0x74C16FD5, (jint) 0x1E2A0990, (jint) 0x7749AC92, (jint) 0x0DF36EEB, (jint) 0x7954BFA4, (jint) 0x28079289, (jint) 0x7AF5067A, (jint) 0x2EDC2050, (jint) 0x7C3BC17C, (jint) 0x123D5E7B, (jint) 0x7D38AD76, (jint) 0x2A9381D9, (jint) 0x7DF9C5DF, (jint) 0x0E868CA7, (jint) 0x7E8B2ABA, (jint) 0x18E5C811, (jint) 0x7EF7237C, (jint) 0x00908272, (jint) 0x7F4637C5, (jint) 0x6DBA5126, (jint) 0x7F7F5707, (jint) 0x4A52EDEB, (jint) 0x7FA808CC, (jint) 0x23290599, (jint) 0x7FC4A083, (jint) 0x69BDF2D5, (jint) 0x7FD870CA, (jint) 0x42275558, (jint) 0x7FE5FB5D, (jint) 0x3EF82C1B, (jint) 0x7FEF1BFA, (jint) 0x6C03A362, (jint) 0x7FF52D4E, (jint) 0x316C2C8C, (jint) 0x7FF927BA, (jint) 0x12AE54AF, (jint) 0x7FFBBA43, (jint) 0x749CC0E2, (jint) 0x7FFD5E3D, (jint) 0x4524AD91, (jint) 0x7FFE6664, (jint) 0x535785B5, (jint) 0x7FFF0A41, (jint) 0x0B291681, (jint) 0x7FFF6E81, (jint) 0x132C3D6F, (jint) 0x7FFFAAFE, (jint) 0x4DBC6BED, (jint) 0x7FFFCEFD, (jint) 0x7A1E2D14, (jint) 0x7FFFE41E, (jint) 0x4C6EC115, (jint) 0x7FFFF059, (jint) 0x319503C8, (jint) 0x7FFFF754, (jint) 0x5DDD0D40, (jint) 0x7FFFFB43, (jint) 0x0B9E9823, (jint) 0x7FFFFD71, (jint) 0x76B81AE1, (jint) 0x7FFFFEA3, (jint) 0x7E66A1EC, (jint) 0x7FFFFF49, (jint) 0x26F6E191, (jint) 0x7FFFFFA1, (jint) 0x2FA31694, (jint) 0x7FFFFFCF, (jint) 0x5247BEC9, (jint) 0x7FFFFFE7, (jint) 0x4F4127C7, (jint) 0x7FFFFFF3, (jint) 0x6FAA69FD, (jint) 0x7FFFFFFA, (jint) 0x0630D073, (jint) 0x7FFFFFFD, (jint) 0x0F2957BB, (jint) 0x7FFFFFFE, (jint) 0x4FD29432, (jint) 0x7FFFFFFF, (jint) 0x2CFAD60D, (jint) 0x7FFFFFFF, (jint) 0x5967A930, (jint) 0x7FFFFFFF, (jint) 0x6E4C9DFF, (jint) 0x7FFFFFFF, (jint) 0x77FDCCC8, (jint) 0x7FFFFFFF, (jint) 0x7C6CE89E, (jint) 0x7FFFFFFF, (jint) 0x7E6D116F, (jint) 0x7FFFFFFF, (jint) 0x7F50FA31, (jint) 0x7FFFFFFF, (jint) 0x7FB50089, (jint) 0x7FFFFFFF, (jint) 0x7FE04C2D, (jint) 0x7FFFFFFF, (jint) 0x7FF2C7C1, (jint) 0x7FFFFFFF, (jint) 0x7FFA8FE3, (jint) 0x7FFFFFFF, (jint) 0x7FFDCB1B, (jint) 0x7FFFFFFF, (jint) 0x7FFF1DE2, (jint) 0x7FFFFFFF, (jint) 0x7FFFA6B7, (jint) 0x7FFFFFFF, (jint) 0x7FFFDD39, (jint) 0x7FFFFFFF, (jint) 0x7FFFF2A3, (jint) 0x7FFFFFFF, (jint) 0x7FFFFAEF, (jint) 0x7FFFFFFF, (jint) 0x7FFFFE1B, (jint) 0x7FFFFFFF, (jint) 0x7FFFFF4D, (jint) 0x7FFFFFFF, (jint) 0x7FFFFFBF, (jint) 0x7FFFFFFF, (jint) 0x7FFFFFE9, (jint) 0x7FFFFFFF, (jint) 0x7FFFFFF8, (jint) 0x7FFFFFFF, (jint) 0x7FFFFFFD, (jint) 0x7FFFFFFF, (jint) 0x7FFFFFFF } count:156]);
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_sample_gauss_polyWithInt_withByteArray_withInt_withIntArray_withInt_(jint nonce, IOSByteArray *seed, jint seedOffset, IOSIntArray *poly, jint polyOffset) {
  ...
  IOSByteArray *samp = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CHUNK_SIZE * OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CDT_COLS * 4];
  IOSIntArray *c = [IOSIntArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CDT_COLS];
  jint borrow;
  jint sign;
  ...
  for (jint chunk = 0; chunk < OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N; chunk += OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CHUNK_SIZE) {
    OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK128SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(samp, 0, OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CHUNK_SIZE * OrgBouncycastlePqcCryptoQteslaQTesla1p_Gaussian_CDT_COLS * 4, (jshort) dmsp++, seed, seedOffset, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_SEEDBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_QTesla1PPolynomial_poly_uniformWithIntArray_withByteArray_withInt_(IOSIntArray *a, IOSByteArray *seed, jint seedOffset) {
  ...
  IOSByteArray *buf = [IOSByteArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_GEN_A];
  jshort dmsp = 0;
  OrgBouncycastlePqcCryptoQteslaHashUtils_customizableSecureHashAlgorithmKECCAK128SimpleWithByteArray_withInt_withInt_withShort_withByteArray_withInt_withInt_(buf, 0, OrgBouncycastlePqcCryptoQteslaHashUtils_SECURE_HASH_ALGORITHM_KECCAK_128_RATE * OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_GEN_A, dmsp++, seed, seedOffset, OrgBouncycastlePqcCryptoQteslaQTesla1p_CRYPTO_RANDOMBYTES);
...
void OrgBouncycastlePqcCryptoQteslaQTesla1p_QTesla1PPolynomial_sparse_mul32WithIntArray_withInt_withIntArray_withInt_withIntArray_withShortArray_(IOSIntArray *prod, jint ppos, IOSIntArray *pk, jint pkPos, IOSIntArray *pos_list, IOSShortArray *sign_list) {
  ...
  jint j;
  jint pos;
  IOSLongArray *temp = [IOSLongArray arrayWithLength:OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_N];
  for (i = 0; i < OrgBouncycastlePqcCryptoQteslaQTesla1p_PARAM_H; i++) {
    pos = IOSIntArray_Get(nil_chk(pos_list), i);
    for (j = 0; j < pos; j++) {
