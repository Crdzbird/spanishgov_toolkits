...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/crypto/digests/MD4Digest.java
//
...
#error "org/bouncycastle/crypto/digests/MD4Digest must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (id<OrgBouncycastleUtilMemoable>)copy__ {
  return create_OrgBouncycastleCryptoDigestsMD4Digest_initWithOrgBouncycastleCryptoDigestsMD4Digest_(self);
}
