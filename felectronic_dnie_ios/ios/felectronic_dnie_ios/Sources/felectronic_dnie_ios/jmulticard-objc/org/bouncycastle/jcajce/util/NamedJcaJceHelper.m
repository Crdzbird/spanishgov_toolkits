...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/jcajce/util/NamedJcaJceHelper.java
//
...
#error "org/bouncycastle/jcajce/util/NamedJcaJceHelper must not be compiled with ARC (-fobjc-arc)"
#endif
...
void OrgBouncycastleJcajceUtilNamedJcaJceHelper_initWithNSString_(OrgBouncycastleJcajceUtilNamedJcaJceHelper *self, NSString *providerName) {
  NSObject_init(self);
  JreStrongAssign(&self->providerName_, providerName);
}
