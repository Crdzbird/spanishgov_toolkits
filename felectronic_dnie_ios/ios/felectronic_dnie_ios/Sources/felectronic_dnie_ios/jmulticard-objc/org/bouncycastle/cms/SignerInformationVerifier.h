...
- (instancetype _Nonnull)initWithOrgBouncycastleCmsCMSSignatureAlgorithmNameGenerator:(id<OrgBouncycastleCmsCMSSignatureAlgorithmNameGenerator>)sigNameGenerator
