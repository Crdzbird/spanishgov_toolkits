...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/asn1/ASN1RelativeOID.java
//
...
#error "org/bouncycastle/asn1/ASN1RelativeOID must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (OrgBouncycastleAsn1ASN1UniversalType *)TYPE {
  return OrgBouncycastleAsn1ASN1RelativeOID_TYPE;
}
...
- (OrgBouncycastleAsn1ASN1RelativeOID *)branchWithNSString:(NSString *)branchID {
  return create_OrgBouncycastleAsn1ASN1RelativeOID_initWithOrgBouncycastleAsn1ASN1RelativeOID_withNSString_(self, branchID);
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleAsn1ASN1RelativeOID class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleAsn1ASN1RelativeOID_TYPE, new_OrgBouncycastleAsn1ASN1RelativeOID_1_initWithIOSClass_withInt_(OrgBouncycastleAsn1ASN1RelativeOID_class_(), OrgBouncycastleAsn1BERTags_RELATIVE_OID));
...
OrgBouncycastleAsn1ASN1RelativeOID *OrgBouncycastleAsn1ASN1RelativeOID_getInstanceWithId_(id obj) {
  ...
  if ([OrgBouncycastleAsn1ASN1Encodable_class_() isInstance:obj]) {
    ...
    @catch (JavaIoIOException *e) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"failed to construct relative OID from byte[]: ", [e getMessage]));
    }
  }
...
void OrgBouncycastleAsn1ASN1RelativeOID_initWithNSString_(OrgBouncycastleAsn1ASN1RelativeOID *self, NSString *identifier) {
  ...
  if (!OrgBouncycastleAsn1ASN1RelativeOID_isValidIdentifierWithNSString_withInt_(identifier, 0)) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$", @"string ", identifier, @" not a relative OID"));
  }
...
void OrgBouncycastleAsn1ASN1RelativeOID_initWithOrgBouncycastleAsn1ASN1RelativeOID_withNSString_(OrgBouncycastleAsn1ASN1RelativeOID *self, OrgBouncycastleAsn1ASN1RelativeOID *oid, NSString *branchID) {
  ...
  JreStrongAssign(&self->identifier_, JreStrcat("$C$", [((OrgBouncycastleAsn1ASN1RelativeOID *) nil_chk(oid)) getId], '.', branchID));
}
...
OrgBouncycastleAsn1ASN1RelativeOID *OrgBouncycastleAsn1ASN1RelativeOID_createPrimitiveWithByteArray_withBoolean_(IOSByteArray *contents, jboolean clone) {
  OrgBouncycastleAsn1ASN1RelativeOID_initialize();
  return create_OrgBouncycastleAsn1ASN1RelativeOID_initWithByteArray_withBoolean_(contents, clone);
}
...
jboolean OrgBouncycastleAsn1ASN1RelativeOID_isValidIdentifierWithNSString_withInt_(NSString *identifier, jint from) {
  ...
  while (--pos >= from) {
    ...
    if (ch == '.') {
      if (0 == digitCount || (digitCount > 1 && [identifier charAtWithInt:pos + 1] == '0')) {
        return false;
      }
      digitCount = 0;
    }
...
void OrgBouncycastleAsn1ASN1RelativeOID_writeFieldWithJavaIoByteArrayOutputStream_withLong_(JavaIoByteArrayOutputStream *outArg, jlong fieldValue) {
  OrgBouncycastleAsn1ASN1RelativeOID_initialize();
  IOSByteArray *result = [IOSByteArray arrayWithLength:9];
  jint pos = 8;
...
void OrgBouncycastleAsn1ASN1RelativeOID_writeFieldWithJavaIoByteArrayOutputStream_withJavaMathBigInteger_(JavaIoByteArrayOutputStream *outArg, JavaMathBigInteger *fieldValue) {
  ...
  if (byteCount == 0) {
    ...
    JavaMathBigInteger *tmpValue = JreRetainedLocalValue(fieldValue);
    IOSByteArray *tmp = [IOSByteArray arrayWithLength:byteCount];
