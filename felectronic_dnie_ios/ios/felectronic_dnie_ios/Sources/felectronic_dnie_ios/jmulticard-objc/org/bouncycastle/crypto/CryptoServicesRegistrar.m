...
#error "org/bouncycastle/crypto/CryptoServicesRegistrar must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (void)initialize {
  if (self == [OrgBouncycastleCryptoCryptoServicesRegistrar class]) {
    JreStrongAssign(&OrgBouncycastleCryptoCryptoServicesRegistrar_LOG, JavaUtilLoggingLogger_getLoggerWithNSString_([OrgBouncycastleCryptoCryptoServicesRegistrar_class_() getName]));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_CanSetDefaultProperty, new_OrgBouncycastleCryptoCryptoServicesPermission_initWithNSString_(OrgBouncycastleCryptoCryptoServicesPermission_GLOBAL_CONFIG));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_CanSetThreadProperty, new_OrgBouncycastleCryptoCryptoServicesPermission_initWithNSString_(OrgBouncycastleCryptoCryptoServicesPermission_THREAD_LOCAL_CONFIG));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_CanSetDefaultRandom, new_OrgBouncycastleCryptoCryptoServicesPermission_initWithNSString_(OrgBouncycastleCryptoCryptoServicesPermission_DEFAULT_RANDOM));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_CanSetConstraints, new_OrgBouncycastleCryptoCryptoServicesPermission_initWithNSString_(OrgBouncycastleCryptoCryptoServicesPermission_CONSTRAINTS));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_threadProperties, new_JavaLangThreadLocal_init());
    JreStrongAssign(&OrgBouncycastleCryptoCryptoServicesRegistrar_globalProperties, JavaUtilCollections_synchronizedMapWithJavaUtilMap_(create_JavaUtilHashMap_init()));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_defaultRandomProviderImpl, new_OrgBouncycastleCryptoCryptoServicesRegistrar_1_init());
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_noConstraintsImpl, new_OrgBouncycastleCryptoCryptoServicesRegistrar_2_init());
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_defaultSecureRandomProvider, new_JavaUtilConcurrentAtomicAtomicReference_init());
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_servicesConstraints, new_JavaUtilConcurrentAtomicAtomicReference_init());
    {
      OrgBouncycastleCryptoParamsDSAParameters *def512Params = create_OrgBouncycastleCryptoParamsDSAParameters_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withOrgBouncycastleCryptoParamsDSAValidationParameters_(create_JavaMathBigInteger_initWithNSString_withInt_(@"fca682ce8e12caba26efccf7110e526db078b05edecbcd1eb4a208f3ae1617ae01f35b91a47e6df63413c5e12ed0899bcd132acd50d99151bdc43ee737592e17", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"962eddcc369cba8ebb260ee6b6a126d9346e38c5", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"678471b27a9cf44ee91a49c5147db1a9aaf244f05a434d6486931d2d14271b9e35030b71fd73da179069b32e2935630e1c2062354d0da20a6c416e50be794ca4", 16), create_OrgBouncycastleCryptoParamsDSAValidationParameters_initWithByteArray_withInt_(OrgBouncycastleUtilEncodersHex_decodeStrictWithNSString_(@"b869c82b35d70e1b1ff91b28e37a62ecdc34409b"), 123));
      OrgBouncycastleCryptoParamsDSAParameters *def768Params = create_OrgBouncycastleCryptoParamsDSAParameters_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withOrgBouncycastleCryptoParamsDSAValidationParameters_(create_JavaMathBigInteger_initWithNSString_withInt_(@"e9e642599d355f37c97ffd3567120b8e25c9cd43e927b3a9670fbec5d890141922d2c3b3ad2480093799869d1e846aab49fab0ad26d2ce6a22219d470bce7d777d4a21fbe9c270b57f607002f3cef8393694cf45ee3688c11a8c56ab127a3daf", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"9cdbd84c9f1ac2f38d0f80f42ab952e7338bf511", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"30470ad5a005fb14ce2d9dcd87e38bc7d1b1c5facbaecbe95f190aa7a31d23c4dbbcbe06174544401a5b2c020965d8c2bd2171d3668445771f74ba084d2029d83c1c158547f3a9f1a2715be23d51ae4d3e5a1f6a7064f316933a346d3f529252", 16), create_OrgBouncycastleCryptoParamsDSAValidationParameters_initWithByteArray_withInt_(OrgBouncycastleUtilEncodersHex_decodeStrictWithNSString_(@"77d0f8c4dad15eb8c4f2f8d6726cefd96d5bb399"), 263));
      OrgBouncycastleCryptoParamsDSAParameters *def1024Params = create_OrgBouncycastleCryptoParamsDSAParameters_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withOrgBouncycastleCryptoParamsDSAValidationParameters_(create_JavaMathBigInteger_initWithNSString_withInt_(@"", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"9760508f15230bccb292b982a2eb840bf0581cf5", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"", 16), create_OrgBouncycastleCryptoParamsDSAValidationParameters_initWithByteArray_withInt_(OrgBouncycastleUtilEncodersHex_decodeStrictWithNSString_(@"8d5155894229d5e689ee01e6018a237e2cae64cd"), 92));
      OrgBouncycastleCryptoParamsDSAParameters *def2048Params = create_OrgBouncycastleCryptoParamsDSAParameters_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withOrgBouncycastleCryptoParamsDSAValidationParameters_(create_JavaMathBigInteger_initWithNSString_withInt_(@"", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"f8183668ba5fc5bb06b5981e6d8b795d30b8978d43ca0ec572e37e09939a9773", 16), create_JavaMathBigInteger_initWithNSString_withInt_(@"", 16), create_OrgBouncycastleCryptoParamsDSAValidationParameters_initWithByteArray_withInt_(OrgBouncycastleUtilEncodersHex_decodeStrictWithNSString_(@"b0b4417601b59cbc9d8ac8f935cadaec4f5fbb2f23785609ae466748d9b5a536"), 497));
      OrgBouncycastleCryptoCryptoServicesRegistrar_localSetGlobalPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(JreLoadStatic(OrgBouncycastleCryptoCryptoServicesRegistrar_Property, DSA_DEFAULT_PARAMS), [IOSObjectArray arrayWithObjects:(id[]){ def512Params, def768Params, def1024Params, def2048Params } count:4 type:OrgBouncycastleCryptoParamsDSAParameters_class_()]);
      OrgBouncycastleCryptoCryptoServicesRegistrar_localSetGlobalPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(JreLoadStatic(OrgBouncycastleCryptoCryptoServicesRegistrar_Property, DH_DEFAULT_PARAMS), [IOSObjectArray arrayWithObjects:(id[]){ OrgBouncycastleCryptoCryptoServicesRegistrar_toDHWithOrgBouncycastleCryptoParamsDSAParameters_(def512Params), OrgBouncycastleCryptoCryptoServicesRegistrar_toDHWithOrgBouncycastleCryptoParamsDSAParameters_(def768Params), OrgBouncycastleCryptoCryptoServicesRegistrar_toDHWithOrgBouncycastleCryptoParamsDSAParameters_(def1024Params), OrgBouncycastleCryptoCryptoServicesRegistrar_toDHWithOrgBouncycastleCryptoParamsDSAParameters_(def2048Params) } count:4 type:OrgBouncycastleCryptoParamsDHParameters_class_()]);
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_setSecureRandomWithJavaSecuritySecureRandom_(JavaSecuritySecureRandom *secureRandom) {
  ...
  if (secureRandom == nil) {
    ...
    [((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(OrgBouncycastleCryptoCryptoServicesRegistrar_defaultSecureRandomProvider)) setWithId:create_OrgBouncycastleCryptoCryptoServicesRegistrar_3_initWithJavaSecuritySecureRandom_(secureRandom)];
  }
}
  ...
  if ([((IOSClass *) nil_chk(((OrgBouncycastleCryptoCryptoServicesRegistrar_Property *) nil_chk(property))->type_)) isAssignableFrom:OrgBouncycastleCryptoParamsDHParameters_class_()]) {
    {
      ...
      while (b__ < e__) {
        id value = RETAIN_AND_AUTORELEASE(*b__++);
        ...
        if ([((JavaMathBigInteger *) nil_chk([params getP])) bitLength] == size) {
          return params;
        }
      }
    }
  }
  else if ([property->type_ isAssignableFrom:OrgBouncycastleCryptoParamsDSAParameters_class_()]) {
    {
      IOSObjectArray *a__ = values;
      id const *b__ = a__->buffer_;
      id const *e__ = b__ + a__->size_;
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_setThreadPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(OrgBouncycastleCryptoCryptoServicesRegistrar_Property *property, IOSObjectArray *propertyValue) {
  ...
  if (![((IOSClass *) nil_chk(((OrgBouncycastleCryptoCryptoServicesRegistrar_Property *) nil_chk(property))->type_)) isAssignableFrom:[nil_chk(IOSObjectArray_Get(nil_chk(propertyValue), 0)) java_getClass]]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Bad property value passed");
  }
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_localSetThreadWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(OrgBouncycastleCryptoCryptoServicesRegistrar_Property *property, IOSObjectArray *propertyValue) {
  OrgBouncycastleCryptoCryptoServicesRegistrar_initialize();
  id<JavaUtilMap> properties = JreRetainedLocalValue([((JavaLangThreadLocal *) nil_chk(OrgBouncycastleCryptoCryptoServicesRegistrar_threadProperties)) get]);
  if (properties == nil) {
    properties = create_JavaUtilHashMap_init();
    [OrgBouncycastleCryptoCryptoServicesRegistrar_threadProperties setWithId:properties];
  }
  [properties putWithId:((OrgBouncycastleCryptoCryptoServicesRegistrar_Property *) nil_chk(property))->name_ withId:propertyValue];
}
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_localSetGlobalPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(OrgBouncycastleCryptoCryptoServicesRegistrar_Property *property, IOSObjectArray *propertyValue) {
  ...
  OrgBouncycastleCryptoCryptoServicesRegistrar_localSetThreadWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_withNSObjectArray_(property, propertyValue);
  [((id<JavaUtilMap>) nil_chk(OrgBouncycastleCryptoCryptoServicesRegistrar_globalProperties)) putWithId:property->name_ withId:propertyValue];
}
...
IOSObjectArray *OrgBouncycastleCryptoCryptoServicesRegistrar_clearGlobalPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_(OrgBouncycastleCryptoCryptoServicesRegistrar_Property *property) {
  OrgBouncycastleCryptoCryptoServicesRegistrar_initialize();
  OrgBouncycastleCryptoCryptoServicesRegistrar_checkPermissionWithJavaSecurityPermission_(OrgBouncycastleCryptoCryptoServicesRegistrar_CanSetDefaultProperty);
  OrgBouncycastleCryptoCryptoServicesRegistrar_localClearThreadPropertyWithOrgBouncycastleCryptoCryptoServicesRegistrar_Property_(property);
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_checkPermissionWithJavaSecurityPermission_(JavaSecurityPermission *permission) {
  ...
  if (securityManager != nil) {
    JavaSecurityAccessController_doPrivilegedWithJavaSecurityPrivilegedAction_(create_OrgBouncycastleCryptoCryptoServicesRegistrar_4_initWithJavaLangSecurityManager_withJavaSecurityPermission_(securityManager, permission));
  }
}
...
OrgBouncycastleCryptoParamsDHParameters *OrgBouncycastleCryptoCryptoServicesRegistrar_toDHWithOrgBouncycastleCryptoParamsDSAParameters_(OrgBouncycastleCryptoParamsDSAParameters *dsaParams) {
  ...
  return create_OrgBouncycastleCryptoParamsDHParameters_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withInt_withInt_withJavaMathBigInteger_withOrgBouncycastleCryptoParamsDHValidationParameters_([dsaParams getP], [dsaParams getG], [dsaParams getQ], m, 0, nil, create_OrgBouncycastleCryptoParamsDHValidationParameters_initWithByteArray_withInt_([((OrgBouncycastleCryptoParamsDSAValidationParameters *) nil_chk([dsaParams getValidationParameters])) getSeed], [((OrgBouncycastleCryptoParamsDSAValidationParameters *) nil_chk([dsaParams getValidationParameters])) getCounter]));
}
...
- (JavaSecuritySecureRandom *)get {
  return create_JavaSecuritySecureRandom_init();
}
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_3_initWithJavaSecuritySecureRandom_(OrgBouncycastleCryptoCryptoServicesRegistrar_3 *self, JavaSecuritySecureRandom *capture$0) {
  JreStrongAssign(&self->val$secureRandom_, capture$0);
  NSObject_init(self);
}
...
- (void)dealloc {
  RELEASE_(val$securityManager_);
  RELEASE_(val$permission_);
  [super dealloc];
}
...
void OrgBouncycastleCryptoCryptoServicesRegistrar_4_initWithJavaLangSecurityManager_withJavaSecurityPermission_(OrgBouncycastleCryptoCryptoServicesRegistrar_4 *self, JavaLangSecurityManager *capture$0, JavaSecurityPermission *capture$1) {
  JreStrongAssign(&self->val$securityManager_, capture$0);
  JreStrongAssign(&self->val$permission_, capture$1);
  NSObject_init(self);
}
...
+ (OrgBouncycastleCryptoCryptoServicesRegistrar_Property *)EC_IMPLICITLY_CA {
  return OrgBouncycastleCryptoCryptoServicesRegistrar_Property_EC_IMPLICITLY_CA;
}

+ (OrgBouncycastleCryptoCryptoServicesRegistrar_Property *)DH_DEFAULT_PARAMS {
  return OrgBouncycastleCryptoCryptoServicesRegistrar_Property_DH_DEFAULT_PARAMS;
}

+ (OrgBouncycastleCryptoCryptoServicesRegistrar_Property *)DSA_DEFAULT_PARAMS {
  return OrgBouncycastleCryptoCryptoServicesRegistrar_Property_DSA_DEFAULT_PARAMS;
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleCryptoCryptoServicesRegistrar_Property class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_Property_EC_IMPLICITLY_CA, new_OrgBouncycastleCryptoCryptoServicesRegistrar_Property_initWithNSString_withIOSClass_(@"ecImplicitlyCA", OrgBouncycastleAsn1X9X9ECParameters_class_()));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_Property_DH_DEFAULT_PARAMS, new_OrgBouncycastleCryptoCryptoServicesRegistrar_Property_initWithNSString_withIOSClass_(@"dhDefaultParams", OrgBouncycastleCryptoParamsDHParameters_class_()));
    JreStrongAssignAndConsume(&OrgBouncycastleCryptoCryptoServicesRegistrar_Property_DSA_DEFAULT_PARAMS, new_OrgBouncycastleCryptoCryptoServicesRegistrar_Property_initWithNSString_withIOSClass_(@"dsaDefaultParams", OrgBouncycastleCryptoParamsDSAParameters_class_()));
