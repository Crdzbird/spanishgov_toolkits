...
#error "org/bouncycastle/util/IPAddress must not be compiled with ARC (-fobjc-arc)"
#endif
...
jboolean OrgBouncycastleUtilIPAddress_isValidIPv4WithNetmaskWithNSString_(NSString *address) {
  ...
  return (index > 0) && OrgBouncycastleUtilIPAddress_isValidIPv4WithNSString_([address java_substring:0 endIndex:index]) && (OrgBouncycastleUtilIPAddress_isValidIPv4WithNSString_(mask) || OrgBouncycastleUtilIPAddress_isMaskValueWithNSString_withInt_(mask, 32));
}
...
jboolean OrgBouncycastleUtilIPAddress_isValidIPv6WithNetmaskWithNSString_(NSString *address) {
  ...
  jint index = [((NSString *) nil_chk(address)) java_indexOfString:@"/"];
  NSString *mask = [address java_substring:index + 1];
  return (index > 0) && (OrgBouncycastleUtilIPAddress_isValidIPv6WithNSString_([address java_substring:0 endIndex:index]) && (OrgBouncycastleUtilIPAddress_isValidIPv6WithNSString_(mask) || OrgBouncycastleUtilIPAddress_isMaskValueWithNSString_withInt_(mask, 128)));
}
