...
#error "org/bouncycastle/asn1/x500/style/X500NameTokenizer must not be compiled with ARC (-fobjc-arc)"
#endif
...
void OrgBouncycastleAsn1X500StyleX500NameTokenizer_initWithNSString_(OrgBouncycastleAsn1X500StyleX500NameTokenizer *self, NSString *oid) {
  OrgBouncycastleAsn1X500StyleX500NameTokenizer_initWithNSString_withChar_(self, oid, ',');
}
