...
#error "org/bouncycastle/asn1/ASN1EncodableVector must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (void)addWithOrgBouncycastleAsn1ASN1Encodable:(id<OrgBouncycastleAsn1ASN1Encodable>)element {
  ...
  IOSObjectArray_Set(nil_chk(self->elements_), elementCount_, element);
  self->elementCount_ = minCapacity;
}

- (void)addAllWithOrgBouncycastleAsn1ASN1EncodableArray:(IOSObjectArray *)others {
  if (nil == others) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"'others' cannot be null");
  }
...
- (void)addAllWithOrgBouncycastleAsn1ASN1EncodableVector:(OrgBouncycastleAsn1ASN1EncodableVector *)other {
  if (nil == other) {
    @throw create_JavaLangNullPointerException_initWithNSString_(@"'other' cannot be null");
  }
...
- (id<OrgBouncycastleAsn1ASN1Encodable>)getWithInt:(jint)i {
  if (i >= elementCount_) {
    @throw create_JavaLangArrayIndexOutOfBoundsException_initWithNSString_(JreStrcat("I$I", i, @" >= ", elementCount_));
  }
...
- (IOSObjectArray *)copyElements {
  ...
  IOSObjectArray *copy_ = [IOSObjectArray arrayWithLength:elementCount_ type:OrgBouncycastleAsn1ASN1Encodable_class_()];
...
+ (void)initialize {
  if (self == [OrgBouncycastleAsn1ASN1EncodableVector class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleAsn1ASN1EncodableVector_EMPTY_ELEMENTS, [IOSObjectArray newArrayWithLength:0 type:OrgBouncycastleAsn1ASN1Encodable_class_()]);
...
void OrgBouncycastleAsn1ASN1EncodableVector_initWithInt_(OrgBouncycastleAsn1ASN1EncodableVector *self, jint initialCapacity) {
  ...
  if (initialCapacity < 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"'initialCapacity' must not be negative");
  }
  JreStrongAssign(&self->elements_, (initialCapacity == 0) ? OrgBouncycastleAsn1ASN1EncodableVector_EMPTY_ELEMENTS : [IOSObjectArray arrayWithLength:initialCapacity type:OrgBouncycastleAsn1ASN1Encodable_class_()]);
...
void OrgBouncycastleAsn1ASN1EncodableVector_doAddAllWithOrgBouncycastleAsn1ASN1EncodableArray_withNSString_(OrgBouncycastleAsn1ASN1EncodableVector *self, IOSObjectArray *others, NSString *nullMsg) {
  ...
  do {
    ...
    if (nil == otherElement) {
      @throw create_JavaLangNullPointerException_initWithNSString_(nullMsg);
    }
    IOSObjectArray_Set(nil_chk(self->elements_), self->elementCount_ + i, otherElement);
  }
...
void OrgBouncycastleAsn1ASN1EncodableVector_reallocateWithInt_(OrgBouncycastleAsn1ASN1EncodableVector *self, jint minCapacity) {
  ...
  IOSObjectArray *copy_ = [IOSObjectArray arrayWithLength:newCapacity type:OrgBouncycastleAsn1ASN1Encodable_class_()];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(self->elements_, 0, copy_, 0, self->elementCount_);
  JreStrongAssign(&self->elements_, copy_);
  self->copyOnWrite_ = false;
}
