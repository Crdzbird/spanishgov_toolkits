...
#error "org/bouncycastle/crypto/digests/SHA512Digest must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (id<OrgBouncycastleUtilMemoable>)copy__ {
  return create_OrgBouncycastleCryptoDigestsSHA512Digest_initWithOrgBouncycastleCryptoDigestsSHA512Digest_(self);
}
