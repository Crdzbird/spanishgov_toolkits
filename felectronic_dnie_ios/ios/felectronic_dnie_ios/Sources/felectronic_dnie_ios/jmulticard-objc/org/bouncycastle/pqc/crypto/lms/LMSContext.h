...
- (instancetype _Nonnull)initWithOrgBouncycastlePqcCryptoLmsLMOtsPrivateKey:(OrgBouncycastlePqcCryptoLmsLMOtsPrivateKey *)key
...
- (instancetype _Nonnull)initWithOrgBouncycastlePqcCryptoLmsLMOtsPublicKey:(OrgBouncycastlePqcCryptoLmsLMOtsPublicKey *)publicKey
                                                                    withId:(id)signature
                                           withOrgBouncycastleCryptoDigest:(id<OrgBouncycastleCryptoDigest>)digest;
