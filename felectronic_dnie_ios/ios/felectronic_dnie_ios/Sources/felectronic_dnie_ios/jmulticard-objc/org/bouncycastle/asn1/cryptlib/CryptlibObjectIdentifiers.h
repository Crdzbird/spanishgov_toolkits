...
@property (readonly, class, strong) OrgBouncycastleAsn1ASN1ObjectIdentifier *ecc NS_SWIFT_NAME(ecc);
@property (readonly, class, strong) OrgBouncycastleAsn1ASN1ObjectIdentifier *curvey25519 NS_SWIFT_NAME(curvey25519);
