...
@property (readonly, class) jint SEED_RANDOMISER_INDEX NS_SWIFT_NAME(SEED_RANDOMISER_INDEX);
@property (readonly, class) jint SEED_LEN NS_SWIFT_NAME(SEED_LEN);
@property (readonly, class) jint MAX_HASH NS_SWIFT_NAME(MAX_HASH);
@property (readonly, class) jshort D_MESG NS_SWIFT_NAME(D_MESG);
