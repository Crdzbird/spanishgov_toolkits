...
#error "org/bouncycastle/math/ec/custom/sec/SecP192R1Field must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (IOSIntArray *)P {
  return OrgBouncycastleMathEcCustomSecSecP192R1Field_P;
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleMathEcCustomSecSecP192R1Field class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcCustomSecSecP192R1Field_P, [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFE, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF } count:6]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcCustomSecSecP192R1Field_PExt, [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x00000001, (jint) 0x00000000, (jint) 0x00000002, (jint) 0x00000000, (jint) 0x00000001, (jint) 0x00000000, (jint) 0xFFFFFFFE, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFD, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF } count:12]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcCustomSecSecP192R1Field_PExtInv, [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFD, (jint) 0xFFFFFFFF, (jint) 0xFFFFFFFE, (jint) 0xFFFFFFFF, (jint) 0x00000001, (jint) 0x00000000, (jint) 0x00000002 } count:9]);
...
void OrgBouncycastleMathEcCustomSecSecP192R1Field_reduceWithIntArray_withIntArray_(IOSIntArray *xx, IOSIntArray *z) {
  ...
  *IOSIntArray_GetRef(z, 2) = (jint) z2;
  ...
  if ((cc != 0 && OrgBouncycastleMathRawNat_incAtWithInt_withIntArray_withInt_(6, z, 3) != 0) || (IOSIntArray_Get(z, 5) == OrgBouncycastleMathEcCustomSecSecP192R1Field_P5 && OrgBouncycastleMathRawNat192_gteWithIntArray_withIntArray_(z, OrgBouncycastleMathEcCustomSecSecP192R1Field_P))) {
    OrgBouncycastleMathEcCustomSecSecP192R1Field_addPInvToWithIntArray_(z);
  }
}
...
void OrgBouncycastleMathEcCustomSecSecP192R1Field_reduce32WithInt_withIntArray_(jint x, IOSIntArray *z) {
  ...
  if ((cc != 0 && OrgBouncycastleMathRawNat_incAtWithInt_withIntArray_withInt_(6, z, 3) != 0) || (IOSIntArray_Get(nil_chk(z), 5) == OrgBouncycastleMathEcCustomSecSecP192R1Field_P5 && OrgBouncycastleMathRawNat192_gteWithIntArray_withIntArray_(z, OrgBouncycastleMathEcCustomSecSecP192R1Field_P))) {
    OrgBouncycastleMathEcCustomSecSecP192R1Field_addPInvToWithIntArray_(z);
  }
}
