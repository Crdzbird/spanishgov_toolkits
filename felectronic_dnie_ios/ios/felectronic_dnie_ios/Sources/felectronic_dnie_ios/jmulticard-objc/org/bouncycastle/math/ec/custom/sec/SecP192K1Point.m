...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/math/ec/custom/sec/SecP192K1Point.java
//
...
#error "org/bouncycastle/math/ec/custom/sec/SecP192K1Point must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastleMathEcECPoint *)detach {
  return create_OrgBouncycastleMathEcCustomSecSecP192K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(nil, [self getAffineXCoord], [self getAffineYCoord]);
}
...
- (OrgBouncycastleMathEcECPoint *)addWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(t4);
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Y3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(G);
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(H);
  if (!Z1IsOne) {
  ...
  return create_OrgBouncycastleMathEcCustomSecSecP192K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve, X3, Y3, zs);
}
...
- (OrgBouncycastleMathEcECPoint *)twice {
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(T);
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1Field_subtractWithIntArray_withIntArray_withIntArray_(X3->x_, S, X3->x_);
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Y3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(S);
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z3 = create_OrgBouncycastleMathEcCustomSecSecP192K1FieldElement_initWithIntArray_(M);
  ...
  return create_OrgBouncycastleMathEcCustomSecSecP192K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve, X3, Y3, [IOSObjectArray arrayWithObjects:(id[]){ Z3 } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
...
- (OrgBouncycastleMathEcECPoint *)negate {
  ...
  return create_OrgBouncycastleMathEcCustomSecSecP192K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve_, x_, [((OrgBouncycastleMathEcECFieldElement *) nil_chk(y_)) negate], zs_);
}
