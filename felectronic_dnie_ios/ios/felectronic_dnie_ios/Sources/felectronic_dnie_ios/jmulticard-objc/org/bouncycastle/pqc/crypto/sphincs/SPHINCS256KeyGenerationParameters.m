...
#error "org/bouncycastle/pqc/crypto/sphincs/SPHINCS256KeyGenerationParameters must not be compiled with ARC (-fobjc-arc)"
#endif
...
void OrgBouncycastlePqcCryptoSphincsSPHINCS256KeyGenerationParameters_initWithJavaSecuritySecureRandom_withOrgBouncycastleCryptoDigest_(OrgBouncycastlePqcCryptoSphincsSPHINCS256KeyGenerationParameters *self, JavaSecuritySecureRandom *random, id<OrgBouncycastleCryptoDigest> treeDigest) {
  OrgBouncycastleCryptoKeyGenerationParameters_initWithJavaSecuritySecureRandom_withInt_(self, random, OrgBouncycastlePqcCryptoSphincsSPHINCS256Config_CRYPTO_PUBLICKEYBYTES * 8);
