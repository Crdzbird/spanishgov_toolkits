...
#error "org/bouncycastle/math/ec/ValidityPrecompInfo must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (NSString *)PRECOMP_NAME {
  return OrgBouncycastleMathEcValidityPrecompInfo_PRECOMP_NAME;
}
