...
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *AlgID_qTESLA_p_I NS_SWIFT_NAME(AlgID_qTESLA_p_I);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *AlgID_qTESLA_p_III NS_SWIFT_NAME(AlgID_qTESLA_p_III);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *SPHINCS_SHA3_256 NS_SWIFT_NAME(SPHINCS_SHA3_256);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *SPHINCS_SHA512_256 NS_SWIFT_NAME(SPHINCS_SHA512_256);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *XMSS_SHA256 NS_SWIFT_NAME(XMSS_SHA256);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *XMSS_SHA512 NS_SWIFT_NAME(XMSS_SHA512);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *XMSS_SHAKE128 NS_SWIFT_NAME(XMSS_SHAKE128);
@property (readonly, class, strong) OrgBouncycastleAsn1X509AlgorithmIdentifier *XMSS_SHAKE256 NS_SWIFT_NAME(XMSS_SHAKE256);
@property (readonly, class, strong) id<JavaUtilMap> categories NS_SWIFT_NAME(categories);
@property (readonly, class, strong) id<JavaUtilMap> frodoOids NS_SWIFT_NAME(frodoOids);
@property (readonly, class, strong) id<JavaUtilMap> frodoParams NS_SWIFT_NAME(frodoParams);
@property (readonly, class, strong) id<JavaUtilMap> saberOids NS_SWIFT_NAME(saberOids);
@property (readonly, class, strong) id<JavaUtilMap> saberParams NS_SWIFT_NAME(saberParams);
@property (readonly, class, strong) id<JavaUtilMap> mcElieceOids NS_SWIFT_NAME(mcElieceOids);
@property (readonly, class, strong) id<JavaUtilMap> mcElieceParams NS_SWIFT_NAME(mcElieceParams);
@property (readonly, class, strong) id<JavaUtilMap> sphincsPlusOids NS_SWIFT_NAME(sphincsPlusOids);
@property (readonly, class, strong) id<JavaUtilMap> sphincsPlusParams NS_SWIFT_NAME(sphincsPlusParams);
