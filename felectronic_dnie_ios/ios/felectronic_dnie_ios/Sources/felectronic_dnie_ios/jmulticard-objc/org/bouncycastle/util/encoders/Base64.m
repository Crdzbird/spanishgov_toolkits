...
#error "org/bouncycastle/util/encoders/Base64 must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (void)initialize {
  if (self == [OrgBouncycastleUtilEncodersBase64 class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleUtilEncodersBase64_encoder, new_OrgBouncycastleUtilEncodersBase64Encoder_init());
...
IOSByteArray *OrgBouncycastleUtilEncodersBase64_encodeWithByteArray_withInt_withInt_(IOSByteArray *data, jint off, jint length) {
  ...
  JavaIoByteArrayOutputStream *bOut = create_JavaIoByteArrayOutputStream_initWithInt_(len);
  @try {
  ...
  @catch (JavaLangException *e) {
    @throw create_OrgBouncycastleUtilEncodersEncoderException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"exception encoding base64 string: ", [e getMessage]), e);
  }
...
IOSByteArray *OrgBouncycastleUtilEncodersBase64_decodeWithByteArray_(IOSByteArray *data) {
  ...
  @catch (JavaLangException *e) {
    @throw create_OrgBouncycastleUtilEncodersDecoderException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"unable to decode base64 data: ", [e getMessage]), e);
  }
  return [bOut toByteArray];
}
...
IOSByteArray *OrgBouncycastleUtilEncodersBase64_decodeWithNSString_(NSString *data) {
  ...
  @catch (JavaLangException *e) {
    @throw create_OrgBouncycastleUtilEncodersDecoderException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"unable to decode base64 string: ", [e getMessage]), e);
  }
  return [bOut toByteArray];
}
