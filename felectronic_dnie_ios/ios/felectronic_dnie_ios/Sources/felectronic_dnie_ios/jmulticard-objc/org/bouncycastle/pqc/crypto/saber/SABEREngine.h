...
@property (readonly, class) jint SABER_EQ NS_SWIFT_NAME(SABER_EQ);
@property (readonly, class) jint SABER_EP NS_SWIFT_NAME(SABER_EP);
@property (readonly, class) jint SABER_N NS_SWIFT_NAME(SABER_N);

#pragma mark Public

- (instancetype _Nonnull)initPackagePrivateWithInt:(jint)l
