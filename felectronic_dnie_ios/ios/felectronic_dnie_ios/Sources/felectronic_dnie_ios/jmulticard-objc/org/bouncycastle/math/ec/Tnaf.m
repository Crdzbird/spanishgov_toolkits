...
#error "org/bouncycastle/math/ec/Tnaf must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (jbyte)WIDTH {
  return OrgBouncycastleMathEcTnaf_WIDTH;
}

+ (jbyte)POW_2_WIDTH {
  return OrgBouncycastleMathEcTnaf_POW_2_WIDTH;
}

+ (IOSObjectArray *)alpha0 {
  return OrgBouncycastleMathEcTnaf_alpha0;
}

+ (IOSObjectArray *)alpha0Tnaf {
  return OrgBouncycastleMathEcTnaf_alpha0Tnaf;
}

+ (IOSObjectArray *)alpha1 {
  return OrgBouncycastleMathEcTnaf_alpha1;
}

+ (IOSObjectArray *)alpha1Tnaf {
  return OrgBouncycastleMathEcTnaf_alpha1Tnaf;
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleMathEcTnaf class]) {
    JreStrongAssign(&OrgBouncycastleMathEcTnaf_MINUS_ONE, [((JavaMathBigInteger *) nil_chk(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE))) negate]);
    JreStrongAssign(&OrgBouncycastleMathEcTnaf_MINUS_TWO, [((JavaMathBigInteger *) nil_chk(JreLoadStatic(OrgBouncycastleMathEcECConstants, TWO))) negate]);
    JreStrongAssign(&OrgBouncycastleMathEcTnaf_MINUS_THREE, [((JavaMathBigInteger *) nil_chk(JreLoadStatic(OrgBouncycastleMathEcECConstants, THREE))) negate]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcTnaf_alpha0, [IOSObjectArray newArrayWithObjects:(id[]){ nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE), JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(OrgBouncycastleMathEcTnaf_MINUS_THREE, OrgBouncycastleMathEcTnaf_MINUS_ONE), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(OrgBouncycastleMathEcTnaf_MINUS_ONE, OrgBouncycastleMathEcTnaf_MINUS_ONE), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE), OrgBouncycastleMathEcTnaf_MINUS_ONE), nil } count:9 type:OrgBouncycastleMathEcZTauElement_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcTnaf_alpha0Tnaf, [IOSObjectArray newArrayWithObjects:(id[]){ nil, [IOSByteArray arrayWithBytes:(jbyte[]){ 1 } count:1], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ -1, 0, 1 } count:3], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ 1, 0, 1 } count:3], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ -1, 0, 0, 1 } count:4] } count:8 type:IOSClass_byteArray(1)]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcTnaf_alpha1, [IOSObjectArray newArrayWithObjects:(id[]){ nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE), JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(OrgBouncycastleMathEcTnaf_MINUS_THREE, JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE)), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(OrgBouncycastleMathEcTnaf_MINUS_ONE, JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE)), nil, create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE), JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE)), nil } count:9 type:OrgBouncycastleMathEcZTauElement_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleMathEcTnaf_alpha1Tnaf, [IOSObjectArray newArrayWithObjects:(id[]){ nil, [IOSByteArray arrayWithBytes:(jbyte[]){ 1 } count:1], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ -1, 0, 1 } count:3], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ 1, 0, 1 } count:3], nil, [IOSByteArray arrayWithBytes:(jbyte[]){ -1, 0, 0, -1 } count:4] } count:8 type:IOSClass_byteArray(1)]);
...
JavaMathBigInteger *OrgBouncycastleMathEcTnaf_normWithByte_withOrgBouncycastleMathEcZTauElement_(jbyte mu, OrgBouncycastleMathEcZTauElement *lambda) {
  ...
  JavaMathBigInteger *s1 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(((OrgBouncycastleMathEcZTauElement *) nil_chk(lambda))->u_)) multiplyWithJavaMathBigInteger:lambda->u_]);
  JavaMathBigInteger *s2 = JreRetainedLocalValue([lambda->u_ multiplyWithJavaMathBigInteger:lambda->v_]);
  JavaMathBigInteger *s3 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(lambda->v_)) multiplyWithJavaMathBigInteger:lambda->v_])) shiftLeftWithInt:1]);
  if (mu == 1) {
    ...
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"mu must be 1 or -1");
  }
  return norm;
}
...
OrgBouncycastleMathEcSimpleBigDecimal *OrgBouncycastleMathEcTnaf_normWithByte_withOrgBouncycastleMathEcSimpleBigDecimal_withOrgBouncycastleMathEcSimpleBigDecimal_(jbyte mu, OrgBouncycastleMathEcSimpleBigDecimal *u, OrgBouncycastleMathEcSimpleBigDecimal *v) {
  ...
  OrgBouncycastleMathEcSimpleBigDecimal *s1 = JreRetainedLocalValue([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(u)) multiplyWithOrgBouncycastleMathEcSimpleBigDecimal:u]);
  OrgBouncycastleMathEcSimpleBigDecimal *s2 = JreRetainedLocalValue([u multiplyWithOrgBouncycastleMathEcSimpleBigDecimal:v]);
  OrgBouncycastleMathEcSimpleBigDecimal *s3 = JreRetainedLocalValue([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(v)) multiplyWithOrgBouncycastleMathEcSimpleBigDecimal:v])) shiftLeftWithInt:1]);
  if (mu == 1) {
...
OrgBouncycastleMathEcZTauElement *OrgBouncycastleMathEcTnaf_roundWithOrgBouncycastleMathEcSimpleBigDecimal_withOrgBouncycastleMathEcSimpleBigDecimal_withByte_(OrgBouncycastleMathEcSimpleBigDecimal *lambda0, OrgBouncycastleMathEcSimpleBigDecimal *lambda1, jbyte mu) {
  ...
  if ([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(lambda1)) getScale] != scale_) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"lambda0 and lambda1 do not have same scale");
  }
  if (!((mu == 1) || (mu == -1))) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"mu must be 1 or -1");
  }
  JavaMathBigInteger *f0 = JreRetainedLocalValue([lambda0 round]);
  JavaMathBigInteger *f1 = JreRetainedLocalValue([lambda1 round]);
  OrgBouncycastleMathEcSimpleBigDecimal *eta0 = JreRetainedLocalValue([lambda0 subtractWithJavaMathBigInteger:f0]);
  OrgBouncycastleMathEcSimpleBigDecimal *eta1 = JreRetainedLocalValue([lambda1 subtractWithJavaMathBigInteger:f1]);
  OrgBouncycastleMathEcSimpleBigDecimal *eta = JreRetainedLocalValue([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(eta0)) addWithOrgBouncycastleMathEcSimpleBigDecimal:eta0]);
  if (mu == 1) {
  ...
  OrgBouncycastleMathEcSimpleBigDecimal *threeEta1 = JreRetainedLocalValue([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(eta1)) addWithOrgBouncycastleMathEcSimpleBigDecimal:eta1])) addWithOrgBouncycastleMathEcSimpleBigDecimal:eta1]);
  OrgBouncycastleMathEcSimpleBigDecimal *fourEta1 = JreRetainedLocalValue([((OrgBouncycastleMathEcSimpleBigDecimal *) nil_chk(threeEta1)) addWithOrgBouncycastleMathEcSimpleBigDecimal:eta1]);
  ...
  JavaMathBigInteger *q0 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(f0)) addWithJavaMathBigInteger:JavaMathBigInteger_valueOfWithLong_(h0)]);
  JavaMathBigInteger *q1 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(f1)) addWithJavaMathBigInteger:JavaMathBigInteger_valueOfWithLong_(h1)]);
  return create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(q0, q1);
}
...
OrgBouncycastleMathEcSimpleBigDecimal *OrgBouncycastleMathEcTnaf_approximateDivisionByNWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withByte_withInt_withInt_(JavaMathBigInteger *k, JavaMathBigInteger *s, JavaMathBigInteger *vm, jbyte a, jint m, jint c) {
  ...
  JavaMathBigInteger *ns = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(k)) shiftRightWithInt:m - _k - 2 + a]);
  JavaMathBigInteger *gs = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(s)) multiplyWithJavaMathBigInteger:ns]);
  JavaMathBigInteger *hs = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(gs)) shiftRightWithInt:m]);
  JavaMathBigInteger *js = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(vm)) multiplyWithJavaMathBigInteger:hs]);
  JavaMathBigInteger *gsPlusJs = JreRetainedLocalValue([gs addWithJavaMathBigInteger:js]);
  JavaMathBigInteger *ls = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(gsPlusJs)) shiftRightWithInt:_k - c]);
  ...
  return create_OrgBouncycastleMathEcSimpleBigDecimal_initPackagePrivateWithJavaMathBigInteger_withInt_(ls, c);
}
...
IOSByteArray *OrgBouncycastleMathEcTnaf_tauAdicNafWithByte_withOrgBouncycastleMathEcZTauElement_(jbyte mu, OrgBouncycastleMathEcZTauElement *lambda) {
  ...
  IOSByteArray *u = [IOSByteArray arrayWithLength:maxLength];
  jint i = 0;
  jint length = 0;
  JavaMathBigInteger *r0 = JreRetainedLocalValue(((OrgBouncycastleMathEcZTauElement *) nil_chk(lambda))->u_);
  JavaMathBigInteger *r1 = JreRetainedLocalValue(lambda->v_);
  while (!(([((JavaMathBigInteger *) nil_chk(r0)) isEqual:JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)]) && ([((JavaMathBigInteger *) nil_chk(r1)) isEqual:JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)]))) {
    ...
    JavaMathBigInteger *t = JreRetainedLocalValue(r0);
    JavaMathBigInteger *s = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(r0)) shiftRightWithInt:1]);
    if (mu == 1) {
  ...
  length++;
  IOSByteArray *tnaf = [IOSByteArray arrayWithLength:length];
...
jbyte OrgBouncycastleMathEcTnaf_getMuWithOrgBouncycastleMathEcECCurve_AbstractF2m_(OrgBouncycastleMathEcECCurve_AbstractF2m *curve) {
  ...
  if (![((OrgBouncycastleMathEcECCurve_AbstractF2m *) nil_chk(curve)) isKoblitz]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"No Koblitz curve (ABC), TNAF multiplication not possible");
  }
...
IOSObjectArray *OrgBouncycastleMathEcTnaf_getLucasWithByte_withInt_withBoolean_(jbyte mu, jint k, jboolean doV) {
  ...
  IOSObjectArray *retVal = [IOSObjectArray arrayWithObjects:(id[]){ u0, u1 } count:2 type:JavaMathBigInteger_class_()];
  return retVal;
}
...
JavaMathBigInteger *OrgBouncycastleMathEcTnaf_getTwWithByte_withInt_(jbyte mu, jint w) {
  ...
  if (w == 4) {
    ...
    JavaMathBigInteger *twoToW = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO))) setBitWithInt:w]);
    JavaMathBigInteger *u1invert = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(IOSObjectArray_Get(nil_chk(us), 1))) modInverseWithJavaMathBigInteger:twoToW]);
...
IOSObjectArray *OrgBouncycastleMathEcTnaf_getSiWithOrgBouncycastleMathEcECCurve_AbstractF2m_(OrgBouncycastleMathEcECCurve_AbstractF2m *curve) {
  OrgBouncycastleMathEcTnaf_initialize();
  if (![((OrgBouncycastleMathEcECCurve_AbstractF2m *) nil_chk(curve)) isKoblitz]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"si is defined for Koblitz curves only");
  }
  ...
  JavaMathBigInteger *dividend0 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE))) addWithJavaMathBigInteger:IOSObjectArray_Get(nil_chk(ui), 1)])) shiftRightWithInt:shifts]);
  JavaMathBigInteger *dividend1 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([JreLoadStatic(OrgBouncycastleMathEcECConstants, ONE) addWithJavaMathBigInteger:IOSObjectArray_Get(ui, 0)])) shiftRightWithInt:shifts])) negate]);
  return [IOSObjectArray arrayWithObjects:(id[]){ dividend0, dividend1 } count:2 type:JavaMathBigInteger_class_()];
}
...
jint OrgBouncycastleMathEcTnaf_getShiftsForCofactorWithJavaMathBigInteger_(JavaMathBigInteger *h) {
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"h (Cofactor) must be 2 or 4");
}
...
OrgBouncycastleMathEcZTauElement *OrgBouncycastleMathEcTnaf_partModReductionWithJavaMathBigInteger_withInt_withByte_withJavaMathBigIntegerArray_withByte_withByte_(JavaMathBigInteger *k, jint m, jbyte a, IOSObjectArray *s, jbyte mu, jbyte c) {
  ...
  OrgBouncycastleMathEcSimpleBigDecimal *lambda0 = OrgBouncycastleMathEcTnaf_approximateDivisionByNWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withByte_withInt_withInt_(k, IOSObjectArray_Get(s, 0), vm, a, m, c);
  ...
  JavaMathBigInteger *r0 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(k)) subtractWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(d0)) multiplyWithJavaMathBigInteger:((OrgBouncycastleMathEcZTauElement *) nil_chk(q))->u_]])) subtractWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_valueOfWithLong_(2))) multiplyWithJavaMathBigInteger:IOSObjectArray_Get(s, 1)])) multiplyWithJavaMathBigInteger:q->v_]]);
  JavaMathBigInteger *r1 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(IOSObjectArray_Get(s, 1))) multiplyWithJavaMathBigInteger:q->u_])) subtractWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(IOSObjectArray_Get(s, 0))) multiplyWithJavaMathBigInteger:q->v_]]);
  return create_OrgBouncycastleMathEcZTauElement_initPackagePrivateWithJavaMathBigInteger_withJavaMathBigInteger_(r0, r1);
}
...
OrgBouncycastleMathEcECPoint_AbstractF2m *OrgBouncycastleMathEcTnaf_multiplyFromTnafWithOrgBouncycastleMathEcECPoint_AbstractF2m_withByteArray_(OrgBouncycastleMathEcECPoint_AbstractF2m *p, IOSByteArray *u) {
  OrgBouncycastleMathEcTnaf_initialize();
  OrgBouncycastleMathEcECCurve *curve = JreRetainedLocalValue([((OrgBouncycastleMathEcECPoint_AbstractF2m *) nil_chk(p)) getCurve]);
...
IOSByteArray *OrgBouncycastleMathEcTnaf_tauAdicWNafWithByte_withOrgBouncycastleMathEcZTauElement_withByte_withJavaMathBigInteger_withJavaMathBigInteger_withOrgBouncycastleMathEcZTauElementArray_(jbyte mu, OrgBouncycastleMathEcZTauElement *lambda, jbyte width, JavaMathBigInteger *pow2w, JavaMathBigInteger *tw, IOSObjectArray *alpha) {
  ...
  IOSByteArray *u = [IOSByteArray arrayWithLength:maxLength];
  JavaMathBigInteger *pow2wMin1 = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk(pow2w)) shiftRightWithInt:1]);
  JavaMathBigInteger *r0 = JreRetainedLocalValue(((OrgBouncycastleMathEcZTauElement *) nil_chk(lambda))->u_);
  JavaMathBigInteger *r1 = JreRetainedLocalValue(lambda->v_);
  jint i = 0;
  while (!(([((JavaMathBigInteger *) nil_chk(r0)) isEqual:JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)]) && ([((JavaMathBigInteger *) nil_chk(r1)) isEqual:JreLoadStatic(OrgBouncycastleMathEcECConstants, ZERO)]))) {
    if ([r0 testBitWithInt:0]) {
      JavaMathBigInteger *uUnMod = JreRetainedLocalValue([((JavaMathBigInteger *) nil_chk([r0 addWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(r1)) multiplyWithJavaMathBigInteger:tw]])) modWithJavaMathBigInteger:pow2w]);
      jbyte uLocal;
...
IOSObjectArray *OrgBouncycastleMathEcTnaf_getPreCompWithOrgBouncycastleMathEcECPoint_AbstractF2m_withByte_(OrgBouncycastleMathEcECPoint_AbstractF2m *p, jbyte a) {
  ...
  IOSObjectArray *pu = [IOSObjectArray arrayWithLength:JreURShift32((alphaTnaf->size_ + 1), 1) type:OrgBouncycastleMathEcECPoint_AbstractF2m_class_()];
  IOSObjectArray_Set(pu, 0, p);
  jint precompLen = alphaTnaf->size_;
  for (jint i = 3; i < precompLen; i += 2) {
    IOSObjectArray_Set(pu, JreURShift32(i, 1), OrgBouncycastleMathEcTnaf_multiplyFromTnafWithOrgBouncycastleMathEcECPoint_AbstractF2m_withByteArray_(p, IOSObjectArray_Get(alphaTnaf, i)));
  }
