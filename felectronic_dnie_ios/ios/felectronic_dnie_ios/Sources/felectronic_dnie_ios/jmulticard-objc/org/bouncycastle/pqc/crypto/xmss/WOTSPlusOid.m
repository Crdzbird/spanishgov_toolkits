...
#error "org/bouncycastle/pqc/crypto/xmss/WOTSPlusOid must not be compiled with ARC (-fobjc-arc)"
#endif
  ...
  if (self == [OrgBouncycastlePqcCryptoXmssWOTSPlusOid class]) {
    {
      ...
      [map putWithId:OrgBouncycastlePqcCryptoXmssWOTSPlusOid_createKeyWithNSString_withInt_withInt_withInt_(@"SHA-256", 32, 16, 67) withId:create_OrgBouncycastlePqcCryptoXmssWOTSPlusOid_initPackagePrivateWithInt_withNSString_((jint) 0x01000001, @"WOTSP_SHA2-256_W16")];
      [map putWithId:OrgBouncycastlePqcCryptoXmssWOTSPlusOid_createKeyWithNSString_withInt_withInt_withInt_(@"SHA-512", 64, 16, 131) withId:create_OrgBouncycastlePqcCryptoXmssWOTSPlusOid_initPackagePrivateWithInt_withNSString_((jint) 0x02000002, @"WOTSP_SHA2-512_W16")];
      [map putWithId:OrgBouncycastlePqcCryptoXmssWOTSPlusOid_createKeyWithNSString_withInt_withInt_withInt_(@"SHAKE128", 32, 16, 67) withId:create_OrgBouncycastlePqcCryptoXmssWOTSPlusOid_initPackagePrivateWithInt_withNSString_((jint) 0x03000003, @"WOTSP_SHAKE128_W16")];
      [map putWithId:OrgBouncycastlePqcCryptoXmssWOTSPlusOid_createKeyWithNSString_withInt_withInt_withInt_(@"SHAKE256", 64, 16, 131) withId:create_OrgBouncycastlePqcCryptoXmssWOTSPlusOid_initPackagePrivateWithInt_withNSString_((jint) 0x04000004, @"WOTSP_SHAKE256_W16")];
      JreStrongAssign(&OrgBouncycastlePqcCryptoXmssWOTSPlusOid_oidLookupTable, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(map));
    }
