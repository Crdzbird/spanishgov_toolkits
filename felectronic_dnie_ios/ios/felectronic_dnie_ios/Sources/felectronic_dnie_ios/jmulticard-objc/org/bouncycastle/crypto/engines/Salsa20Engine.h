...
@property (readonly, class, strong) IOSByteArray *sigma NS_SWIFT_NAME(sigma);
@property (readonly, class, strong) IOSByteArray *tau NS_SWIFT_NAME(tau);

#pragma mark Public

- (instancetype _Nonnull)init;

- (instancetype _Nonnull)initWithInt:(jint)rounds;
