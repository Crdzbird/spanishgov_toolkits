...
#error "org/bouncycastle/pqc/crypto/rainbow/util/ComputeInField must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (IOSShortArray *)solveEquationWithShortArray2:(IOSObjectArray *)B
  ...
  @try {
    JreStrongAssignAndConsume(&A_, [IOSShortArray newArrayWithDimensions:2 lengths:(jint[]){ B->size_, B->size_ + 1 }]);
    JreStrongAssignAndConsume(&x_, [IOSShortArray newArrayWithLength:B->size_]);
...
- (IOSObjectArray *)inverseWithShortArray2:(IOSObjectArray *)coef {
  @try {
    ...
    JreStrongAssignAndConsume(&A_, [IOSShortArray newArrayWithDimensions:2 lengths:(jint[]){ ((IOSObjectArray *) nil_chk(coef))->size_, 2 * coef->size_ }]);
    if (coef->size_ != ((IOSShortArray *) nil_chk(IOSObjectArray_Get(coef, 0)))->size_) {
      @throw create_JavaLangRuntimeException_initWithNSString_(@"The matrix is not invertible. Please choose another one!");
    }
    ...
    inverse = [IOSShortArray arrayWithDimensions:2 lengths:(jint[]){ ((IOSObjectArray *) nil_chk(A_))->size_, A_->size_ }];
...
- (IOSObjectArray *)multiplyMatrixWithShortArray2:(IOSObjectArray *)M1
  ...
  if (((IOSShortArray *) nil_chk(IOSObjectArray_Get(nil_chk(M1), 0)))->size_ != ((IOSObjectArray *) nil_chk(M2))->size_) {
    @throw create_JavaLangRuntimeException_initWithNSString_(@"Multiplication is not possible!");
  }
  jshort tmp = 0;
  JreStrongAssignAndConsume(&A_, [IOSShortArray newArrayWithDimensions:2 lengths:(jint[]){ M1->size_, ((IOSShortArray *) nil_chk(IOSObjectArray_Get(M2, 0)))->size_ }]);
...
- (IOSShortArray *)multiplyMatrixWithShortArray2:(IOSObjectArray *)M1
  ...
  jshort tmp = 0;
  IOSShortArray *B = [IOSShortArray arrayWithLength:M1->size_];
  for (jint i = 0; i < M1->size_; i++) {
...
- (IOSShortArray *)addVectWithShortArray:(IOSShortArray *)vector1
  ...
  IOSShortArray *rslt = [IOSShortArray arrayWithLength:vector1->size_];
...
- (IOSObjectArray *)multVectsWithShortArray:(IOSShortArray *)vector1
  ...
  IOSObjectArray *rslt = [IOSShortArray arrayWithDimensions:2 lengths:(jint[]){ vector1->size_, vector2->size_ }];
...
- (IOSShortArray *)multVectWithShort:(jshort)scalar
  ...
  IOSShortArray *rslt = [IOSShortArray arrayWithLength:((IOSShortArray *) nil_chk(vector))->size_];
  for (jint n = 0; n < rslt->size_; n++) {
...
- (IOSObjectArray *)multMatrixWithShort:(jshort)scalar
  ...
  IOSObjectArray *rslt = [IOSShortArray arrayWithDimensions:2 lengths:(jint[]){ ((IOSObjectArray *) nil_chk(matrix))->size_, ((IOSShortArray *) nil_chk(IOSObjectArray_Get(matrix, 0)))->size_ }];
...
- (IOSObjectArray *)addSquareMatrixWithShortArray2:(IOSObjectArray *)matrix1
  ...
  if (((IOSObjectArray *) nil_chk(matrix1))->size_ != ((IOSObjectArray *) nil_chk(matrix2))->size_ || ((IOSShortArray *) nil_chk(IOSObjectArray_Get(matrix1, 0)))->size_ != ((IOSShortArray *) nil_chk(IOSObjectArray_Get(matrix2, 0)))->size_) {
    @throw create_JavaLangRuntimeException_initWithNSString_(@"Addition is not possible!");
  }
  IOSObjectArray *rslt = [IOSShortArray arrayWithDimensions:2 lengths:(jint[]){ matrix1->size_, matrix1->size_ }];
...
void OrgBouncycastlePqcCryptoRainbowUtilComputeInField_computeZerosUnderWithBoolean_(OrgBouncycastlePqcCryptoRainbowUtilComputeInField *self, jboolean usedForInverse) {
  ...
  for (jint k = 0; k < self->A_->size_ - 1; k++) {
    for (jint i = k + 1; i < ((IOSObjectArray *) nil_chk(self->A_))->size_; i++) {
      ...
      if (factor2 == 0) {
        @throw create_JavaLangIllegalStateException_initWithNSString_(@"Matrix not invertible! We have to choose another one!");
      }
...
void OrgBouncycastlePqcCryptoRainbowUtilComputeInField_computeZerosAbove(OrgBouncycastlePqcCryptoRainbowUtilComputeInField *self) {
  ...
  for (jint k = ((IOSObjectArray *) nil_chk(self->A_))->size_ - 1; k > 0; k--) {
    for (jint i = k - 1; i >= 0; i--) {
      ...
      jshort factor2 = OrgBouncycastlePqcCryptoRainbowUtilGF2Field_invElemWithShort_(IOSShortArray_Get(nil_chk(IOSObjectArray_Get(self->A_, k)), k));
      if (factor2 == 0) {
        @throw create_JavaLangRuntimeException_initWithNSString_(@"The matrix is not invertible");
      }
...
void OrgBouncycastlePqcCryptoRainbowUtilComputeInField_substitute(OrgBouncycastlePqcCryptoRainbowUtilComputeInField *self) {
  ...
  if (temp == 0) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(@"The equation system is not solvable");
  }
  *IOSShortArray_GetRef(nil_chk(self->x_), ((IOSObjectArray *) nil_chk(self->A_))->size_ - 1) = OrgBouncycastlePqcCryptoRainbowUtilGF2Field_multElemWithShort_withShort_(IOSShortArray_Get(nil_chk(IOSObjectArray_Get(self->A_, self->A_->size_ - 1)), self->A_->size_), temp);
  for (jint i = ((IOSObjectArray *) nil_chk(self->A_))->size_ - 2; i >= 0; i--) {
    ...
    if (temp == 0) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(@"Not solvable equation system");
    }
