...
#error "org/bouncycastle/pqc/crypto/xmss/XMSSKeyParameters must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (NSString *)SHA_256 {
  return OrgBouncycastlePqcCryptoXmssXMSSKeyParameters_SHA_256;
}

+ (NSString *)SHA_512 {
  return OrgBouncycastlePqcCryptoXmssXMSSKeyParameters_SHA_512;
}

+ (NSString *)SHAKE128 {
  return OrgBouncycastlePqcCryptoXmssXMSSKeyParameters_SHAKE128;
}

+ (NSString *)SHAKE256 {
  return OrgBouncycastlePqcCryptoXmssXMSSKeyParameters_SHAKE256;
}
