...
#error "org/bouncycastle/asn1/ASN1UTF8String must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (OrgBouncycastleAsn1ASN1UniversalType *)TYPE {
  return OrgBouncycastleAsn1ASN1UTF8String_TYPE;
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleAsn1ASN1UTF8String class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleAsn1ASN1UTF8String_TYPE, new_OrgBouncycastleAsn1ASN1UTF8String_1_initWithIOSClass_withInt_(OrgBouncycastleAsn1ASN1UTF8String_class_(), OrgBouncycastleAsn1BERTags_UTF8_STRING));
...
void OrgBouncycastleAsn1ASN1UTF8String_initWithNSString_(OrgBouncycastleAsn1ASN1UTF8String *self, NSString *string) {
  OrgBouncycastleAsn1ASN1UTF8String_initWithByteArray_withBoolean_(self, OrgBouncycastleUtilStrings_toUTF8ByteArrayWithNSString_(string), false);
}
...
OrgBouncycastleAsn1ASN1UTF8String *OrgBouncycastleAsn1ASN1UTF8String_createPrimitiveWithByteArray_(IOSByteArray *contents) {
  OrgBouncycastleAsn1ASN1UTF8String_initialize();
  return create_OrgBouncycastleAsn1DERUTF8String_initWithByteArray_withBoolean_(contents, false);
}
