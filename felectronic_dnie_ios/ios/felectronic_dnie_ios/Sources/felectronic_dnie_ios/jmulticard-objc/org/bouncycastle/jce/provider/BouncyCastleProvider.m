...
#error "org/bouncycastle/jce/provider/BouncyCastleProvider must not be compiled with ARC (-fobjc-arc)"
#endif
...
+ (NSString *)PROVIDER_NAME {
  return OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME;
}

+ (id<OrgBouncycastleJcajceProviderConfigProviderConfiguration>)CONFIGURATION {
  return OrgBouncycastleJceProviderBouncyCastleProvider_CONFIGURATION;
}
...
- (void)addAlgorithmWithNSString:(NSString *)key
  ...
  if ([self containsKeyWithId:key]) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$$", @"duplicate provider key (", key, @") found"));
  }
...
- (void)addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:(OrgBouncycastleAsn1ASN1ObjectIdentifier *)oid
  ...
  @synchronized(OrgBouncycastleJceProviderBouncyCastleProvider_keyInfoConverters) {
    [((id<JavaUtilMap>) nil_chk(OrgBouncycastleJceProviderBouncyCastleProvider_keyInfoConverters)) putWithId:oid withId:keyInfoConverter];
  }
}
...
- (void)addAttributesWithNSString:(NSString *)key
  ...
  for (id __strong element in nil_chk([((id<JavaUtilMap>) nil_chk(attributeMap)) keySet])) {
    ...
    if ([self containsKeyWithId:attributeKey]) {
      @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$$", @"duplicate provider attribute key (", attributeKey, @") found"));
    }
    [self putWithId:attributeKey withId:[attributeMap getWithId:attributeName]];
  }
}
...
+ (void)initialize {
  if (self == [OrgBouncycastleJceProviderBouncyCastleProvider class]) {
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_CONFIGURATION, new_OrgBouncycastleJceProviderBouncyCastleProviderConfiguration_initPackagePrivate());
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_keyInfoConverters, new_JavaUtilHashMap_init());
    JreStrongAssign(&OrgBouncycastleJceProviderBouncyCastleProvider_revChkClass, OrgBouncycastleJcajceProviderSymmetricUtilClassUtil_loadClassWithIOSClass_withNSString_(OrgBouncycastleJceProviderBouncyCastleProvider_class_(), @"java.security.cert.PKIXRevocationChecker"));
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_SYMMETRIC_GENERIC, [IOSObjectArray newArrayWithObjects:(id[]){ @"PBEPBKDF1", @"PBEPBKDF2", @"PBEPKCS12", @"TLSKDF", @"SCRYPT" } count:5 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_SYMMETRIC_MACS, [IOSObjectArray newArrayWithObjects:(id[]){ @"SipHash", @"SipHash128", @"Poly1305" } count:3 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_SYMMETRIC_CIPHERS, [IOSObjectArray newArrayWithObjects:(id[]){ @"AES", @"ARC4", @"ARIA", @"Blowfish", @"Camellia", @"CAST5", @"CAST6", @"ChaCha", @"DES", @"DESede", @"GOST28147", @"Grainv1", @"Grain128", @"HC128", @"HC256", @"IDEA", @"Noekeon", @"RC2", @"RC5", @"RC6", @"Rijndael", @"Salsa20", @"SEED", @"Serpent", @"Shacal2", @"Skipjack", @"SM4", @"TEA", @"Twofish", @"Threefish", @"VMPC", @"VMPCKSA3", @"XTEA", @"XSalsa20", @"OpenSSLPBKDF", @"DSTU7624", @"GOST3412_2015", @"Zuc" } count:38 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_ASYMMETRIC_GENERIC, [IOSObjectArray newArrayWithObjects:(id[]){ @"X509", @"IES", @"COMPOSITE", @"EXTERNAL" } count:4 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_ASYMMETRIC_CIPHERS, [IOSObjectArray newArrayWithObjects:(id[]){ @"DSA", @"DH", @"EC", @"RSA", @"GOST", @"ECGOST", @"ElGamal", @"DSTU4145", @"GM", @"EdEC", @"LMS", @"SPHINCSPlus" } count:12 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_DIGESTS, [IOSObjectArray newArrayWithObjects:(id[]){ @"GOST3411", @"Keccak", @"MD2", @"MD4", @"MD5", @"SHA1", @"RIPEMD128", @"RIPEMD160", @"RIPEMD256", @"RIPEMD320", @"SHA224", @"SHA256", @"SHA384", @"SHA512", @"SHA3", @"Skein", @"SM3", @"Tiger", @"Whirlpool", @"Blake2b", @"Blake2s", @"DSTU7564", @"Haraka", @"Blake3" } count:24 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_KEYSTORES, [IOSObjectArray newArrayWithObjects:(id[]){ @"BC", @"BCFKS", @"PKCS12" } count:3 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgBouncycastleJceProviderBouncyCastleProvider_SECURE_RANDOMS, [IOSObjectArray newArrayWithObjects:(id[]){ @"DRBG" } count:1 type:NSString_class_()]);
...
void OrgBouncycastleJceProviderBouncyCastleProvider_init(OrgBouncycastleJceProviderBouncyCastleProvider *self) {
  JavaSecurityProvider_initWithNSString_withDouble_withNSString_(self, OrgBouncycastleJceProviderBouncyCastleProvider_PROVIDER_NAME, 1.71, OrgBouncycastleJceProviderBouncyCastleProvider_info);
  JavaSecurityAccessController_doPrivilegedWithJavaSecurityPrivilegedAction_(create_OrgBouncycastleJceProviderBouncyCastleProvider_1_initWithOrgBouncycastleJceProviderBouncyCastleProvider_(self));
}
...
void OrgBouncycastleJceProviderBouncyCastleProvider_setup(OrgBouncycastleJceProviderBouncyCastleProvider *self) {
  ...
  OrgBouncycastleJceProviderBouncyCastleProvider_loadPQCKeys(self);
  [self putWithId:@"X509Store.CERTIFICATE/COLLECTION" withId:@"org.bouncycastle.jce.provider.X509StoreCertCollection"];
  [self putWithId:@"X509Store.ATTRIBUTECERTIFICATE/COLLECTION" withId:@"org.bouncycastle.jce.provider.X509StoreAttrCertCollection"];
  [self putWithId:@"X509Store.CRL/COLLECTION" withId:@"org.bouncycastle.jce.provider.X509StoreCRLCollection"];
  [self putWithId:@"X509Store.CERTIFICATEPAIR/COLLECTION" withId:@"org.bouncycastle.jce.provider.X509StoreCertPairCollection"];
  [self putWithId:@"X509Store.CERTIFICATE/LDAP" withId:@"org.bouncycastle.jce.provider.X509StoreLDAPCerts"];
  [self putWithId:@"X509Store.CRL/LDAP" withId:@"org.bouncycastle.jce.provider.X509StoreLDAPCRLs"];
  [self putWithId:@"X509Store.ATTRIBUTECERTIFICATE/LDAP" withId:@"org.bouncycastle.jce.provider.X509StoreLDAPAttrCerts"];
  [self putWithId:@"X509Store.CERTIFICATEPAIR/LDAP" withId:@"org.bouncycastle.jce.provider.X509StoreLDAPCertPairs"];
  [self putWithId:@"X509StreamParser.CERTIFICATE" withId:@"org.bouncycastle.jce.provider.X509CertParser"];
  [self putWithId:@"X509StreamParser.ATTRIBUTECERTIFICATE" withId:@"org.bouncycastle.jce.provider.X509AttrCertParser"];
  [self putWithId:@"X509StreamParser.CRL" withId:@"org.bouncycastle.jce.provider.X509CRLParser"];
  [self putWithId:@"X509StreamParser.CERTIFICATEPAIR" withId:@"org.bouncycastle.jce.provider.X509CertPairParser"];
  [self putWithId:@"Cipher.BROKENPBEWITHMD5ANDDES" withId:@"org.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES"];
  [self putWithId:@"Cipher.BROKENPBEWITHSHA1ANDDES" withId:@"org.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES"];
  [self putWithId:@"Cipher.OLDPBEWITHSHAANDTWOFISH-CBC" withId:@"org.bouncycastle.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish"];
  if (OrgBouncycastleJceProviderBouncyCastleProvider_revChkClass != nil) {
    [self putWithId:@"CertPathValidator.RFC3281" withId:@"org.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi"];
    [self putWithId:@"CertPathBuilder.RFC3281" withId:@"org.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi"];
    [self putWithId:@"CertPathValidator.RFC3280" withId:@"org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8"];
    [self putWithId:@"CertPathBuilder.RFC3280" withId:@"org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8"];
    [self putWithId:@"CertPathValidator.PKIX" withId:@"org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8"];
    [self putWithId:@"CertPathBuilder.PKIX" withId:@"org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8"];
  }
  else {
    [self putWithId:@"CertPathValidator.RFC3281" withId:@"org.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi"];
    [self putWithId:@"CertPathBuilder.RFC3281" withId:@"org.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi"];
    [self putWithId:@"CertPathValidator.RFC3280" withId:@"org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi"];
    [self putWithId:@"CertPathBuilder.RFC3280" withId:@"org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi"];
    [self putWithId:@"CertPathValidator.PKIX" withId:@"org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi"];
    [self putWithId:@"CertPathBuilder.PKIX" withId:@"org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi"];
  }
  [self putWithId:@"CertStore.Collection" withId:@"org.bouncycastle.jce.provider.CertStoreCollectionSpi"];
  [self putWithId:@"CertStore.LDAP" withId:@"org.bouncycastle.jce.provider.X509LDAPCertStoreSpi"];
  [self putWithId:@"CertStore.Multi" withId:@"org.bouncycastle.jce.provider.MultiCertStoreSpi"];
  [self putWithId:@"Alg.Alias.CertStore.X509LDAP" withId:@"LDAP"];
}
...
void OrgBouncycastleJceProviderBouncyCastleProvider_loadAlgorithmsWithNSString_withNSStringArray_(OrgBouncycastleJceProviderBouncyCastleProvider *self, NSString *packageName, IOSObjectArray *names) {
  {
    ...
    while (b__ < e__) {
      NSString *name = RETAIN_AND_AUTORELEASE(*b__++);
      ...
      if (clazz != nil) {
        ...
        @catch (JavaLangException *e) {
          @throw create_JavaLangInternalError_initWithNSString_(JreStrcat("$$$$@", @"cannot create instance of ", packageName, name, @"$Mappings : ", e));
        }
      }
    }
  }
...
void OrgBouncycastleJceProviderBouncyCastleProvider_loadPQCKeys(OrgBouncycastleJceProviderBouncyCastleProvider *self) {
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1BcBCObjectIdentifiers, sphincsPlus) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderSphincsplusSPHINCSPlusKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1BcBCObjectIdentifiers, sphincsPlus_shake_256) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderSphincsplusSPHINCSPlusKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1BcBCObjectIdentifiers, sphincsPlus_sha_256) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderSphincsplusSPHINCSPlusKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1BcBCObjectIdentifiers, sphincsPlus_sha_512) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderSphincsplusSPHINCSPlusKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, sphincs256) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderSphincsSphincs256KeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, newHope) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderNewhopeNHKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, xmss) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1IsaraIsaraObjectIdentifiers, id_alg_xmss) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, xmss_mt) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1IsaraIsaraObjectIdentifiers, id_alg_xmssmt) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, mcEliece) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderMcelieceMcElieceKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, mcElieceCca2) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderMcelieceMcElieceCCA2KeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, rainbow) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderRainbowRainbowKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, qTESLA_p_I) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderQteslaQTESLAKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastlePqcAsn1PQCObjectIdentifiers, qTESLA_p_III) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderQteslaQTESLAKeyFactorySpi_init()];
  [self addKeyInfoConverterWithOrgBouncycastleAsn1ASN1ObjectIdentifier:JreLoadStatic(OrgBouncycastleAsn1PkcsPKCSObjectIdentifiers, id_alg_hss_lms_hashsig) withOrgBouncycastleJcajceProviderUtilAsymmetricKeyInfoConverter:create_OrgBouncycastlePqcJcajceProviderLmsLMSKeyFactorySpi_init()];
}
