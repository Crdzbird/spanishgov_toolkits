...
#pragma push_macro("INCLUDE_ALL_OrgBouncycastleMathRawNat192")
#ifdef RESTRICT_OrgBouncycastleMathRawNat192
#define INCLUDE_ALL_OrgBouncycastleMathRawNat192 0
#else
#define INCLUDE_ALL_OrgBouncycastleMathRawNat192 1
#endif
#undef RESTRICT_OrgBouncycastleMathRawNat192
...
#if !defined (OrgBouncycastleMathRawNat192_) && (INCLUDE_ALL_OrgBouncycastleMathRawNat192 || defined(INCLUDE_OrgBouncycastleMathRawNat192))
#define OrgBouncycastleMathRawNat192_
...
FOUNDATION_EXPORT void OrgBouncycastleMathRawNat192_init(OrgBouncycastleMathRawNat192 *self);
...
FOUNDATION_EXPORT void OrgBouncycastleMathRawNat192_copy__WithIntArray_withInt_withIntArray_withInt_(IOSIntArray *x, jint xOff, IOSIntArray *z, jint zOff);

FOUNDATION_EXPORT void OrgBouncycastleMathRawNat192_copy64WithLongArray_withLongArray_(IOSLongArray *x, IOSLongArray *z);

FOUNDATION_EXPORT void OrgBouncycastleMathRawNat192_copy64WithLongArray_withInt_withLongArray_withInt_(IOSLongArray *x, jint xOff, IOSLongArray *z, jint zOff);

FOUNDATION_EXPORT IOSIntArray *OrgBouncycastleMathRawNat192_create(void);

FOUNDATION_EXPORT IOSLongArray *OrgBouncycastleMathRawNat192_create64(void);

FOUNDATION_EXPORT IOSIntArray *OrgBouncycastleMathRawNat192_createExt(void);

FOUNDATION_EXPORT IOSLongArray *OrgBouncycastleMathRawNat192_createExt64(void);
...
FOUNDATION_EXPORT jboolean OrgBouncycastleMathRawNat192_eq64WithLongArray_withLongArray_(IOSLongArray *x, IOSLongArray *y);

FOUNDATION_EXPORT IOSIntArray *OrgBouncycastleMathRawNat192_fromBigIntegerWithJavaMathBigInteger_(JavaMathBigInteger *x);

FOUNDATION_EXPORT IOSLongArray *OrgBouncycastleMathRawNat192_fromBigInteger64WithJavaMathBigInteger_(JavaMathBigInteger *x);
...
FOUNDATION_EXPORT jboolean OrgBouncycastleMathRawNat192_isOne64WithLongArray_(IOSLongArray *x);

FOUNDATION_EXPORT jboolean OrgBouncycastleMathRawNat192_isZeroWithIntArray_(IOSIntArray *x);

FOUNDATION_EXPORT jboolean OrgBouncycastleMathRawNat192_isZero64WithLongArray_(IOSLongArray *x);
...
FOUNDATION_EXPORT JavaMathBigInteger *OrgBouncycastleMathRawNat192_toBigInteger64WithLongArray_(IOSLongArray *x);
...
#endif
#pragma pop_macro("INCLUDE_ALL_OrgBouncycastleMathRawNat192")
