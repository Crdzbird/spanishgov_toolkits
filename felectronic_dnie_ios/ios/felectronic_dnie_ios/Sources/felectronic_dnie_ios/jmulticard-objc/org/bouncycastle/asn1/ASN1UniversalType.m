...
//  source: ./jmulticard/jmulticard-j2obc/java/org/bouncycastle/asn1/ASN1UniversalType.java
//
...
#error "org/bouncycastle/asn1/ASN1UniversalType must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastleAsn1ASN1Primitive *)fromImplicitPrimitiveWithOrgBouncycastleAsn1DEROctetString:(OrgBouncycastleAsn1DEROctetString *)octetString {
  @throw create_JavaLangIllegalStateException_initWithNSString_(@"unexpected implicit primitive encoding");
}
...
- (OrgBouncycastleAsn1ASN1Primitive *)fromImplicitConstructedWithOrgBouncycastleAsn1ASN1Sequence:(OrgBouncycastleAsn1ASN1Sequence *)sequence {
  @throw create_JavaLangIllegalStateException_initWithNSString_(@"unexpected implicit constructed encoding");
}
...
void OrgBouncycastleAsn1ASN1UniversalType_initPackagePrivateWithIOSClass_withInt_(OrgBouncycastleAsn1ASN1UniversalType *self, IOSClass *javaClass, jint tagNumber) {
  ...
  JreStrongAssign(&self->tag_, OrgBouncycastleAsn1ASN1Tag_createWithInt_withInt_(OrgBouncycastleAsn1BERTags_UNIVERSAL, tagNumber));
}
