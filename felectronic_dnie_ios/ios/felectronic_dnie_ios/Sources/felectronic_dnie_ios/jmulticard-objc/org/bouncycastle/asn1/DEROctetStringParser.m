...
#error "org/bouncycastle/asn1/DEROctetStringParser must not be compiled with ARC (-fobjc-arc)"
#endif
...
- (OrgBouncycastleAsn1ASN1Primitive *)getLoadedObject {
  return create_OrgBouncycastleAsn1DEROctetString_initWithByteArray_([((OrgBouncycastleAsn1DefiniteLengthInputStream *) nil_chk(stream_)) toByteArray]);
}
