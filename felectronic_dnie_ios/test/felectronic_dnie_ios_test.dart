import 'package:felectronic_dnie_ios/felectronic_dnie_ios.dart';
...
void main() {
  ...
  group('FelectronicDnieIOS', () {
    late FelectronicDnieIOS platform;
    late _MockHostApi mockApi;

    setUp(() {
      platform = FelectronicDnieIOS();
      mockApi = _MockHostApi();
      platform.api = mockApi;
    });

    test('can be registered', () {
      FelectronicDnieIOS.registerWith();
      expect(
        FelectronicDniePlatform.instance,
        isA<FelectronicDnieIOS>(),
      );
    });
